...
abstract contract Project {
    address public marketingWallet = 0x715C6B05Bfc89bD533Fe61c88bE54337cC3bB77c;
    address public devWallet = 0x715C6B05Bfc89bD533Fe61c88bE54337cC3bB77c;

    string constant _name = "CALYPSO";
    string constant _symbol = "CAL";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 10) / 100000; // (_totalSupply * 10) / 1000 [this equals 1%]
    uint256 public _maxWalletToken = (_totalSupply * 20) / 100000; //
 ...
 * MainContract
 */
contract Bnbinu is Project, IERC20, Ownable {
