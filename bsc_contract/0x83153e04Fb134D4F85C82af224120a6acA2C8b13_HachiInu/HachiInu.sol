...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0C220549b2D2586016bDFB4ae838293Ae398d983; // owner address
...
contract HachiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hachi Inu";
    string private _symbol = "$HI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0C220549b2D2586016bDFB4ae838293Ae398d983); // Marketing Address
    address payable private teamWalletAddress = payable(0x0C220549b2D2586016bDFB4ae838293Ae398d983); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 60;  // original 12
    ...
    uint256 private minimumTokensBeforeSwap = 1000000000 * 10**4; 
