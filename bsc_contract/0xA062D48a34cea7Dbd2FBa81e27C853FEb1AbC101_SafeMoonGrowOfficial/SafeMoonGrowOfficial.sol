...
/**
https://t.me/SafeMoonGrowOfficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb5495c182f84703E079dCAcB3a98f0036259EdbC; // owner address
...
contract SafeMoonGrowOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SafemoonGROW";
    string private _symbol = "SFMGROW";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x23c4b64E45B9aDfCF5f8384f012340C52DDe84B4); // Marketing Address
    address payable private teamWalletAddress = payable(0xb5495c182f84703E079dCAcB3a98f0036259EdbC); // Team Address
