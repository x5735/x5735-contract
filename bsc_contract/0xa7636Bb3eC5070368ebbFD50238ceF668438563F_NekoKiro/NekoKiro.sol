...
contract NekoKiro is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingAddress = payable(0xd4e196d69D00cE8c30d9Ecf73d80a1A51ec372a9); // Marketing Address
    ...
    string private _name = "Neko Kiro";
    string private _symbol = "NekoKiro";
