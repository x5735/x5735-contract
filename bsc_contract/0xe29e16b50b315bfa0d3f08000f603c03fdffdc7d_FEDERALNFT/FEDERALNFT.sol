...
https://t.me/federalnftshop
https://federalnft.shop
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF1DF8D450d79D5f297347e92a5dB0c58413CbB87; 
...
contract FEDERALNFT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Federal NFT";
    string private _symbol = "FEDERAL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE84B31214aB474c19be2B7a2258F76B0d7D72cab); 
    address payable public teamWalletAddress = payable(0xE84B31214aB474c19be2B7a2258F76B0d7D72cab); 
