...
/*
Telegram: https://t.me/HobbesbscCommunityOfficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE9CF94a33EBe6DeB88766E3b5b70c264fF9a242A;
...
contract Hobbes is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xE9CF94a33EBe6DeB88766E3b5b70c264fF9a242A);
    address payable public teamWalletAddress = payable(0xE9CF94a33EBe6DeB88766E3b5b70c264fF9a242A);
