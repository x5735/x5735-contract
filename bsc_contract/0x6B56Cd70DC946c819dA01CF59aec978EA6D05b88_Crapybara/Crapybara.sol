...
//
//Web:https://www.crapybara.com/
//TG: https://t.me/crapybaracoin
...
contract Crapybara  is ERC20, Ownable {
    uint256 public feeOnBuy = 5;
    uint256 public feeOnSell = 5;
    address public marketingWallet = 0x9A00726AD630172c4Cd6981106F718fa66d3a812;

    uint256 public _maxWalletSize = 10**5 * (10**18);
    ...
    constructor() ERC20("Crapybara", "CRAPY") {
    ...
    function setFees(uint256 _feeOnBuy, uint256 _feeOnSell) external onlyOwner {
        require(
            _feeOnBuy <= 5,
            "Marketing fee on buy cannot be more than 5%"
        );
        require(
            _feeOnSell <= 5,
            "Marketing fee on sell cannot be more than 5%"
        );
        feeOnBuy = _feeOnBuy;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(to != uniswapV2Pair ||!_isLimitExempt[from]||!_isLimitExempt[to]) {
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public onlyOwner {
        require(maxWalletSize >= _maxWalletSize,"You can't decrease max wallet size");
