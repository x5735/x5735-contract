...
/** 
 *  SourceUnit: /Users/Seedxapp/Desktop/orderbook-exchange/contracts/WrappedExchange.sol
*/
...
/** 
 *  SourceUnit: /Users/SEEDxapp/Desktop/Orderbook/contracts/WrappedExchange.sol
*/
...
contract SeedxApp_Orderbook is Initializable , Ownable ,Pausable {
    // CUSTOM DATATYPE
    struct Pair {
        address baseToken;
        address pairToken;
    ...
    event Swap(address user,address[] path, uint[] amounts);
    ...
    function swapExactTokensForTokens(
        ...
        emit Swap(msg.sender,path,  amounts);
        return amounts;
    }
