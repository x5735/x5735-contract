...
contract BEP20Token is Context, IBEP20, Ownable {
    ...
    mapping(address => bool) public feeWhiteList; // rewardAddress, address(this), address(router), owner
    ...
    constructor(
        ...
        uint256 BuyFeeRate,
        uint256 SellFeeRate,
        uint256 BuyBurnFeeRate,
        uint256 SellBurnFeeRate,
        uint256 BaseSupply
    ) {
        _name = Name;
        _symbol = Symbol;
        ...
        buyBurnFeeRate = BuyBurnFeeRate;
        sellBurnFeeRate = SellBurnFeeRate;
    ...
    function _takeFee(
        ...
        // reward amount
        uint256 rewardAmount = totalFee.sub(burnAmount);
...
contract SEEDToken is BEP20Token {
    constructor(
        string memory Name,
        string memory Symbol,
        uint8 Decimals,
        uint256 Supply, // no need to multiply decimal manually
        address RewardAddress,
        uint256 BuyFeeRate,
        uint256 SellFeeRate,
        uint256 BuyBurnFeeRate,
        uint256 SellBurnFeeRate,
        uint256 BaseSupply // no need to multiply decimal manually
    )
        BEP20Token(
            Name,
            Symbol,
