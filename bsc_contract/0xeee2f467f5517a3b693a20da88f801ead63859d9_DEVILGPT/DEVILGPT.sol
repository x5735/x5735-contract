...
contract DEVILGPT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2FdEB223Ae380DDBC71BD9513a670935F5a52547); 
    address payable public Wallet_Dev = payable(0xCE535e662A172e373cd0e9cd02414D3075b508fa);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "MuuInu"; 
