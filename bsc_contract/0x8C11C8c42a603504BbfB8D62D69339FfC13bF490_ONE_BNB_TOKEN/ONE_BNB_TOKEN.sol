...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3124cC559688b198fF1Ba3fC75cf15856fb5A215; 
...
contract ONE_BNB_TOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "1 BNB TOKEN";
    string private _symbol = "1 BNB TOKEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3124cC559688b198fF1Ba3fC75cf15856fb5A215); // 
    address payable public teamWalletAddress = payable(0x3124cC559688b198fF1Ba3fC75cf15856fb5A215); // 
