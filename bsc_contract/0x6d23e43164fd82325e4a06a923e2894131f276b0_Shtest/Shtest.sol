...
contract Shtest is BEP20, Ownable {
    ...
    uint256 public maxBuyLimit = 20e7 * 10**18; // 2%
    uint256 public maxSellLimit = 20e7 * 10**18; // 2%
    uint256 public maxWalletLimit = 20e7 * 10**18; // 2%

    uint256 public genesis_block;
    uint256 private lunchTime = 4;
    uint256 private lunchTax = 25;

    address public marketingWallet = 0x89F519BA3D480699652f71214478Ff7284997A05;
    ...
    */
    ...
    constructor() BEP20("RugpullFinal", "RUGPULLfinal") {
    ...
    function updatelunchTime(uint256 _lunchTime) external onlyOwner {
        ...
        require(_lunchTime < 50,"lunchTime should be less than 5 Blocks");
