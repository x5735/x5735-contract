...
contract SHIKB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIKB";
    string private _symbol = "SHIKB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC312a8332CAb1356869bB8a33EcF73EaBdA1dfD1);
    address payable public teamWalletAddress = payable(0xC312a8332CAb1356869bB8a33EcF73EaBdA1dfD1);
    address public immutable deadAddress = 0xC312a8332CAb1356869bB8a33EcF73EaBdA1dfD1;
