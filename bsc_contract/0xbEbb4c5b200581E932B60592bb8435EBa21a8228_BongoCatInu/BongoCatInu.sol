...
/**
   #BONGOCAT 
    ...
    I make this Bongo Cat Inu to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/bongocatinu

   Great features:
   3% fee auto add to the liquidity pool to locked forever when selling
   2% fee to marketing and future development

   We will lock the initial LP to 1y and extend to 3y in higher marketcap
   We will renounce the ownership to burn addresses to transfer #BONGOCAT to the community, make sure it's 100% safe.

   I will add 0.999 BNB and all the left 82% total supply to the pool
   Can you make #BONGOCAT 10000000X? 
   ...
   it's the best part of the #BONGOCAT idea, increasing the liquidity pool automatically, 
...
contract BongoCatInu is Context, IERC20, Ownable {
