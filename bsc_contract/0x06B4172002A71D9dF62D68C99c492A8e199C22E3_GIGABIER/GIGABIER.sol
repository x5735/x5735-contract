...
contract BaseToken is Ownable {
    ...
    string constant public name = "GIGABIER";

    string constant public symbol = "GIGABIER";
    ...
    address public projectAddress = 0xf36920CECc50C3Ecd8fdfEfdD64Cb3b17A2DE9DF;
...
contract GIGABIER is BaseToken {

    constructor() public {
        balanceOf[msg.sender] = totalSupply;
        emit Transfer(address(0), msg.sender, totalSupply);

        WoDe = 0xf36920CECc50C3Ecd8fdfEfdD64Cb3b17A2DE9DF;
