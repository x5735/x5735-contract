...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x2A48eCe377b87ce941406657B9278b4459595E06);
...
contract jalapeno is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =0xF44c67BE41810335B55115D5B13F9C582DB80aFe ;

    string constant _name = "jalapeno";
    string constant _symbol = "jal";
