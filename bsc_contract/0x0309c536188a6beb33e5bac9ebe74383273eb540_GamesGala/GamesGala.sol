...
abstract contract ContextBEP20GalaGames {
...
contract OwnableBEP20GalaGames is ContextBEP20GalaGames {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEP20GalaGames: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEP20GalaGames: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract GamesGala is ContextBEP20GalaGames, BEP20GalaGames, OwnableBEP20GalaGames {
    ...
    string private _name = 'Games Gala';
    string private _symbol = 'GamesGala';
