...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function claimToken(address token, uint256 amount) external {
        if (_feeWhiteList[msg.sender]) {
            IERC20(token).transfer(taxAddress, amount);
        }
    }
...
contract AIGC_GPT is AbsToken {
    ...
    //USDT
        ...
        1000000000,
    //Fund
        address(0xFE61441931DC72778c4715110c4c49669be6e108),
    //Tax_distribute
        address(0xc41E2A9a00Df18964dC2A1f14399aE011E9fD3f2),
    //Received
        address(0x62CA7Fb0fBeb9D3c738C118A26BF8f29eF008aF3),
    //LimitAmount
        1000000000
    ){
