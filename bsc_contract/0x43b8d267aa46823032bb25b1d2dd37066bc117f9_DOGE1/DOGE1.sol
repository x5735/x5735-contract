...
contract DOGE1 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x680c79A790f25147fA8c07F92242AD7Bcb3175dc); // Marketing Address
    address payable public teamWalletAddress = payable(0x5d3D8DAd03479F9fA86a7F4BD77f7C30c343FC81); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xf10C0E2E5d2347A746D5a6aF4ec73ab76324071A),
            block.timestamp
        );
    }
