        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xB00D5b837e2F74EE2a60E20A2B3463302C4697dB), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        10000000,//Su 
        address(0xB00D5b837e2F74EE2a60E20A2B3463302C4697dB),//
        address(0xB00D5b837e2F74EE2a60E20A2B3463302C4697dB)//
    ){
    }
}