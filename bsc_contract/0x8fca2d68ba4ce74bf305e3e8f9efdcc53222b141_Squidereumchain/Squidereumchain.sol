...
contract Squidereumchain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = unicode"Squidereum chain token";
    string private _symbol = unicode"SQC";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0x5c07Ea66766669F876099926637Dbf0A02E16631); 
    address payable public BurnedWalletAddress = payable(0x5c07Ea66766669F876099926637Dbf0A02E16631); 
