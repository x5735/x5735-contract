...
/**
    Telegram: https://t.me/CoinROI
    Website: https://coinroi.online/
*/
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0x4FbD94Dd5626F9bfE6EBA68B1a30041ff2b25AEB;
...
contract CoinROI is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "COIN ROI";
    string constant _symbol = "$CROI";
    ...
    uint256 public swapThreshold = _totalSupply * 15 / 2000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x18f822748c0934Dbced558B1AAaE866dcB8E93cf;
        buybackWallet = 0x18f822748c0934Dbced558B1AAaE866dcB8E93cf;
