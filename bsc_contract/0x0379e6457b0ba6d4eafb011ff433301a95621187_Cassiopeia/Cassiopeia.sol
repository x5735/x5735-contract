...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x87C0B9919A717fEc16f3A6ee0913ec8F37592D48;
...
contract Cassiopeia is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x92fFA3b1D3E7e826b830E55A7995402f64C839D6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Cassiopeia";
    string private _symbol = "CASI";
