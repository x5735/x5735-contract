...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd21bB2CE6a8b94D40a10d7a1D2646C50468d6722; // owner address
...
contract RextumNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Rextum Network";
    string private _symbol = unicode"$Rextum";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd21bB2CE6a8b94D40a10d7a1D2646C50468d6722); // Marketing Address
    address payable public teamWalletAddress = payable(0xd21bB2CE6a8b94D40a10d7a1D2646C50468d6722); // Team Address
