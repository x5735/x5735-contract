...
contract FreedomFinanceToken is ERC20, Ownable {
    ...
    mapping(address => bool) public contractWhiteListMap;
    ...
    function setTransferWhite(address addr) public onlyOwner {
        transferWhiteListMap[addr] = true;
    }

    function setAddressWhite(address addr) public onlyOwner {
        contractWhiteListMap[addr] = true;
    }
