...
contract HULKMUSK is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x8849D9ea61F2dCE58E4b59f89dEB7f16C4C35b4b;

    string private constant _name = "HULK MUSK";
    string private constant _symbol = "HULKMUSK";
