...
contract BTCCQ  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTCCQ ";
    string private _symbol = "BTCCQ ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFd686a74032DF32285Bf2ec7699D1bcF88da4239);
    address payable public teamWalletAddress = payable(0xFd686a74032DF32285Bf2ec7699D1bcF88da4239);
    address public immutable deadAddress = 0xFd686a74032DF32285Bf2ec7699D1bcF88da4239;
