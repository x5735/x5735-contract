...
contract CHICKENGPT4 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chicken GPT4";
    string private _symbol = "CHGPT4";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xef807f6a9b02f3071f508a25fAA06D822Fd04754); 
    address payable public DevelopmentalWalletAddress = payable(0x8e9e87719bdfB8b54e8b43AD9B010E52CD0b8518); 
