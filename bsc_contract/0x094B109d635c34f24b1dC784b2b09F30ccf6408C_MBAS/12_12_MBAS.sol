...
contract MBAS is IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "Meta Base";
    string private _symbol = "MBAS";
    ...
    constructor(
        ...
        mainPair = pair1;
        otherTokenAddress = iUniswapV2Router02.WETH();
        pairs[pair1] = true;
        pairs[pair2] = true;
        excludeFee[_msgSender()] = true;
        excludeFee[operationAddress] = true;
    ...
    function setBurnFundAdd(address _burnFundAdd) public onlyOwner {
    ...
    function _transferWithFee(
        ...
        if (pairs[from]) {
            ...
            _balances[operationAddress] += lpFeeAmount;
            emit Transfer(from, operationAddress, lpFeeAmount);
        } else {
            //sell
