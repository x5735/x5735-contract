...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x63638F4e2328661275E9056dFC407284a901305E; // owner address
...
contract ChickenPaw is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Chicken Paw";
    string private _symbol = unicode"$ChicPaw";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x63638F4e2328661275E9056dFC407284a901305E); // Marketing Address
    address payable public teamWalletAddress = payable(0x63638F4e2328661275E9056dFC407284a901305E); // Team Address
