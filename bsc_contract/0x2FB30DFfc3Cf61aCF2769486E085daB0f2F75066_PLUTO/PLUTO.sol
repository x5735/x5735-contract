...
/**
    ...
    Pluto [$PLT] 
    Red_Whale_Vesting_and_Staking; 
    Dividend_Paying_Contract
...
contract PLUTO is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Pluto";
    string public _symbol= "PLT";
     bool balances1 = true;

    address payable public charityAddress = payable(0xfF3e1E223fa64568fcC4e1D6801A87fE0471155d); // Marketing Address
