...
abstract contract GTToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _nofeeList;
    ...
    constructor (
        ...
        address FundAddress, address MarketAddress, address ReceiveAddress,
        ...
        _nofeeList[FundAddress] = true;
        _nofeeList[MarketAddress] = true;
        _nofeeList[ReceiveAddress] = true;
        _nofeeList[address(this)] = true;
        _nofeeList[address(swapRouter)] = true;
    ...
    function setHolderRewardCondition(uint256 amount) external onFunder {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        USDT.transferFrom(address(_tokenDistributor), fundAddress, fundAmount * 7 / 10);
        USDT.transferFrom(address(_tokenDistributor), marketAddress, fundAmount * 3 / 10);
    ...
    function _transfer(
        ...
        if (!_nofeeList[from] && !_nofeeList[to]) {
    ...
    function setExcludeHolder(address addr, bool enable) external onFunder {
    ...
    function claimToken(address token, uint256 amount, address to) external onFunder {
...
contract GT is GTToken {
    constructor() GTToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
        address(0x55d398326f99059fF775485246999027B3197955),
        address(0x1A7E07Ba951CDac84902c476062Ce55028C59858),
        address(0x1A7E07Ba951CDac84902c476062Ce55028C59858),
        address(0x36e72ddBE74DE073106250D903536C473157Ef95),
        "GT",
        "GT",
        18,
        5000000
