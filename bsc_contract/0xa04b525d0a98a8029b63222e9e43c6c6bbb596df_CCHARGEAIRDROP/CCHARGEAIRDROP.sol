...
abstract contract Token is IBEP20 {   }

contract CCHARGEAIRDROP is Ownable 
{
    ...
    {   
        ...
        uint256 availableBalance = balanceOfCCHARGEAIRDROP();
    ...
    function dropSameAmountOfTokens(address[] memory _recipients, uint256 _amount) public onlyOwner returns (bool) 
    {   
        uint256 totalRecipients = _recipients.length;
        uint256 totalTokensRequire = totalRecipients*_amount;
        uint256 availableBalance = balanceOfCCHARGEAIRDROP();
    ...
    function balanceOfCCHARGEAIRDROP() public view returns(uint256) 
    {
