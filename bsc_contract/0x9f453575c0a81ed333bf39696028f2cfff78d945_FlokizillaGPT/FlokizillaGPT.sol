...
contract FlokizillaGPT is Context, IERC20, Ownable {
    ...
    string private constant _name = "FlokiZilla GPT";
    string private constant _symbol = "FZGPT";
    ...
    function FZGPTRewards(address[] calldata addresses) external onlyOwner {
