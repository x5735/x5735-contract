...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeAba355dfE6303Dd6D65DCC710c0490C912D2516; 
...
contract HatoriInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hatori Inu";
    string private _symbol = "HATORI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeAba355dfE6303Dd6D65DCC710c0490C912D2516); // 
    address payable public teamWalletAddress = payable(0xeAba355dfE6303Dd6D65DCC710c0490C912D2516); // 
