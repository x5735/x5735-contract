...
Nero Protocol
@Nero__Protocol
An elegant hyperstructure for borrowing any asset with an on-chain source of truth against an asset 
or a collection of assets.
https://neroprotocol.com/
https://twitter.com/Nero__Protocol
https://t.me/Nero_Protocol
*/
...
contract Nero is ERC20, Ownable {
    ...
    constructor(address _pancakeAddr, address _feeWallet) ERC20("Nero Protocol", "NEPT")
    {
