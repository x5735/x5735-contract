...
/**
Jorax AI 驅動的永不休眠的電報機器人！消除停機時間並維護完美的社區管理。 
Jorax 是一個電報聊天機器人，可以學習您項目的白皮書並回答社區成員的問題以獲得 24/7 客戶支持
*/
...
contract JoraxAI  is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Jorax AI";
    string private constant _symbol = unicode"JORAXAI更新";
    ...
    address payable public DevWallet = payable(0x1d6A44e9a2D37d0F34171Ff0ce498Ab90f3db51C);
    address payable public MarketingWallet = payable(0x7Cf1F0065C0f7aFf4895d8ee88947C158590900B);
