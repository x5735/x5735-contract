...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x31fd0204087dcD340583A3E43920aECbADEf9739; // owner address
...
contract BloopNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Bloop Network";
    string private _symbol = unicode"$Bloop";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x31fd0204087dcD340583A3E43920aECbADEf9739); // Marketing Address
    address payable public teamWalletAddress = payable(0x31fd0204087dcD340583A3E43920aECbADEf9739); // Team Address
