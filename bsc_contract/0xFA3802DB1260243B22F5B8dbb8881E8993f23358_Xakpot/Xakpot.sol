...
=== 'Xakpot' Token contract with following features ===
    => BEP20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2023 onwards Xakpot
-------------------------------------------------------------------
*/ 
...
contract Xakpot is owned {
    
    using SafeMath for uint256;

    string constant private _name = "Xakpot";
    string constant private _symbol = "XAK";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;                       
    uint256 private maxSupply = 1000000000 * (10**_decimals);
