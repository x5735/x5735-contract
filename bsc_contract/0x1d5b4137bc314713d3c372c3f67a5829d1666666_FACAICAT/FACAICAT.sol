...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintNftWithTokenUser(address to) public onlyMinter returns (bool) {
		...
		tokenId = tokenId + 1;
		_mint(to, tokenId);
        _setTokenURI(tokenId, "https://ipfs.io/ipfs/QmZ4v2wgNEopju9FzyXERUtprwnEJPL9mHBtYS8SDqqoX1");
        return true;
    }
}
...
contract FACAICAT  is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("FACAICAT NFT", "FACAICAT NFT") {
