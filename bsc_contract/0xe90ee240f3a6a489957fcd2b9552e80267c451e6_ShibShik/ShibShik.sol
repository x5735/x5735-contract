...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCA66Ccd0223772985839855430f840FBD7DD12fF; // owner address
...
contract ShibShik is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibShik";
    string private _symbol = "SHIBSHIK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xCA66Ccd0223772985839855430f840FBD7DD12fF); // Marketing Address
    address payable private teamWalletAddress = payable(0xCA66Ccd0223772985839855430f840FBD7DD12fF); // Team Address
