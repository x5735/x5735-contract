...
contract FLOKIK  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKIK ";
    string private _symbol = "FLOKIK ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0ecEa638C79F540687EFF17428642e7c9f1B1BD0);
    address payable public teamWalletAddress = payable(0x0ecEa638C79F540687EFF17428642e7c9f1B1BD0);
    address public immutable deadAddress = 0x0ecEa638C79F540687EFF17428642e7c9f1B1BD0;
