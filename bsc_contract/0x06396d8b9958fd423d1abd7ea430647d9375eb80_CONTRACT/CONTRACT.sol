...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7C93Deb75F36ed1c8F77b2AD6abE2B01Fbaad09D; // owner address
...
contract CONTRACT is Context, IERC20, Ownable {
    ...
    string private _name = "GPT-4 PROTOCOL";
    string private _symbol = "GPT4-PRO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7C93Deb75F36ed1c8F77b2AD6abE2B01Fbaad09D);
    address payable private teamWalletAddress = payable(0x7C93Deb75F36ed1c8F77b2AD6abE2B01Fbaad09D);
