...
contract OgatoToken is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if (!swapping && !automatedMarketMakerPairs[from] && autoSwapEnable) {
            swapping = true;
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        uint256 feeMarketing = newBalance;

        sendBNB(payable(marketingWallet), feeMarketing);
