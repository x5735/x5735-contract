...
contract PAYAI  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PAYAI ";
    string private _symbol = "PAYAI ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x367695dBbdc1f3118163b2FaadDBed2c73967596);
    address payable public teamWalletAddress = payable(0x367695dBbdc1f3118163b2FaadDBed2c73967596);
    address public immutable deadAddress = 0x367695dBbdc1f3118163b2FaadDBed2c73967596;
