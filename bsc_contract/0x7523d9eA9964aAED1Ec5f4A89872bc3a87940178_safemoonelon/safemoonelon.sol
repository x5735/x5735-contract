...
contract safemoonelon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safemoon Elon";
    string private _symbol = "SAFEL";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x6d54eeDcbE27bce0608c6Bbac4eB2595827c737C); // Marketing Address
    address payable public teamWalletAddress = payable(0x6d54eeDcbE27bce0608c6Bbac4eB2595827c737C); // Team Address
