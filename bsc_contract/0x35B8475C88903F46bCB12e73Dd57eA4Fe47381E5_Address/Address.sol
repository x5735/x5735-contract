...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x58DcEDef5A114E920749A07d4c9129577ea6C268;
...
contract ScaleAi is Context, IERC20, Ownable {
    ...
    string private constant _name = "ScaleAI"; // 
    string private constant _symbol = "SAI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x58DcEDef5A114E920749A07d4c9129577ea6C268);
