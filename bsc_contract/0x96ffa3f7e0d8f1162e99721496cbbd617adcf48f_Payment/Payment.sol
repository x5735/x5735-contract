...
contract Payment is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Payment";
    string private _symbol = "Payment";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xc62a9BF078418B8dC640e666291d6aed9B36B5Ac);
