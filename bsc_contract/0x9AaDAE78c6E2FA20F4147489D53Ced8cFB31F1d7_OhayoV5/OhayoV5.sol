...
contract OhayoV5 is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    using SafeMath for uint256;
    ...
    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("OhayoV5", "OhayoV5") {
