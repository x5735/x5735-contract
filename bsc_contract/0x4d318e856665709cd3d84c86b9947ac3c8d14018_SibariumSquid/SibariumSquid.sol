...
contract SibariumSquid is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ShibariumSquid";
    string constant _symbol = "shquid";
    ...
    uint256 public _maxTxAmount = 30000 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 30000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xD182DFA582CA048a090fc6Ad85A8E718a8e965c2;
        marketingWallet = 0xD182DFA582CA048a090fc6Ad85A8E718a8e965c2;
        devWallet = 0xD182DFA582CA048a090fc6Ad85A8E718a8e965c2;
