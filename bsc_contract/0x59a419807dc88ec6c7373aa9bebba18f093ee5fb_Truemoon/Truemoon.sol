...
LP will be locked, eventually forever

Tax will only go to reflections after launch
...
contract Truemoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "Truemoon";
    string private constant _symbol = "TRUMUN";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x7Ba3022aD2D112C847C9aC2897E470dabc871BfB);
    address payable private _marketingAddress = payable(0x7Ba3022aD2D112C847C9aC2897E470dabc871BfB);
