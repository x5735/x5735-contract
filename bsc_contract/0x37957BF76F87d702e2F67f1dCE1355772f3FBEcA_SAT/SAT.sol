...
contract SAT is IERC20, Ownable {
    ...
    address private fundAddress = address(0x14E2cd9780A9a9c5feF23666380Dec0f7Fe30849);
    address private fundAddress2 = address(0x00BC1A9BC7e6faC22fb60E051cDA0C84281c8503);
    ...
    uint256 public _starttime = block.timestamp + 20 minutes;  
    bool isBuy = false;
    uint256 public statetest = 1;
    constructor() {
    ...
    function _transfer(
        ...
        if  (isBuy){
                require(block.timestamp >= _starttime, "not startswap");  
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            rate = _taxFee.mul(multiple) + _destroyFee.mul(multiple)  + _lpFee.mul(multiple) + _fundFee.mul(multiple);
        }
