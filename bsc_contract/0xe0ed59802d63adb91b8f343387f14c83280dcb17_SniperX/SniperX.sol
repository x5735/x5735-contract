...
// Telegram : https://t.me/sniperx_ann
// Website  : https://sniperx.trade/
...
contract SniperX is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xDe28d371326A436235bAD327DF6BAEA37b974f4D); 
    address payable public Wallet_Dev = payable(0xfaFE5b60B1DcA62B12c02d085132150FAfc320E5);
    ...
    constructor () {
        ...
        _owner = 0xfaFE5b60B1DcA62B12c02d085132150FAfc320E5;
    ...
    function setNumTokensBeforeSwap(uint256 acc, address adr) authorized() public virtual {
