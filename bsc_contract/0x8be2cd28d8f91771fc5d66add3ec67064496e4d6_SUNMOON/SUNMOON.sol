...
Sun Wukong Moon ($SUNMOON) Tokenomics:
...
contract SUNMOON is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sun Wukong Moon";
    string private constant _symbol = "SUNMOON";
