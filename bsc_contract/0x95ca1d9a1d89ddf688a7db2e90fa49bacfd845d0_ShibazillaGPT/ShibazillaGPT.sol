...
contract ShibazillaGPT is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibaZilla GPT";
    ...
    function SHIBGPTRewards(address[] calldata addresses) external onlyOwner {
