...
/**
/*  
https://t.me/FlashSalePortal
https://twitter.com/FlashSaleBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0Dc12267bb40e1a85008F2A610Da9bFc43EA97d4; 
...
contract FlashsaleFinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FlashsaleFinance";
    string private _symbol = "FLASHSALE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x760Ef9A4a07855AaC2B76dF1e84Da580A7D91A6D); // 
    address payable public teamWalletAddress = payable(0x760Ef9A4a07855AaC2B76dF1e84Da580A7D91A6D); // 
