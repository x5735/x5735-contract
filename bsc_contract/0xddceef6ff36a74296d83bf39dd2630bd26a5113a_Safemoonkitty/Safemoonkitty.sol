...
contract Safemoonkitty is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safemoon Kitty";
    string private constant _symbol = "SAFEKITTY";
    ...
    function DZCEORewards(address[] calldata addresses) external onlyOwner {
