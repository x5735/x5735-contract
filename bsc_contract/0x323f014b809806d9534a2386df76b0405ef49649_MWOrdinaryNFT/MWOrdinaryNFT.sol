...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintAdminWithTokenURI(address user) public onlyMinter returns (bool) {
        ...
        _setTokenURI(nftIndexId, "https://bafkreicvweh4gbvtxgcu7qcencgdy732j6lrbs2sxjtuqvrmizh5aiflpa.ipfs.nftstorage.link");
...
//0x05E1297A70A25de9D94d7DE0Ba310920187fA286
contract MWOrdinaryNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("MW Ordinary NFT", "MW Ordinary NFT") {
