...
contract Mytoken is ERC20, Ownable {
    ...
    string public name_ = "arbking Token";//名称
    string public symbol_ = "arb";//简称
    ...
    uint256[8] public  buyFeeSetting_ = [2,1,4,1];//买入手续费：持币分红、回流、营销钱包、销毁
    uint256[8] public  sellFeeSetting_ = [2,1,4,1];//卖出手续费：持币分红、回流、营销钱包、销毁
