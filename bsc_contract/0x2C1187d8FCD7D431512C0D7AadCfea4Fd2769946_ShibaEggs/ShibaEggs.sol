...
contract ShibaEggs is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba Eggs";
    string private constant _symbol = "ShibaEggs";
    ...
    constructor() {
        ...
        _marketingWallet = payable(0xB7A981aA00c817502f5f27b7563d69C86531D28E);
        _liqWalletAddress = 0xB7A981aA00c817502f5f27b7563d69C86531D28E;
    ...
    function setSellTaxFeePercent(uint256 taxFee) external onlyOwner() {
        _sellTaxFee = taxFee;
        require(_sellTaxFee + _sellMarketingFee + _sellLiquidityFee <= 99, "Total fees exceed 25%");
    }
