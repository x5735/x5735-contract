...
contract TELEPHONEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Telephone Inu";
    string private _symbol = "TELEINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xef807f6a9b02f3071f508a25fAA06D822Fd04754); // Marketing Address
