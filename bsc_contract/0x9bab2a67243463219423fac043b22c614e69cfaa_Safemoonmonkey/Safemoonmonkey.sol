...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x49994878394aca7A86e20928C0B11Ec1fFE66BDE; // owner address
...
contract Safemoonmonkey is Context, IERC20, Ownable {
    ...
    string private _name = "SafemoonMonkey";
    string private _symbol = "SFMM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xFa49ec638561f8Ca8687f3A0648585e607f3137E); // Marketing Address
    address payable private teamWalletAddress = payable(0x49994878394aca7A86e20928C0B11Ec1fFE66BDE); // Team Address
