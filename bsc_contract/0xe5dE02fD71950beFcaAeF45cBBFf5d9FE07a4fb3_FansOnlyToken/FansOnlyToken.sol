...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x191715F502Ce2cFB3675d4531d955e446a33F8A1;
...
contract FansOnlyToken is Context, IERC20, Ownable {
    ...
    address private _RndWalletAddress = 0x262C5Af5CBDfEeac6e12713A63f7DCF9a67D76c4;
    ...
    string private _name = "FansOnly Token";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_tTotal * 100) / 100000;
    uint256 public _maxWalletToken = ( _tTotal * 100 ) / 100000;
