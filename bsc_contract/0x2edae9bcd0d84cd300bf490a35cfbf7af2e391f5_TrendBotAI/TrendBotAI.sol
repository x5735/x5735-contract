...
/**
Trend bot AI is a platform that automatically lists top trending tokens in the BSC network 
and uses its native token as a fee for fast track listing can provide a valuable service to token issuers and investors. 
It can help to simplify the listing process, improve liquidity for new tokens, and drive adoption of the platform's native token.
Official Telegram: https://t.me/trendbotaiportal
...
contract TrendBotAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TrendBot AI";
    string private _symbol = "TBAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2286CF0431DE078b8E9A2fb581dF0bfDC2D73Ad8); 
    address payable public buyBackWalletAddress = payable(0x2286CF0431DE078b8E9A2fb581dF0bfDC2D73Ad8); 
    ...
    uint256 public _walletMax = 1600000 * 10**9; 
