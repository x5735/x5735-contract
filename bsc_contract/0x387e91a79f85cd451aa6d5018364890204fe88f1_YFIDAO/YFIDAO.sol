        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x36A9e5E4d4709a573202F13AeEf2AA063C221381), block.timestamp
                );
            }
        }
    }
...
contract YFIDAO is AbsToken {
    constructor() AbsToken(
        ...
        18,//Decimals
        30000,//Supply
        address(0x472dF5287B84b98A751c8cB31FB8233F3B8D5288),//FundAddress
        address(0x9f33Ee8E14CAfB1BF2bB4df579033b5948014Fd5)//ReceiveAddress
    ){
    }
}