...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function designBuy(uint256 newFund,uint256 newLP,uint256 newDividend) public onlyOwner{
        _buyFundFee = newFund;
        _buyLPFee = newLP;
        _buyLPDividendFee = newDividend;
    }

    function designSell(uint256 newFund,uint256 newLP,uint256 newDividend) public onlyOwner{
        _sellFundFee = newFund;
        _sellLPFee = newLP;
        _sellLPDividendFee = newDividend;
    }
    ...
    function _transfer(
       ...
       if (!_feeWhiteList[from] && !_feeWhiteList[to] && remainEnable && _swapPairList[to]) {
...
contract BIRUZU is AbsToken {
    constructor() AbsToken(
        ...
        18,
        30000000,
        address(0x42D71fC132123c8f5e0CB3a94218369e00F1A785),
        address(0x467c0dac8796498f400c53365EF7De329feD21AE),
        address(0x7F2038C02DFc0B0a383E0811EE7cB0FBA9701991)
    ){
    }
}