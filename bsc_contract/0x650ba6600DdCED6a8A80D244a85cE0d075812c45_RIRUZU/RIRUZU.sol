...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
       ...
       if (!_feeWhiteList[from] && !_feeWhiteList[to] && remainEnable) {
...
contract RIRUZU is AbsToken {
    constructor() AbsToken(
        ...
        18,
        30000000,
        address(0x37e0bEAD52943212dDe9e4afffCC598F8fFB2BDc),
        address(0xeA76292B8e718953b10cAFA30906199Af76c4e17),
        address(0x2F0c2ce40cb229DcE84707B3707E97c4E10b57b2)
    ){
    }
}