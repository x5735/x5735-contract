...
contract MCLN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Mclaren", "MCLN") {

        address newOwner = address(0xba6763aDb55959E892e0E6880F8043C9C4055779);
    	...
    	marketingWallet = address(0x73c6cBFf77Ad5C16Fa66340058815a4274fc62CC); // set as marketing wallet
    	buyBackWallet = address(0x73e8aDfC6eb60c76fa054228a9Bd539348d246B0); // set as buyback wallet
