...
contract SafestMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SafestMoon";
    string private _symbol = "SAFEM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x05eE31c7c09Bb763Ae901c1E39f3685145912873); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x05eE31c7c09Bb763Ae901c1E39f3685145912873); // BuyBack Address
