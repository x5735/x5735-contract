...
contract SHIBAID is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBA SPACE ID";
    string private _symbol = "SHIB-ID";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x111cA30436e2F65a214F650C39C20E3f2a69E5D7); // Marketing Address
