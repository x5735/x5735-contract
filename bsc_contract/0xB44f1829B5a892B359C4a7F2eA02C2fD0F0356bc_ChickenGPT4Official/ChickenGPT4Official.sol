...
/**
https://t.me/ChickenGPT4Official
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x49EeC21639802Ac4c4d955FA0a7a28ddf72A46b9; // owner address
...
contract ChickenGPT4Official is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CHICKENGPT-4";
    string private _symbol = "KFCGPT4";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x484E734201B9Df3CAFBd78B0F67A3E1AB0FC0948); // Marketing Address
    address payable private teamWalletAddress = payable(0x49EeC21639802Ac4c4d955FA0a7a28ddf72A46b9); // Team Address
