...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x18f83aDeF5eBe6753f09bdDaBC7EC9C24cf02F2a;
        _owner = msgSender;
...
contract ArbitrumShikoku is Context, IERC20, Ownable {
    ...
    string private constant _name = "Arbitrum Shikoku";
    string private constant _symbol = "$ARBSHIK";
    ...
    constructor () {
        marketingWallet = payable(0x18f83aDeF5eBe6753f09bdDaBC7EC9C24cf02F2a);
