...
/**
Tg : https://t.me/DoctorobotAI MATHIU DEV
...
contract DOCTOROBOTAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOCTOROBOT AI";
    string private _symbol = "DOCTOROBOT AI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7406e19F3D5699373dBf01A8e6de425B3dF679b2); // Marketing Address
    address payable public teamWalletAddress = payable(0x7406e19F3D5699373dBf01A8e6de425B3dF679b2); // Team Address
