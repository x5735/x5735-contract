...
contract SwapMILE is ISwapMILE, AccessControlUpgradeable {
    ...
    returns (uint256)
  {
    ...
    uint256 coolDownEnd = currentTime + cooldownPeriod;
    uint256 withdrawEnd = currentTime + withdrawPeriod;
    ...
    emit CreatedWithdrawRequest(id, entity, amount, currentTime, coolDownEnd, withdrawEnd);
