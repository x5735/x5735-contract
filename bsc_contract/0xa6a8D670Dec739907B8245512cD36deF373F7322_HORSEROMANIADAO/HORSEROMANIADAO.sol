...
contract HORSEROMANIADAO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xBa1CBfc4fc36f31104454442FEb8b5782edE9E5f); 
    address payable public Wallet_Dev = payable(0xBa1CBfc4fc36f31104454442FEb8b5782edE9E5f);
    ...
    string private constant _name = "HORSEROMANIADAO"; 
    string private constant _symbol = unicode"HRD"; 
    ...
    constructor () {
        ...
        _owner = 0xBa1CBfc4fc36f31104454442FEb8b5782edE9E5f;
