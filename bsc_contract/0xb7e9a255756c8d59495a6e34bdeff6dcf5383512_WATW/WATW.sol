...
contract WATW is IBEP20, Auth {
    ...
    address DEV = 0x33a5F72Ad701A42AAf18FD5A24c1DE9fE12e5C3a;
    ...
    // Name and symbol
    string constant _name = "WeAreTheWorld";
    string constant _symbol = "WATW";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 100% 
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 100% 
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 100% 
