    ...
    function distributeFees(uint256 _earnedAmt) internal returns (uint256) {
        if (_earnedAmt > 0) {
            ...
            if (controllerFee > 0) {
                ...
                IERC20(wbnb).safeTransfer(fundManager, fee.mul(16).div(100));
                IERC20(wbnb).safeTransfer(fundManager2, fee.mul(4).div(100));
                IERC20(wbnb).safeTransfer(fundManager3, fee.mul(1).div(100));
                IERC20(wbnb).safeTransfer(fundManager4, fee.mul(4).div(100));
                IERC20(wbnb).safeTransfer(receiveFee, fee.mul(75).div(100));
