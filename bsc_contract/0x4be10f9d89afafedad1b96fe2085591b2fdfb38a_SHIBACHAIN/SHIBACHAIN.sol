...
/**
 The next 10000X.....When website goes live and the bull run starts. 

1. The liquidity will be locked forever.
2. 5% reflection to all holders
3. 2% Liquidity 
4. 2% Marketing and Development 
5. 2% Treasury and donation
6. 2% Burn 

The tokenomics will never be changed and contract will be renounce.

I will be handing over all keys to the community. I will burn liquidity LPs to burn addresses to lock the pool forever.
I will renounce the ownership to burn addresses to transfer #Pit to the community, make sure it's 100% safe.

Can you make Shiba Chain the next 10000X
...
contract SHIBACHAIN is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = 0x4fD9297a96DfeE39C449E6325a6F7f929572d2C7; // Marketing Address
	address payable public burningAddress = 0x0000000000000000000000000000000000000000; // burn Address
	address payable public devAddress = 0x4fD9297a96DfeE39C449E6325a6F7f929572d2C7; // Dev Address
