...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6A9DB7bA041F12793D9add80aC7d1cfD8240B742; 
...
contract InuZuko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "InuZuko";
    string private _symbol = "ZUKO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6A9DB7bA041F12793D9add80aC7d1cfD8240B742); // 
    address payable public teamWalletAddress = payable(0x6A9DB7bA041F12793D9add80aC7d1cfD8240B742); // 
