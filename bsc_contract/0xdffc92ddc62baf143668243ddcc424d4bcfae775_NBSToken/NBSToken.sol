...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 private _lpFeeForBuy = 3;
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        uint256 lpAmount = tokenAmount * _lpFeeForBuy / (_marketingFeeForBuy) / 2;
        ...
        uint256 totalUsdtFee = _lpFeeForBuy / 2 + _marketingFeeForBuy;
        USDT.transferFrom(address(_tokenDistributor), marketAddress, newBalance * _marketingFeeForBuy / totalUsdtFee);
        uint256 lpUsdt = newBalance * _lpFeeForBuy / 2 / totalUsdtFee;
...
contract NBSToken is AbsToken {
    constructor() AbsToken(
        "NBS Token",
        "NBS",
        18,
        5600000,
        address(0x5D237198bc55A9904d0199D1E5261B0FdD370BFF),
        address(0x194b168f6231f098048398D6Bf377d693Db5CabE)
    ){
    }
}