...
Eat The Drip Smart Contract

Buy: 1% Auto Burn 1% dev 1% lp 2% marketing 5% Drip Rewards
Sell: 1% Auto Burn 1% dev 1% lp 2% marketing 10% Drip Rewards

//Telegram: https://t.me/eatthedripbsc
...
contract ETD is ERC20, Ownable {
    ...
    ETDDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Eat The Drip", "ETD") {
        marketingWallet = payable(0xe93BD1dE1E5d5ac7Cb70D69617ed36ABA185ea01);
        devWallet = payable(0x3C2f373DBB7961864d21379980b49E4116Ef91fa);
        ...
        dividendTracker = new ETDDividendTracker(
            payable(this),
            router,
...
contract ETDDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "ETD_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "ETD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(ETDContract);

            uint256 prevBalance = ETDContract.balanceOf(address(this));
            ...
            {
                uint256 received = ETDContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    ETDContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
