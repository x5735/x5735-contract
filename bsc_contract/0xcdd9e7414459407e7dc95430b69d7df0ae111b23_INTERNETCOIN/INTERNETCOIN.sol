...
contract INTERNETCOIN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xcFC46cB90FE1DF1631e536d5b8C0AC49fecfe617;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "INTERNET COIN";
    string constant _symbol = "$NETCOIN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000000000 * 10**0 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xcFC46cB90FE1DF1631e536d5b8C0AC49fecfe617;
