...
contract LTR is ERC20 {
	...
	address private _fundAddress = address(0x476E717408E12b67C1995f96102217d22aEa1Fd6);
    ...
    constructor(address tokenOwner) ERC20("Lord of the Rings", "LTR") {
        ...
        STC = IERC20(0x74cE1d7cB34C87b1Bb9165e666B4378F74C9Dc6c);//stc
	...
	function _splitOtherToken() private {
		...
		if(thisLtrAmount > 2 * 10**17){ thisLtrAmount = 2 * 10**17;}else{thisLtrAmount = 0;}
