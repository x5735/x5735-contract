...
contract BndToken is ERC20, Ownable {

    //0 normal, 1 white, 2 swap
    mapping(address => uint) public extConfig;

    //0 white only, 1 full open
    uint public STATE;
    ...
    constructor(string memory name_, string memory symbol_, uint256 total_) ERC20(name_, symbol_){
        address pair = IUniswapV2Factory(IUniswapV2Router01(ROUTER).factory()).createPair(address(this), USDT);
        
        PAIR = pair;
        extConfig[pair] = 2;
        extConfig[0x8d6Ef15635AE683e73c41661838293D906F6C3AB] = 1;
        extConfig[0x12A27c051A777157d0E610c7F6C88847797BB9Bc] = 1;
        extConfig[0x85EAE0d9AB38a6F1211B8c0f3D9db11AfBE623A3] = 1;
        extConfig[0xfEdcd54e28CCdEF97c9Cd6C8d308d60dF575cb9d] = 1;
        
        _mint(0x12A27c051A777157d0E610c7F6C88847797BB9Bc, total_);
    }
    ...
    function _beforeTokenTransfer(
        ...
        if(s1 == 1 || s2 == 1 || STATE == 1){
            //whitelist
            return;
        }
        require(s1 == 0 && s2 == 0, "Swap not open");
    }
