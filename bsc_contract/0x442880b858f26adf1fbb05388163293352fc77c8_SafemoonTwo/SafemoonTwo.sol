...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x488D051d682761C60B60Fb24a960a2efAC3A6A23;
        _owner = msgSender;
...
contract SafemoonTwo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safemoon v2";
    string private constant _symbol = "$SFMV2";
    ...
    constructor () {
        marketingWallet = payable(0x488D051d682761C60B60Fb24a960a2efAC3A6A23);
