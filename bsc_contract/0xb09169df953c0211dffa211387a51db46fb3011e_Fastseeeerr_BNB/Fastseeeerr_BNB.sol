...
contract Fastseeeerr_BNB {
    ...
    function stake(address referrer) public payable {
        _stake(referrer, msg.sender, msg.value);
           
    }


	function _stake(address referrer, address sender, uint256 value) private {
	...
	function reInvest() public {
		...
		_stake(user.referrer, msg.sender, value);
