...
/**
 *The first Shibarium Bridge on Binance Smart Chain. www.shibridgebsc.com https://t.me/Shibridgebsc
*/
...
library SafeMath {
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "SafeMath: addition overflow & bridge");

        return c;
    }
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "SafeMath: subtraction overflow & bridge");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "SafeMath: multiplication overflow use only $BONE $SHIRBRIDGE");
...
contract SHibridge is Ownable, IBEP20 {
    ...
    string constant _name = "SHibridge";
    string constant _symbol = "SHibridge";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0x35Ac6AA1688F298D4e958e28Ba3a54462ee1B6a0;
        marketingFeeReceiver = 0x35Ac6AA1688F298D4e958e28Ba3a54462ee1B6a0;
