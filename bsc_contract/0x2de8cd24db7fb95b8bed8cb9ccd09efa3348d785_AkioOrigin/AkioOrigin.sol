...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD313DE2d7e51203542EAeB860B1fd60a18c9C62b; // owner address
...
contract AkioOrigin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Akio Origin";
    string private _symbol = "AKIOORIGIN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xD313DE2d7e51203542EAeB860B1fd60a18c9C62b); // Marketing Address
    address payable private teamWalletAddress = payable(0xD313DE2d7e51203542EAeB860B1fd60a18c9C62b); // Team Address
