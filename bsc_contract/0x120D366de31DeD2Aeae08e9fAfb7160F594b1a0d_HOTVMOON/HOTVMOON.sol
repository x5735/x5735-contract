...
abstract contract Token is IERC20, Ownable {
    ...
    uint256 public _sellFundFee = 165;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                swapFee = _buyFundFee + _buyLPDividendFee+_burnFee;
            }
        ...
        lockTheSwap
    {
        ...
        uint256 sellFundAmount = (fistBalance * _sellFundFee) / swapFee;
         uint256 burnFeeAmount = (fistBalance * _burnFee) / swapFee;
        FIST.transferFrom(
            address(_tokenDistributor),
            buyFundAddress,
            buyFundAmount
...
contract HOTVMOON is Token {
    constructor()
        Token(
            ...
            address(0xa2dDb8055cd4496B40EA72bc4F7e34DF180e4F0A) //receiver
        )
    {}
}