...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc3999A7422c8fd0Ac52d418909952112D48AB9F9; // owner address
...
contract The3DOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "3DOGE";
    string private _symbol = "$3DOGE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xc3999A7422c8fd0Ac52d418909952112D48AB9F9); // Marketing Address
    address payable private teamWalletAddress = payable(0xc3999A7422c8fd0Ac52d418909952112D48AB9F9); // Team Address
