...
/**
 *TG: https://t.me/MiniOptimusInu
 with 3% $OPTIMUSINU REWARDS 
*/
...
contract MiniOptimusInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = " Mini Optimus Inu ";
    string constant _symbol = " $MINIOPTIMUS ";
