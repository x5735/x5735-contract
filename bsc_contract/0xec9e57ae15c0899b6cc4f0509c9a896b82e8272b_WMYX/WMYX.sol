...
contract WMYX is ERC20 {
	...
	address _fundAddress = address(0xABbad0b3105594B384ee7657Af5ac991c90187CB);
    ...
    constructor(address tokenOwner) ERC20("WMYX", "WMYX") {
		...
		ordinaryNft = UsdtWarp(0x67f5787Bb15123B95278f4b5b271F0BE0A655961);//Nft Contract
    ...
    function swapAndLiquify() public {
		...
		if(allTokenAmount >= 10**19){
			...
			if(allAmount > oldAmount){
				...
				USDT.transfer(_fundAddress, newAmount.div(6));
				nftAmount = nftAmount.add(newAmount.div(6));
			}
		}
    }
