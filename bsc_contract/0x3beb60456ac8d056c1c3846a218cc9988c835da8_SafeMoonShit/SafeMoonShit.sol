...
contract SafeMoonShit is Context, IERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;

    string private constant _name = "SafeMoonShit";
    string private constant _symbol = "SFMSHIT";
    ...
    uint256 public _maxWallet = 4_000_000 * 10**18;
    ...
    function _transfer(
        ...
        require(_isExcludedFromMaxWallet[to] || balanceOf(to) + amount <= _maxWallet, "Transfer amount exceeds the maxTxAmount.");
