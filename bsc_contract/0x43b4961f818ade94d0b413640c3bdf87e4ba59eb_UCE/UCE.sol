...
contract UCE is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "United Crypto Exchange";
    string public _symbol= "UCE";
     bool balances1 = true;
    ...
    address payable public MarketingAddress = payable(0x61cB9E9f258fEfA1f69D05bb5148AE8b32D27c8d); // Marketing Address
