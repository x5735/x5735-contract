...
contract SNSToken is BEP20 {
    ...
    constructor() BEP20('WSNS', 'WSNS', 18) public {
        //dev
        // _mint(msg.sender, _total * (10 ** uint256(decimals)));
        //prod
        _mint(address(0xa01BaAD8e51538B9Ae6905BA6f0F6595BaD1a6ad), 2100 * 10000 * (10 ** uint256(18)));
    ...
    function _beforeTokenTransfer( address sender, address recipient, uint256 _amount )internal override returns (uint256){
        ...
        }else if(recipient == uniswapV2Pair) { // Âô³ö
