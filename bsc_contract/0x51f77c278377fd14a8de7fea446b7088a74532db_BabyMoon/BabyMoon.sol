...
contract BabyMoon is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xCa7a7C6df4A16086676aA265E9b7B45B3D3a13d0);
    address payable private _marketingAddress = payable(0xCa7a7C6df4A16086676aA265E9b7B45B3D3a13d0);
