...
contract test is IERC20 {
    ...
    uint256 constant public maxRoundTripTaxes = 2000;
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xcfA4d14147DcCa9094f75e361cAE6431A0E2Df1F),
        buyback: payable(0xcfA4d14147DcCa9094f75e361cAE6431A0E2Df1F)
    });
...
//===============================================================================================================
    ...
    function setTaxes(uint16 buyFee, uint16 sellFee, uint16 transferFee) external onlyOwner {
        ...
        require(buyFee + sellFee <= maxRoundTripTaxes, "Cannot exceed maximums.");
        _taxRates.buyFee = buyFee;
        _taxRates.sellFee = sellFee;
        _taxRates.transferFee = transferFee;
    }

    function setRatios(uint16 burn, uint16 buyback, uint16 marketing) external onlyOwner {
        _ratios.burn = burn;
