...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setBuyFee(
        uint256 lpDividendFee, uint256 fundFee, uint256 nftFee, uint256 lpFee
    ) external onlyOwner {
...
contract FOY is AbsToken {
    constructor() AbsToken(
        ...
        address(0xb0e901BA4DFf0C3C40aA9521c64F1EF74030378A),

        address(0x70C43Ff75a5834d3677960aCF74D2F7f774FEdbc),
