...
contract BOBOCAT is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xd41b00f5eE914D7BdbD62a780FE21132EcC4C008;
    address public devAddress = 0xd41b00f5eE914D7BdbD62a780FE21132EcC4C008;

    string private constant _name = "B0B0CAT";
    ...
    Taxes public taxes = Taxes(5,0,2,1);
    Taxes public sellTaxes = Taxes(5,0,2,1);
