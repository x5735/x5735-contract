...
Donald Trump is back on all platforms. Donald Doge just joined the BSC !
Safe memetoken with lowtax. 
Liquidity locked.
Ownership renounced.
...
https://t.me/DonaldDogeBSC

https://twitter.com/donald_dogee
...
contract DonaldDoge is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Donald Doge";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x071165bfF6081DDcf6fba70600c9a620cb838BDc;
        marketingWallet = 0x071165bfF6081DDcf6fba70600c9a620cb838BDc;
        devWallet = 0x071165bfF6081DDcf6fba70600c9a620cb838BDc;
