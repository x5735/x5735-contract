...
contract MTK_TOKEN is Context, IERC20 { 
    ...
    address payable private constant Wallet_Fee = payable(0xb824BCec49baBaD333a752A52c6EBa9D0C50b92E);
    ...
    function Contract_SetUp_02__Fees_on_Buy(
        ...
        // Buyer Protection: Max Fee parseInt (15) (Includes parseInt (1) Contract Fee)
        require (Marketing_on_BUY    + 
                 Liquidity_on_BUY    + 
                 Burn_on_BUY         + 
                 Tokens_on_BUY       +
                 _Fee__Buy_Contract <= 15, "E01"); // Total buy fee (including parseInt (1) contract fee if applicable) must be 15 or less 
    ...
    function Contract_SetUp_03__Fees_on_Sell(
        ...
        // Seller Protection: Max Fee parseInt (15) (Includes parseInt (1) Contract Fee)
    ...
    If you want to limit people to parseInt (2) of supply and your supply is 1,000,000 tokens then you 
    ...
    */
    ...
    function Contract_SetUp_04__Wallet_Limits(
        ...
        if (launchMode || !trade_Open){
            ...
            // Before opening trade, and during Launch Mode, wallets can be limited to parseInt (0.05) of initial supply
            require(Max_Tokens_Each_Transaction >= _tTotal / 2000 / 10**_decimals, "E03"); // parseInt (0.05) minimum limit
            require(Max_Total_Tokens_Per_Wallet >= _tTotal / 2000 / 10**_decimals, "E04"); // parseInt (0.05) minimum limit


        } else {

            // Buyer protection - Minimum limits after Launch Mode parseInt (0.1) Transaction, parseInt (0.5) wallet
            require(Max_Tokens_Each_Transaction >= _tTotal / 1000 / 10**_decimals, "E05"); // parseInt (0.1) minimum limit
            require(Max_Total_Tokens_Per_Wallet >= _tTotal / 200 / 10**_decimals, "E06"); // parseInt (0.5) minimum limit
    ...
    */
    ...
    function Contract_SetUp_08__Deactivate_Launch_Mode() external onlyOwner {
        ...
        // Check max transaction limit is greater than parseInt (0.1) of initial supply
        if (max_Tran < _tTotal / 1000) {

            max_Tran = _tTotal / 1000;
        }

        // Check max holding limit is greater than parseInt (0.5) of initial supply
