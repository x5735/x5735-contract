...
/*
ETA has been set for the launch its to organize all callers for our marketing just stay tuned keep your eyes on the chat as vc timer already set
...
contract SanjiroInu is IBEP20, Auth {
    ...
    address constant DEV = 0xB1428d1B435a37A1cBB6291B1b7496bA047eb984;


    string constant _name = "Sanjiro Inu";
