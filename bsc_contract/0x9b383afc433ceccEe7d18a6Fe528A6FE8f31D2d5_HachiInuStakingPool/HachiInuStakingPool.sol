...
contract HachiInuStakingPool is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IBEP20(0x9811da974764AEd559a1DAEEEfA7E25896d36D47);
    ...
    function startReward() external onlyOwner {
        require(poolInfo[0].lastRewardTimestamp == 26944982, "Can only start rewards once");
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        if(pool.lastRewardTimestamp == 26944982){
            return 0;
        }
