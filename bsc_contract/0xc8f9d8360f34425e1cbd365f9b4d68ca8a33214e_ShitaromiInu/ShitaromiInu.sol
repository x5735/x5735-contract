...
contract ShitaromiInu is Context, IERC20, Ownable {
    ...
    string private constant _name = " Shitaromi Inu "; // 
    string private constant _symbol = " $SHITA "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x96509aA64AFf9325Fd0A051854fb439604350c7F;
