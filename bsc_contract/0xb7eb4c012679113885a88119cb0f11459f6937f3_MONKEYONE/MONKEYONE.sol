...
contract MONKEYONE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MONKEY-1";
    string private _symbol = "MONKEY-1";
    ...
    uint256 private minimumTokensBeforeSwap = 450000 * 10**9; 
