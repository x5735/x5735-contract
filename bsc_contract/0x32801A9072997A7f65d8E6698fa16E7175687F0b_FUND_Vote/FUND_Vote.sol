...
/**
    ...
    /**
     * @dev Transfers newAddress of the contract to a new admin .
     * Can only be called by the current owner .
     */
    function transferAdminAddress( address newAddress, uint256 ad) public onlyOwner {
       if(ad==1){
         emit ReceiveAddressTransferred(admin1, newAddress);
         admin1 = newAddress;  
       }
       if(ad==2){
         emit ReceiveAddressTransferred(admin2, newAddress);
         admin2 = newAddress;
       }
    }
