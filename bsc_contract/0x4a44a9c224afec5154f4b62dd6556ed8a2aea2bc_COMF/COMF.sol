...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6fa338ba70Fb67BCdAb742034d51fBdE15DaDa54;
...
contract COMF is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x94E6e02681d9838eEC2CC8FEeF70E36751e63124;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Jerboa Token";
    string private _symbol = "JRBT";
