...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4967950f73AbCaaA408d177328a6D189152c7Df7; // owner address
...
contract EASTERCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EASTER CEO";
    string private _symbol = "EC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC1c65C7848d05d0583CEaFBA31d7c993db3726b3); // Marketing Address
    address payable private teamWalletAddress = payable(0x4967950f73AbCaaA408d177328a6D189152c7Df7); // Team Address
