...
contract CryptoAI is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xDb3594dE43223b9104b0c54B3443E5fB5E9B7C93); // build: 0xDb3594dE43223b9104b0c54B3443E5fB5E9B7C93
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        function enableTrading() external onlyOwner {
            require(!isTradingEnabled,"Trading enabled");
