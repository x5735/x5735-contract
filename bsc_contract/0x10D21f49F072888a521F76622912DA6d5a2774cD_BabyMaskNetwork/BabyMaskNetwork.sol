...
https://t.me/BABYMASKBSC

$MASK IS SENDING!!
BABY MASK GIVES 4% REWARDS IN $MASK
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x2eD9a5C8C13b93955103B9a7C167B67Ef4d568a3);
...
contract BabyMaskNetwork is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Mask";
    string constant _symbol = "BabyMask";
