...
contract R5 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3c7b16a0bB65522f97Ba1241beb7e75666714965); 
    address payable public Wallet_Dev = payable(0x3c7b16a0bB65522f97Ba1241beb7e75666714965);
    ...
    string private constant _symbol = unicode"R5";
    ...
    uint256 public swapThreshold = _tTotal / 1000;
    ...
    function _transfer(
        ...
        {  
            ...
            if(contractTokenBalance > swapThreshold) {contractTokenBalance = swapThreshold;}
            txCount = 0;
