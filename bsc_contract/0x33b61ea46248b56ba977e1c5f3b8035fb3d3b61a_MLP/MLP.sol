...
contract MLP is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x9225ead901D9A1AbC7fB2EFd9Adf6e8790534983); 
    address payable public developmentAddress = payable(0x9225ead901D9A1AbC7fB2EFd9Adf6e8790534983); 
    address payable public charityAddress = payable(0x9225ead901D9A1AbC7fB2EFd9Adf6e8790534983); 
    address payable public vaultRewardAddress = payable(0x9225ead901D9A1AbC7fB2EFd9Adf6e8790534983); 
    ...
    string private constant _name = "Multi Level Processing";
