...
Chester Chicken is the Next Meme coin and will be setting the trend 
TG : https://t.me/ChesterChicken
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB59B744331Ce3AC2a21987Ee0098f4e422443824;
...
contract ChesterChicken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Chester Chicken"; // 
    string private constant _symbol = "CC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 5;
    address payable public  _marketingWallet = payable(0xB59B744331Ce3AC2a21987Ee0098f4e422443824);
