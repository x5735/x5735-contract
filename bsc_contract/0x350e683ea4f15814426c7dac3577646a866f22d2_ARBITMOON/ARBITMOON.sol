...
contract ARBITMOON is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ARBITMOONDividendTracker public dividendTracker;
    ...
    constructor() ERC20("ARBITMOON", "ARB") {
        marketingWallet = payable(0x0a9204c7430D0FE1ebe4b7093833DC37adD4EaE9);
        devWallet = payable(0x0a9204c7430D0FE1ebe4b7093833DC37adD4EaE9);
        ...
        dividendTracker = new ARBITMOONDividendTracker(
            payable(this),
            router,
...
contract ARBITMOONDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    ARBITMOON public ARBITMOONContract;
    ...
    constructor(
        ...
        defaultToken = token;
        ARBITMOONContract = ARBITMOON(mainContract);
    ...
    function _transfer(
        ...
        require(false, "ARBITMOON_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "ARBITMOON_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ARBITMOON contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(ARBITMOONContract);

            uint256 prevBalance = ARBITMOONContract.balanceOf(address(this));
            ...
            {
                uint256 received = ARBITMOONContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    ARBITMOONContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
