...
contract PlanetZapOneInch {
    ...
    */
    ...
    @param _outputToken Address of output token 
    */ 
    function swap (address _inputToken, uint256 _tokenInAmount, bytes calldata _token0, address _outputToken) external payable {
    ...
    */ 
    ...
    @param _pair Address of the output LP Pair token
    */
    function zapIn (address _inputToken, uint256 _tokenInAmount, bytes calldata _token0, bytes calldata _token1, WantType _type, address _router, address _pair) public {
        require(_tokenInAmount >= minimumAmount, 'Planet: Insignificant input amount');
