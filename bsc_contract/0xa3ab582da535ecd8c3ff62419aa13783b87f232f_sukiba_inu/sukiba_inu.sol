...
Sukiba Inu is the revolutionary new crypto meme token that¡¯s aiming to take the blockchain by storm! 
Low Tax and Renounce!

Telegram: https://t.me/sukibainu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF87861B5885F6D0c182FE8C0f8aDcff2A3d0EbA6; // owner address
...
contract sukiba_inu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Sukiba Inu";
    string private _symbol = unicode"SUKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF87861B5885F6D0c182FE8C0f8aDcff2A3d0EbA6); // Marketing Wallet
    address payable public teamWalletAddress = payable(0xF87861B5885F6D0c182FE8C0f8aDcff2A3d0EbA6); // Dev Wallet
