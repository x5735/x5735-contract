...
/**
Baby NGA Tiger Binance SmartContract 

Telegram: https://t.me/babyngatiger

Earn 3% reward on NGA Tiger when you hold Baby NGA Tiger
...
contract BabyNGATiger is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BabyNGATigerDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Baby NGA Tiger", "BNGA") {
        marketingWallet = payable(0xEe2E938abBDD13904846ae5ddB3fea3417ef7C94);
        devWallet = payable(0xEe2E938abBDD13904846ae5ddB3fea3417ef7C94);
        ...
        dividendTracker = new BabyNGATigerDividendTracker(
            payable(this),
            router,
    ...
    function updateFees(
        ...
        require(totalSellFees <= 19 && totalBuyFees <= 19, "total fees cannot exceed 19% sell or buy");
...
contract BabyNGATigerDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BabyNGATiger public BabyNGATigerContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BabyNGATigerContract = BabyNGATiger(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BabyNGATiger_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BabyNGATiger_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyNGATiger contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BabyNGATigerContract);

            uint256 prevBalance = BabyNGATigerContract.balanceOf(address(this));
            ...
            {
                uint256 received = BabyNGATigerContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BabyNGATigerContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
