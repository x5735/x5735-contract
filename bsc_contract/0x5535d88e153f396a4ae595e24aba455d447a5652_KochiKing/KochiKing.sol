...
contract KochiKing is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "KochiKing";
    string private _symbol = "KochiKing";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x2264A2EBEa11B4b21f366a9f5E086C8FaE82a27f);
