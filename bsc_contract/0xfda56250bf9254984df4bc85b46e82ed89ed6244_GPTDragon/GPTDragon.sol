...
contract GPTDragon is Context, IERC20, Ownable {
    ...
    address payable private _dev = payable(0xcc29f0D310C604218a03841F2333c1169F6df7e5);
    address payable private _mkt = payable(0xfD64F4912825B9b3D325ef4bBac22c711026F073);
    
    string private constant _name = "GPT-Dragon";
    string private constant _symbol = "GPT-DRG";
