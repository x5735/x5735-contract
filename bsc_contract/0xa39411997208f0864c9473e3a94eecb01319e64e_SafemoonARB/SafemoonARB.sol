...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9e14ed0B75c535BeBe9B65b169C7F4ddDEF4c8ab; // owner address
...
contract SafemoonARB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safemoon Arbitrum";
    string private _symbol = "Safemoon Arbitrum";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x9e14ed0B75c535BeBe9B65b169C7F4ddDEF4c8ab); // Marketing Address
    address payable public teamWalletAddress = payable(0x9e14ed0B75c535BeBe9B65b169C7F4ddDEF4c8ab); // Team Address
