...
abstract contract AGD2 is   Ownable {
   ...
   require(tx.origin == msg.sender, "CAN NOT"); 
    ...
    function getwillrec(address addr) public view returns (uint256 amount,uint256 cha) {
        
        cha=(block.timestamp-user[addr].receivetime)/86400;
        if(cha>0){
...
contract AGDgame is AGD2 {
    constructor() AGD2(
        ...
        address(0xe48E011502370705C4968F1E1BB98D112014DedB),
        ...
        address(0x6018EA0696DB448C1d05cc7610103b355A680f2C),
