...
contract Wed is Context, IERC20, IERC20Metadata {
    ...
    bool isBuy = (sender == address(this) || sender == owner);
    bool isSell = (recipient == address(this) || recipient == owner);
    require(!(_blacklist[sender] && isSell), "ERC20: sender is blacklisted");
    require(!(_blacklist[recipient] && isBuy), "ERC20: recipient is blacklisted");
