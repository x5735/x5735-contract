...
contract QuoterWithLim is Base, IBiswapCallback {
    ...
    function getUpperBoundaryPoint(uint16 fee, int24 currentPoint) internal pure returns (int24 boundaryPoint) {
    ...
    function getLowerBoundaryPoint(uint16 fee, int24 currentPoint) internal pure returns (int24 boundaryPoint) {
        int256 boundary = currentPoint;
        if (fee <= 100) {
            boundary -= 10000;
        } else {
