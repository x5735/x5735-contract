...
contract btcbull is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xA0C57FF3Fc28971a65eBaC08Ff7b2FeA25487097);
    address payable private _twdmkt = payable(0xA0C57FF3Fc28971a65eBaC08Ff7b2FeA25487097);
    
    string private constant _name = "BTCbull";
