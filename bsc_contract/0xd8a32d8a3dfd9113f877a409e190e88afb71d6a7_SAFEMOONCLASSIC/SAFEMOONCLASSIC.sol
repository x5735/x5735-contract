...
Telegram :https://t.me/SafemoonClassicOfficialBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaAEB3686651A9138f1Cdfe342b234995DBFD59D5; // owner address
...
contract SAFEMOONCLASSIC is Context, IERC20, Ownable {
    ...
    string private _name = "Safemoon Classic";
    string private _symbol = "SFM CLASSIC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8d677a6D21262B24317b2fCcbCd0DC86dE1b0C09); // Marketing Address
    address payable private teamWalletAddress = payable(0x8d677a6D21262B24317b2fCcbCd0DC86dE1b0C09); // Team Address
