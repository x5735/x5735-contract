...
contract MINT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb1069cA5BbBe8162723cb6B12c58cA6017B6a615); 
    address payable public Wallet_Dev = payable(0xb1069cA5BbBe8162723cb6B12c58cA6017B6a615);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "Mint"; 
