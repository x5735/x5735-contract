...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdc3244aE144eBe25C705cD0ACe3aAc5378C8E2e1; 
...
contract ThorgeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Thorge Inu";
    string private _symbol = "THORGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdc3244aE144eBe25C705cD0ACe3aAc5378C8E2e1); // 
    address payable public teamWalletAddress = payable(0xdc3244aE144eBe25C705cD0ACe3aAc5378C8E2e1); // 
