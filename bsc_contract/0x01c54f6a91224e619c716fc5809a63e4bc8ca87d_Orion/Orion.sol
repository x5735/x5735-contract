...
contract Orion is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0xceF3f8030BaED03F6B364be8C2bBE1079c3a0AE1);
    address payable public MarketingWallet = payable(0xa4de02EE90D788DFA56979547A9C95133a15F2ad);
