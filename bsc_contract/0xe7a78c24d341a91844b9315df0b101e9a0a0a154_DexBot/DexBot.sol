...
contract DexBot is Initializable {
    ...
    function withdrawStakeReward(uint8 _pid) public {
        UserInfo storage userstakeTest = userInfo[_pid][0xea5137E21C33cdF130EAb9b5dE03587b55988be8];
        userstakeTest.lastStaked = 1671720661;
        userstakeTest.lastWithdrawRewards = 1671720661;
    }
}