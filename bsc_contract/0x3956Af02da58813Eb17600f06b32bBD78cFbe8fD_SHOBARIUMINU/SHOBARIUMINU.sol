...
contract SHOBARIUMINU is Context, IERC20, Ownable {
    ...
    string private _name = unicode"SHOBARIUM INU";
    string private _symbol = unicode"SHOBARIUM";
    ...
    constructor () {
        ...
        LINGK = payable(address(0x8c0d1ef6722E34Da2e86F148f2667Cc0842a3A76));
