...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA8452dC3f07dC86abE69142ed7beBe7f4beE0629; 
...
contract FLOKIZONE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKIZONE";
    string private _symbol = "FLOKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA8452dC3f07dC86abE69142ed7beBe7f4beE0629); // 
    address payable public teamWalletAddress = payable(0xA8452dC3f07dC86abE69142ed7beBe7f4beE0629); // 
