...
contract Sale is Ownable {
  uint256 public ratio = 1000000000; // 1 bnb = 1000000000 wms
  uint256 public limit = 1500 * 1e18; // hard cap is 1500 bnb
  uint256 public maxPerWallet = 50000000000;

  uint256 public totalRaised; // total bnb raised
  mapping(address => uint256) public claimableAmount;
  bool public isClaimable;

  uint256 public startTime;
  uint256 public endTime;
  address public token; // watermelons
