...
contract CHICKENCEOFLOKI is ERC20, Ownable {
    ...
    constructor(address _router) ERC20("Chicken Ceo Floki", "CHICKENCEOFLOKI") payable
    {
        ...
        // Sell Taxes
        sellTaxes["marketing"] = 700;
        sellTaxes["dev"] = 50;
        sellTaxes["liquidity"] = 50;

        // External wallets 
        taxWallets["marketing"] = 0xa1f06e048776F21f3660CbE6867070c71655A43C;
        taxWallets["dev"] = 0x1782088B061B8c7fC3cba2ae20478E5A06A64B57;

        maxTxAmount = initialSupply * 300 / 10000;
        maxOwnedAmount = initialSupply * 100 / 10000;
