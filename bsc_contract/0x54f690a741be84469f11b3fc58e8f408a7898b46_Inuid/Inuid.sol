...
contract Inuid is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Inu id";
    string private _symbol = "Inuid";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf73451987125b9A4D84Abfb1249D2fd13d8bFfa2); // Marketing Address
    address payable public teamWalletAddress = payable(0xf73451987125b9A4D84Abfb1249D2fd13d8bFfa2); // Team Address
