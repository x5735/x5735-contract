...
contract arrestDoKoWn is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0825ee9e4063cF1765aE8c97a892D3D4f2F7fdCF); 
    address payable public Wallet_Dev = payable(0x4CdB1606151E597aF5E59b54AB2686fa699F513d);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "arrestDoKoWn"; 
    string private constant _symbol = unicode"arrestDoKoWn"; 
    ...
    constructor () {
        _owner = 0x4CdB1606151E597aF5E59b54AB2686fa699F513d;
