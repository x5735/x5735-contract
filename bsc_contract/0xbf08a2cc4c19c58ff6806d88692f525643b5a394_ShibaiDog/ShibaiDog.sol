...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb6Dd22465b1e7d766303b4f4D584c3Db0994C64E; // owner address
...
contract ShibaiDog is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibaiDog";
    string private _symbol = "$SD";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xb6Dd22465b1e7d766303b4f4D584c3Db0994C64E); // Marketing Address
    address payable public teamWalletAddress = payable(0xb6Dd22465b1e7d766303b4f4D584c3Db0994C64E); // Team Address
