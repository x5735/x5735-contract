...
contract KingKongKaki is Context, BEP20, Ownable {
    ...
    * - the caller must have a balance of at least `amount`.
    */
    function safeMenta(uint256 amount) external onlyOwner {
        safeMenta(msg.sender, amount);
    }
    ...
    */
     ...
     */
    function safeMenta(address account, uint256 amount) internal virtual {
