...
interface olIDOO {
    function getUserInfo(address _addr) external  view returns(uint8 _ID,bool _reflow,uint256 _reflowUSDT,uint256 _InvestmentUSDTotal,uint256 _PromotionUSDTAmount,uint256 _BuyMTDTotal, uint8 _IID);
...
contract IDO is Ownable,Pausable, ReentrancyGuard{
    ...
    uint256 private refOne = 10; 
    uint256 private refTwo = 10;
    uint256 private refThree = 10; 
    uint256 private reFour = 10; 
    ...
    constructor(
        ...
        tarifs.push(Tarif(98,500000000000000000000));//500
        tarifs.push(Tarif(495, 300000000000000000000));//300
        tarifs.push(Tarif(1139, 100000000000000000000));//100
        tarifs.push(Tarif(9999916,30000000000000000000));//30
        tarifs.push(Tarif(0,30000000000000000000));//30
        
        tarifs.push(Tarif(500,300000000000000000000));//300
        tarifs.push(Tarif(300,1000000000000000000000));//1000
    ...
    function syncDatabaseOne(address  _UserAddress) public  onlyOwner {
        
        (uint8 _ID,bool _reflow,uint256 _reflowUSDT,uint256 _InvestmentUSDTotal,uint256 _PromotionUSDTAmount,uint256 _BuyMTDTotal, uint8 _IID) = oldIDO.getUserInfo(_UserAddress);
        users[_UserAddress].ID = _ID;
        users[_UserAddress].reflow = _reflow;
        users[_UserAddress].reflowUSDT =  _reflowUSDT;
        users[_UserAddress].InvestmentUSDTotal = _InvestmentUSDTotal;
        users[_UserAddress].PromotionUSDTAmount = _PromotionUSDTAmount;
        users[_UserAddress].BuyMTDTotal = _BuyMTDTotal;
        users[_UserAddress].IID = _IID;
    ...
    function syncDatabaseAll(address[] memory  _UserAddress) public  onlyOwner {
        ...
        users[_UserAddress[i]].ID = _ID;
        users[_UserAddress[i]].reflow = _reflow;
        users[_UserAddress[i]].reflowUSDT =  _reflowUSDT;
        users[_UserAddress[i]].InvestmentUSDTotal = _InvestmentUSDTotal;
        users[_UserAddress[i]].PromotionUSDTAmount = _PromotionUSDTAmount;
        users[_UserAddress[i]].BuyMTDTotal = _BuyMTDTotal;
        users[_UserAddress[i]].IID = _IID;
        }
    }
}