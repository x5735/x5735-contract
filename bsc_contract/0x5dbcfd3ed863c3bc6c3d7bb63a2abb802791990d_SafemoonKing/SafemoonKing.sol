...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBE08C82c0152383c10Ae95aA163eD9131b0d64C3; // owner address
...
contract SafemoonKing is Context, IERC20, Ownable {
    ...
    string private _name = "SafemoonKing";
    string private _symbol = "SFMKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBE08C82c0152383c10Ae95aA163eD9131b0d64C3); // 
    address payable public teamWalletAddress = payable(0xBE08C82c0152383c10Ae95aA163eD9131b0d64C3); // 
