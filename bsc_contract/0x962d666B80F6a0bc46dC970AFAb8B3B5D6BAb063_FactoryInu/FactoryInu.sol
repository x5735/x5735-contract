...
contract FactoryInu is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0x6A4a38975E68FEE51F2839CBA9591c886c5dA154);
        teamAddress= payable(0x479f6d1764C22d73a0b53cb8E094bE2B8eDE0601);
        ...
        _maxOnceNum = 10000000000 * 10**_decimals;
        _maxTotalNum = 10000000000 * 10**_decimals;
