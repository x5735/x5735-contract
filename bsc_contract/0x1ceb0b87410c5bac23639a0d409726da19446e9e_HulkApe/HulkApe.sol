...
contract HulkApe is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hulk Ape"; // 
    string private constant _symbol = "$HAPE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x7A5450E49F9155E09a27A22c5ac32e16a1D8af62);
