...
contract Dolphinu is Context, IERC20, Ownable {
    ...
    string private _name = "DolphInu";
    string private _symbol = "DolphInu";
    ...
    address public _marketingWallet =
        payable(address(0x4ff8450D8e44069B9ddB65431e87E68eA36fDD16));
    ...
    constructor() {
        ...
        maxSellAmount = totalSupply().mul(1000).div(100000); // 1% of the supply
        maxBuyAmount = totalSupply().mul(1000).div(100000);// 1% of the supply
        maxWalletAmount = totalSupply().mul(20).div(1000); // 2% of the supply
