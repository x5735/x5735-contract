...
contract StakingContract is Ownable {
    ...
    function calculateReward(address staker) public view returns (uint256) {
        ...
        uint256 reward = stakedAmount * rewardRate * timeSinceLastClaim / (1 days * 1000);
        return reward;
    }
    function updatetokenaddr(address _newTokenAddr) public onlyOwner {
     ...
     function setrewardRate(uint256 percent) public onlyOwner{
        require(percent <= 1000, "Reward percentage cannot be more than 1000.");
        rewardRate = percent;
    }
