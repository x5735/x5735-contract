...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1A59F068F2520346d07F0Dea6BDa015c9CBce4fe;
...
contract GPTFinance is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5c68fec308c06876D66C95862301FaEb6bbEe086;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "GPT Finance";
    string private _symbol = "GPTF";
