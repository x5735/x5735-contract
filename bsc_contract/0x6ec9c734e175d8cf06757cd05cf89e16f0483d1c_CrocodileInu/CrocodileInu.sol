...
/*
   Telegram: https://t.me/CrocodileinuOfficial
   Twitter : https://twitter.com/CrocodileInu
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x690b69f16C0b34988B58334D5750346072f1C088; 
...
contract CrocodileInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crocodile Inu";
    string private _symbol = "CROCODILE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x690b69f16C0b34988B58334D5750346072f1C088); // 
    address payable public teamWalletAddress = payable(0x690b69f16C0b34988B58334D5750346072f1C088); // 
