...
/**
 *THE TOKEN OF DESTINY

 THE FIRST TOKEN ON BSC WHERE THE COMMUNITY WILL CHOOSE ITS FATE.
 FOR TOO LONG THE TOKENS ON BSC HAVE BEEN IN THE HANDS OF THE DEVS AND THE COMMUNITY HAS CONTINUED TO JUST ASK FOR MARKETING,
 TO TELL THE DEVS WHAT TO DO AND HOW TO DO IT , NOW IT'S TIME FOR A CHANGE, 
 I'M LEAVING THIS TOKEN IN YOUR HANDS, WILL YOU BE ABLE TO HANDLE IT?
 START THE GAME
 TAX 0/0
 OWNERSHIP RENOUNCED
 TG: CREATE ONE
...
contract THETOKENOFDESTINY is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TOKENOFDESTINY";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet =  0x328fcD89a28a93E16C90F282E451cd1C3e662164;
