...
contract BNBYFI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBYFI";
    string private _symbol = "BNBYFI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc6C811d704842c2Ce9cd0f458f36D6856764CA1B);
    address payable public teamWalletAddress = payable(0xc6C811d704842c2Ce9cd0f458f36D6856764CA1B);
    address public immutable deadAddress = 0xc6C811d704842c2Ce9cd0f458f36D6856764CA1B;
