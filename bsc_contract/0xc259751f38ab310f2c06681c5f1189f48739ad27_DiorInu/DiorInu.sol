...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0825dB5428Dd6643F079779210B8c0Cf82aA08e1; // owner address
...
contract DiorInu is Context, IERC20, Ownable {
    ...
    string private _name = " Dior Inu ";
    string private _symbol = "$DINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0825dB5428Dd6643F079779210B8c0Cf82aA08e1); // Marketing Address
    address payable public teamWalletAddress = payable(0x0825dB5428Dd6643F079779210B8c0Cf82aA08e1); // Team Address
