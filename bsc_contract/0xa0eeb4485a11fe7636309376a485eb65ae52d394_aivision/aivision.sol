...
//AI Vision, a revolutionary new utility crypto that empowers individuals to take control of their financial future.
//Our goal is to make cryptocurrency accessible to everyone, by providing tools and resources for users to securely store, manage and grow their investments. 
//With AI Vision, you can create your own custom portfolio, track the market and make informed decisions about your money. 
//Join us on our mission to make cryptocurrency the financial infrastructure of the future.

pragma solidity ^0.8.4;
// SPDX-License-Identifier: MIT

//TG Community -https://t.me/AiVisionBscCommunity
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x43C972B10D56cC2fF5c0e26C8fF9376Ab0e2B013;
...
contract aivision is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI VISION"; // 
    string private constant _symbol = "AIVISION"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x43C972B10D56cC2fF5c0e26C8fF9376Ab0e2B013);
