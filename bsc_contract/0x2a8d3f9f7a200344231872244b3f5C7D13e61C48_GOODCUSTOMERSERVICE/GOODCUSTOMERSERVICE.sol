...
// Telegram : https://t.me/GoodCustomerService
...
contract GOODCUSTOMERSERVICE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB027CaE1C91c491F95876a5d04c43074be427750); 
    address payable public Wallet_Dev = payable(0xef249D6313a95C0d307A243041BEa607da85Ae07);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "Good Customer Service"; 
    string private constant _symbol = unicode"$CUSTOMERSERVICE"; 
