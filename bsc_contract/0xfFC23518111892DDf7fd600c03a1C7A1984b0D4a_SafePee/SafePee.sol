...
contract SafePee is Context, IERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;

    string private constant _name = "SafePee";
    string private constant _symbol = "SAFEPEE";
    ...
    uint256 public _maxWallet = 8_000_000 * 10**18;
