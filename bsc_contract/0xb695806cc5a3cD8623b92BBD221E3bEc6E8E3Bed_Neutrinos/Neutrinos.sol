...
contract Neutrinos is IERC20 {
    ...
    string constant private _name = "Neutrinos";
    string constant private _symbol = "$NEUTR";
    ...
    address payable public marketingWallet = payable(0xd0EbAB6FAd0696eD8C59Ac3ACc04C2B5540C9385);
