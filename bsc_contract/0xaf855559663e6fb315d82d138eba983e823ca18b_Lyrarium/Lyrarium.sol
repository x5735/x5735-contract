...
// Telegram : https://t.me/lyrarium
// Website  : https://lyrarium.network/
...
contract Lyrarium is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xbfD4268Ef810C0638f92BAe6C504120bd88f23C5); 
    address payable public Wallet_Dev = payable(0x70efcE43f975b76712b83a8D82EE8f73879bE2c4);
    ...
    string private constant _name = "Lyrarium"; 
    string private constant _symbol = unicode"LYR"; 
    ...
    constructor () {
        ...
        _owner = 0x70efcE43f975b76712b83a8D82EE8f73879bE2c4;
