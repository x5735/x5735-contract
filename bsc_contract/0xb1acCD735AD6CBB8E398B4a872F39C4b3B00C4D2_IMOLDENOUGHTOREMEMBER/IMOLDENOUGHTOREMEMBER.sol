...
// Telegram : https://t.me/ImOldEnoughToRemember
...
contract IMOLDENOUGHTOREMEMBER is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x730E10A681894575549880981e1c4d0AE3E23049);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "Im Old Enough To Remember"; 
    string private constant _symbol = unicode"$IOETR"; 
