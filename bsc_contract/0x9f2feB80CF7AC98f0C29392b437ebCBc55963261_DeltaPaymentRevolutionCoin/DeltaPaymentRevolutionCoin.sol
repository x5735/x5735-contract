...
// ----------------------------------------------------------------------------
/// @title Delta Payment Revolution Coin
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
/// @title Website : https://dpr.finance/
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
/// @title Delta Payment Revolution Coin : ERC Token.
// ----------------------------------------------------------------------------
contract DeltaPaymentRevolutionCoin is  ERC20Interface, Context, Ownable, Whitelisted, Pausable {
    // Define public constant variables.
    ...
    constructor() {
        name              = "Delta Payment Revolution Coin";
        decimals          = 18;
        symbol            = "DPR";
