...
contract GrimaceGPT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Grimace GPT";
    string private constant _symbol = "GRIMGPT";
    ...
    function GRIMRewards(address[] calldata addresses) external onlyOwner {
