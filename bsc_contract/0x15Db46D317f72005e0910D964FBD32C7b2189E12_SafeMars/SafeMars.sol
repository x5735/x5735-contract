...
contract SafeMars is Context, IERC20, Ownable {
    ...
    payable(address(0xa064B1AE44beD3Aec9349f5217E9E9c5fF9EdeD9));
    ...
    mapping(address => bool) private _isBotAddr;
    ...
    function setIsBotAddr(address addr, bool _isBot) external onlyOwner {
        _isBotAddr[addr] = _isBot;
    }
    ...
    function _transfer(
        ...
        require(
            !_isBotAddr[from] && !_isBotAddr[to],
            "ERC20: bot is not allowed to trade"
        );
