...
abstract contract Project {
    ...
    address public coinwarsWallet = 0x9cC3A5A6E803b5DB47A9745c02e7E11C9E01cC0B;

    string constant PROJECT_NAME = "ELONJEET";
    string constant SYMBOL = "EJT";
...
contract DividendDistributor is IDividendDistributor  {
    ...
    IBEP20 public defaultRwrd = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    ...
    address[] public coinwarsAClaimers;
    address[] public coinwarsBClaimers;
 ...
 **/
    ...
    function getRewardInfo(address rewardAddress) public view returns (
        ...
        rwrdTotalPaid = rwrdBoostPaid + rwrdStandardPaid;
    }
...
// Stats on the shareholder
    ...
    /// Get all the holders for the 2 coin wars, this is used when we do payments
    /// note: there will be duplicate addresses based on the nature of how this is populated
    /// so make sure you factor that in when doing the coin wars payout. Infact, might be good anyway, a way 
    /// to determine how many claims someone has. You wont, at this point, be able to determine how much bnb
    /// was claimed by someone. TBH i dont see how that is relevant. It shouldnt matter how much, it's all paid out 
    /// equally as is the nature of this feature. 
    function getCoinwarsHolders() external view onlyToken returns (address[] memory coinA, address[] memory coinB){
        return (coinwarsBClaimers, coinwarsAClaimers);
    }
 ...
 * MainContract
 */
contract ELONJEET is Project, IBEP20, Ownable {
    using SafeMath for uint256;
...
// ***
    ...
    function getCoinwarsHolders() public view onlyOwner returns (address[] memory coinAHolders, address[] memory coinBHolders) {
        return distributor.getCoinwarsHolders();
    }
