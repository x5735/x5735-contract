...
import "@streamable-finance/v2-interfaces/contracts/pool-utils/IAssetManager.sol";
import "@streamable-finance/v2-interfaces/contracts/pool-utils/IControlledPool.sol";
import "@streamable-finance/v2-interfaces/contracts/vault/IVault.sol";
import "@streamable-finance/v2-interfaces/contracts/vault/IBasePool.sol";

import "@streamable-finance/v2-solidity-utils/contracts/helpers/InputHelpers.sol";
import "@streamable-finance/v2-solidity-utils/contracts/helpers/WordCodec.sol";
import "@streamable-finance/v2-solidity-utils/contracts/helpers/TemporarilyPausable.sol";
import "@streamable-finance/v2-solidity-utils/contracts/openzeppelin/ERC20.sol";
    ...
    RecoveryMode
{
    ...
    constructor(
        ...
        StreampayPoolToken(name, symbol, vault)
    ...
    function _getAuthorizer() internal view override returns (IAuthorizer) {
        // Access control management is delegated to the Vault's Authorizer. This lets Streampay Governance manage which
