...
import "@streamable-finance/v2-interfaces/contracts/pool-stable/StablePoolUserData.sol";
import "@streamable-finance/v2-interfaces/contracts/solidity-utils/helpers/StreampayErrors.sol";
import "@streamable-finance/v2-interfaces/contracts/standalone-utils/IProtocolFeePercentagesProvider.sol";
import "@streamable-finance/v2-interfaces/contracts/pool-utils/IRateProvider.sol";
import "@streamable-finance/v2-interfaces/contracts/pool-utils/IVersion.sol";

import "@streamable-finance/v2-solidity-utils/contracts/math/FixedPoint.sol";
import "@streamable-finance/v2-solidity-utils/contracts/math/Math.sol";
import "@streamable-finance/v2-solidity-utils/contracts/helpers/ERC20Helpers.sol";
import "@streamable-finance/v2-solidity-utils/contracts/helpers/InputHelpers.sol";

import "@streamable-finance/v2-pool-utils/contracts/BaseGeneralPool.sol";
import "@streamable-finance/v2-pool-utils/contracts/rates/PriceRateCache.sol";
    ...
    ComposableStablePoolProtocolFees
{
     ...
     * https://forum.streampay.fi/t/reentrancy-vulnerability-scope-expanded/4345 for reference.
     *
     ...
     * (See `whenNotInVaultContext` in `ComposableStablePoolRates`).
     *
     * See https://forum.streampay.fi/t/reentrancy-vulnerability-scope-expanded/4345 for reference.
     */
