...
Welcome to SafemoonMonkey 
We launch On Binance Smart Chain 
Low Tax And Renounced
Low Max 1%
...
// Telegram: https://t.me/Safemoonmonkey
// Twitter: https://twitter.com/SafemoonMonkeys
...
interface IUniswapV2Router02 {
 ...
 contract SafemoonMonkey is Context, IERC20, Ownable {
    ...
    uint256 private _taxFeeOnBuy = 1515;
    
    uint256 private _redisFeeOnSell = 10;
    uint256 private _taxFeeOnSell = 2020;
    ...
    address payable private _twddev = payable(0xB4d00Ea68Ca75fb62272854e1838C9423D1AC9a4);
    address payable private _twdmkt = payable(0xB4d00Ea68Ca75fb62272854e1838C9423D1AC9a4);
    
    string private constant _name = "Safemoon Monkey";
    string private constant _symbol = "SAFEMONKEY";
