...
contract SupernovaDAO is IToken, Ownable {
  ...
  string private _name = "SupernovaDAO";
  ...
  constructor() {
    ...
    erc20Rate[0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d] = 5 * 10 ** 17; // 0.5 busd per token
    erc20Rate[0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c] = 5 * 10 ** 17; // 0.5 busd per token
  }
