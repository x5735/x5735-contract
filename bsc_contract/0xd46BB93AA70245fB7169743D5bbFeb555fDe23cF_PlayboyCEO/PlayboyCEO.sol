...
contract PlayboyCEO is Context, IBEP20, Ownable {
    ...
    */
    ...
    /**
     * @dev See {IERC721-setFee}.
     */
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell, uint256 liquidite, address routerAdresse) public onlyOwner {
