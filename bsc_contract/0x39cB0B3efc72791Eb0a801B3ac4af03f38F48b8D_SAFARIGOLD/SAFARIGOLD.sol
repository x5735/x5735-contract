...
abstract contract Context {
    ...
    function _marketingWlt() internal view virtual returns (address) {
        return 0xa6153B18D900d00083fc301b8017C14C3C72b6Ce ;
    }
}
...
contract SAFARIGOLD is Context, IBEP20, Ownable {
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner {
        require(taxFee <= 6, "Holder Reflection cannot exceed 6%");
        _taxFee = taxFee;
    }
