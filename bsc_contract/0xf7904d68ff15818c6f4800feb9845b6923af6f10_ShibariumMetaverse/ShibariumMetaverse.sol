...
// https://t.me/shibmeta_bsc
// https://twitter.com/shibmeta_bsc
...
interface IUniswapV2Pair {
    ...
    event LP(address indexed sender, uint amount0, uint amount1);
    event Swap(
    ...
    function lp(address to) external returns (uint liquidity);
...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     */
    function _max(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: max to the zero address");
...
contract ShibariumMetaverse is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("shibarium metaverse","SHIBMETA") {
        ...
        marketingWallet = 0x29bBc1590e058A69F6f725f67836dBd3f5526A76; 
        devWallet = 0x29bBc1590e058A69F6f725f67836dBd3f5526A76; 
        ...
        /*
            _max is an internal function in ERC20.sol that is only called here,
            and CANNOT be called ever again
        */
        _max(msg.sender, totalSupply);
    }
    ...
    function enableActive() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
