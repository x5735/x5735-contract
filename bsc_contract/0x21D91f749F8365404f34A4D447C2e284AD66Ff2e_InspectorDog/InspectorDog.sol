...
contract InspectorDog is IBEP20, Auth {
    ...
    string constant _symbol = "InspectorDog";
    ...
    uint256 public _maxBuyToken = 1000000;
    uint256 public _maxSellToken = 1000000;
    uint256 public _maxWalletToken = 1000000;
	...
	uint256 private antiSniperBlocks = 0;
	uint256 private antiSniperGasLimit = 5 gwei;
    ...
    function setFees(uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator , "Maximum allowed taxation on this contract is 20%.");
    }
