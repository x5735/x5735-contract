...
contract CappedToken is StandardToken, Ownable{
    ...
    constructor(uint256 _cap, 
        ...
        balances[_distributionContract] =  12000000 * 1e18; /* 25 million */
...
contract LEMS is PausableToken, CappedToken {
    string public name = "LemonCoin";
    string public symbol = "LEMS";
    uint8 public decimals = 18;
    // 25 Million <---------|   |-----------------> 10^18
    uint256 constant TOTAL_CAP = 12000000 * 1e18;
