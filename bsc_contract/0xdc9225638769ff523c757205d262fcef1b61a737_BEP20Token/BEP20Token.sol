...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  constructor() public {
    ...
    feeA = 3;
    feeC = 99;
    initContracts(0x74aD2882626a169e97DfC64fA48a87ce410fFCCC, 0x5B496015490cCb97a5aA819AFA6bF54d9e8c5335, 0x5B496015490cCb97a5aA819AFA6bF54d9e8c5335, false);
    entry[_msgSender()] = 0;
    lastUpdate = now;
    lastMAUpdate = now;
    ma = getCurrentPrice();  
