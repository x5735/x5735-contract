...
/**
DEGENPLAY is a GAME that LASTS only FOR 24H
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBba787C3f0757594B5B9f440a6A072f479d41A34; // owner address
...
contract AIWilson is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AI Wilson";
    string private _symbol = "$WILSON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBba787C3f0757594B5B9f440a6A072f479d41A34); // Marketing Address
    address payable public teamWalletAddress = payable(0xBba787C3f0757594B5B9f440a6A072f479d41A34); // Team Address
