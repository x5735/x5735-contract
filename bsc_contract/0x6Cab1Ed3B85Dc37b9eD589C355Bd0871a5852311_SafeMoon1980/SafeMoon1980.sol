...
contract SafeMoon1980 is Context, IERC20 { 
    ...
    string private constant _name = "SafeMoon 1980";
    string private constant _symbol = unicode"SFM1980";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xf01e45d1Cf135175C62059D40dB142f39C2a713d);
    address payable public MarketingWallet = payable(0xf01e45d1Cf135175C62059D40dB142f39C2a713d);
