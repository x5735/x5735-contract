...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6e6A13E121C8ba0e2B1bc5B4a07043A49b2d7aF7; // owner address
...
contract LoopGPT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LoopGPT";
    string private _symbol = "LoopGPT";
