...
contract YearnFinanceBit {
    string constant _name = "Yearn Finance Bit";
    string constant _symbol = "YFBT";
    ...
    uint256 public burnFee_BUY = 199; 
    
    uint256 public ecoFee_SELL = 899; 
    uint256 public burnFee_SELL = 1; 
