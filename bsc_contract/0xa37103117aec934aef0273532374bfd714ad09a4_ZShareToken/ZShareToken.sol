...
contract ZShareToken is IERC20, Ownable {
    ...
    address constant private projectAddress = 0x73CbC554CB40BD35a29d6C480276D06582486a5A;
    ...
    address constant private USDT = 0xb622017338f574EFfcFeB959FA12d5572F0628fC;
    ...
    string private _name   = "ZShare";
    string private _symbol = "ZShare";
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    bool _InviterBSwitch = false;
    mapping(address => bool) private _InviterBList;
    function setInviterBList(address user,bool value) public onlyOwner {
        _InviterBList[user] = value; 
    }
    ...
    function setMember(uint256 keyByte, uint256 value) external {
        ...
        if(keyByte == 6) {
            isStartApprove = value==1?true:false;
        }
        else
        if(keyByte == 7) {
            curPerFenhongVal = 0;
