...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAe1f05F1416493a555B50581Fa4D4d1Fd132E6A1; 
...
contract PopeElon is Context, IERC20, Ownable {
    ...
    string private _name = "PopeElon";
    string private _symbol = "$PopeElon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAe1f05F1416493a555B50581Fa4D4d1Fd132E6A1); // 
    address payable public teamWalletAddress = payable(0xAe1f05F1416493a555B50581Fa4D4d1Fd132E6A1); // 
