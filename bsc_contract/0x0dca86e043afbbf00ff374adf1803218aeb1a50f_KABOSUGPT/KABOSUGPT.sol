...
contract KABOSUGPT is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Kabosu GPT";
    string private _symbol = "KGPT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x8eDC209315b156D0E887764B1EA74F97a383Bdd0);
    address payable public liqWalletAddress = payable(0x584a411C67f9C233cBD4Fe9CDA4F37c48436aeA1);
