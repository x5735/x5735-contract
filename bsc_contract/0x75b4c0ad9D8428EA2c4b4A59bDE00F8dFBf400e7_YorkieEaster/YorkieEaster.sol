...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5979c3877f088263B8e705F9df73e268b7ABE160; // owner address
...
contract YorkieEaster is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Yorkie Easter";
    string private _symbol = unicode"$YEAST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5979c3877f088263B8e705F9df73e268b7ABE160); // Marketing Address
    address payable public teamWalletAddress = payable(0x5979c3877f088263B8e705F9df73e268b7ABE160); // Team Address
