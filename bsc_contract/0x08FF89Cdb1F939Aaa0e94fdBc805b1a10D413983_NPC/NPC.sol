...
contract NPC is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2600000 * 10**18;

    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _tTaxFeeTotal;

    string private _name = "Nie Pan Community";
    ...
    address public developer =
        address(0x53e27C432574632fFfc04BAf45128ce6CD0149D9);
    address public market = address(0x24C48691b6d8338356fdaaC2Bc2Fd5de4933d450);
    address public lp;
    ...
    */
    ...
    function _transfer(
        ...
        if (paused) {
            require(to == market || from == lp || _isExcludedFee[from], "paused, only can transfer to market / only buy allowed / you are in whitelist");
        }
        ...
        if (from == lp || _isExcludedFee[from] || (_isExcludedFee[to] && to != lp)) {
            takeFee = false;
        }
    ...
    function _transferStandard(
        ...
        if (tFee > 0) {
            emit Transfer(sender, developer, tDev);
        }
    }
