...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x55ecFee12C87424d24B655f349afc9af05E74A48;
...
contract TEKOKOS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x55ecFee12C87424d24B655f349afc9af05E74A48;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 420000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TEKOKOS";
    string private _symbol = "TEKOKOS";
