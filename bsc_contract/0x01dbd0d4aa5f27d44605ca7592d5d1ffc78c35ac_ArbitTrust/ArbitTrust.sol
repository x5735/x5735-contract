...
* Telegram https://t.me/ArbitTrust
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8E12dfCB64c88d3F04F59990EF96850F1ecFF7f5; // owner address
...
contract ArbitTrust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ArbitTrust";
    string private _symbol = "ARBT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xbe0060FbB90c09717651d08650552f86255f10Db); // Marketing Address
    address payable public teamWalletAddress = payable(0xbe0060FbB90c09717651d08650552f86255f10Db); // Team Address
