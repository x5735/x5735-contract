...
/**
    Telegram: https://t.me/ShinjaiInu
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x619097bF6A587Bf6fBAf565caDd555a505770325; // owner address
...
contract ShinjaiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Shinjai Inu ";
    string private _symbol = "SHINJINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x619097bF6A587Bf6fBAf565caDd555a505770325); // Marketing Address
    address payable public teamWalletAddress = payable(0x619097bF6A587Bf6fBAf565caDd555a505770325); // Team Address
