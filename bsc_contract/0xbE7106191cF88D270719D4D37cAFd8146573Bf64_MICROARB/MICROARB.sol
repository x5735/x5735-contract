...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x0aec1e4CE3cD3ccEe64FF1A2eE47770fd2B0d8d3); //
...
contract MICROARB is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MICROARB";
    string constant _symbol = "MARB";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x0aec1e4CE3cD3ccEe64FF1A2eE47770fd2B0d8d3;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xC7eD28A3ab083415c8F9D16EE0e6b1C6C0D27336;
