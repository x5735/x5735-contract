...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1d60FeC6bAAFe14BF86219c5146Ba34c02db48aa; 
...
contract HachiroInu is Context, IERC20, Ownable {
    ...
    string private _name = " Hachiro Inu ";
    string private _symbol = " HACHIRO ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1d60FeC6bAAFe14BF86219c5146Ba34c02db48aa); // 
    address payable public teamWalletAddress = payable(0x1d60FeC6bAAFe14BF86219c5146Ba34c02db48aa); // 
