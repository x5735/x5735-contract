...
contract GalaxyDoge is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('Galaxy Doge', 'GLXD') {
        require(
            feeAccount != address(0),
            'Galaxy Doge: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'Galaxy Doge: incorrect fee percent');
        require(owner != address(0), 'Galaxy Doge: incorrect owner address');
        require(mintToAddr != address(0), 'Galaxy Doge: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'Galaxy Doge: transfer from the zero address');
        require(recipient != address(0), 'Galaxy Doge: transfer to the zero address');
