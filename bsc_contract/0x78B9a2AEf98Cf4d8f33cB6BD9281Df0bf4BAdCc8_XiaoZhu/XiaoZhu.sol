...
contract XiaoZhu is ERC20, Ownable {
    ...
    constructor(address _router) ERC20("XiaoZhu", "$XZT") payable
    {
        ...
        // External wallets 
        taxWallets["marketing"] = 0xCc2ae6cFf89241F0deb61b2503D15cf2A71B23d7;
        taxWallets["dev"] = 0x6b311D0275A504B09788FB919f16CA9552B57d06;

        maxTxAmount = initialSupply * 300 / 10000;
        maxOwnedAmount = initialSupply ;
