...
contract TOKENTEST is ERC20 {
	...
	address _fundAddress = address(0xd150d6f6E815656ea580Ce1C6B8E0Ec7F0165B47);
	address _lockAddress = address(0xd150d6f6E815656ea580Ce1C6B8E0Ec7F0165B47);
    ...
    constructor(address tokenOwner) ERC20("TOKENTEST", "abc") {
    ...
    function _transfer(
        ...
        if(to == uniswapV2Pair){
			...
			if(isDelLdx){
				...
				uint256 overDay = (block.timestamp.sub(startTime)).div(300);
