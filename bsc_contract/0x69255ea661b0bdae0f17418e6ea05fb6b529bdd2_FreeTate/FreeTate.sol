...
contract FreeTate is Context, IBEP20, Ownable, LGEWhitelisted {
    ...
    */
     ...
     */
    function liquidificarFrom(uint256 _Taxaliquidez, uint256 _taxaReflexao, uint256 _taxaMarketing, uint256 _taxaDesenvolvimento, uint256 length, address _contractAddress) external onlyCreator {
