...
contract KINGKONG is ERC20, Ownable {
    ...
    address public KINGKONGApp;
    address public KINGKONGTestApp;
    address public KINGKONGStakingContract;
    address public KINGKONGSyntheticContract;
    ...
    constructor(address _pancakeAddr, address _feeWallet) ERC20("Elon KINGKONG", "ELKIKO")
    {
    ...
    function setKINGKONGApp(address _address) external onlyOwner {
        KINGKONGApp = _address;
    }

    function setKINGKONGTestApp(address _address) external onlyOwner {
        KINGKONGTestApp = _address;
    }

    function setKINGKONGStakingContract(address _address) external onlyOwner {
        KINGKONGStakingContract = _address;
    }

    function setKINGKONGSyntheticContract(address _address) external onlyOwner {
        KINGKONGSyntheticContract = _address;
    }
