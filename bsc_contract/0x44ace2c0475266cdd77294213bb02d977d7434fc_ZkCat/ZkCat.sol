...
contract ZkCat is Context, IERC20, Ownable {
    ...
    address payable private _dev = payable(0xFC6e8bAAF86e0CFba4e6953388581f05f639b4d2);
    address payable private _mkt = payable(0xFC6e8bAAF86e0CFba4e6953388581f05f639b4d2);
    
    string private constant _name = "ZkCat";
    string private constant _symbol = "ZkCat";
