...
/**
 * @dev This contract simply builds on top of the Streampay V2 architecture to provide useful helpers to users.
 ...
 */
contract StreampayHelpers is AssetHelpers {
