...
contract Wongacoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wongacoin";
    string private _symbol = "WONGA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD6A80e6CbfeE7e078a4c3f1a4cc89a28868123fB); // Marketing Address
    address payable public teamWalletAddress = payable(0xD6A80e6CbfeE7e078a4c3f1a4cc89a28868123fB); // Team Address
