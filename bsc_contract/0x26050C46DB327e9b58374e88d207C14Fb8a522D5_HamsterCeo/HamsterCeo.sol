...
/**
 Telegram : https://t.me/hamsterceo
 Website :   http://hamsterceo.com
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x96CcCC60C291148C70ca19d4EdE47a9b36702F72;
...
contract HamsterCeo is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x96CcCC60C291148C70ca19d4EdE47a9b36702F72);
    ...
    function setlsExcludedFromFee(address account) public authorized {
    ...
    function setTransfersWithoutFees(bool true_or_false) private authorized {
        noFeeToTransfer = true_or_false;
    }

   
    function setMaxTxAmount(uint256 maxTxPercent_x100) external authorized() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/100;
    }    
    
    // Set the maximum wallet holding (percent of total supply)
     function setWalletLimit(uint256 maxWallPercent_x100) external authorized() {
