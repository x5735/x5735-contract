...
//Jodi Usama Husain v1 for MAMA DeFi, to stabilize eUSD_eGBP pool to reflect the real market and stablize pair.
...
contract ReBase_ARYZE_Pair is Initializable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize() public initializer {
        ...
        address eUSD_eGBP_Pool = 0x5817dedF65Dd213Cf3571b8E2a43193ad27AF3a9;
        address eUSD = 0xa4335da338ec4C07C391Fc1A9bF75F306adadc08;
        address eGBP = 0xD711D7D893de57dc13Ff465763218770Bd42DB1D;
        address oracle_USD_USD = address(0);
        address oracle_GBP_USD = 0x8FAf16F710003E538189334541F5D4a391Da46a0;
        address oracle_BNB_USD = 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE;

        setPair(eUSD_eGBP_Pool, eUSD, eGBP, oracle_USD_USD, oracle_GBP_USD, oracle_BNB_USD);
