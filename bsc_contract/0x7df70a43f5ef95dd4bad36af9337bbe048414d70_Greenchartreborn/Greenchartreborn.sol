...
Community feel free to create a community group 
...
contract Greenchartreborn is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x0Dc5bdbe8Ed6eF6e93d8FF90674893E58DE5e777); // Marketing Address
        
    address payable public teamAddress =
        payable(0x0Dc5bdbe8Ed6eF6e93d8FF90674893E58DE5e777); // Team Address

    address payable public liquidityAddress =
        payable(0x0Dc5bdbe8Ed6eF6e93d8FF90674893E58DE5e777); // Liquidity Address
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0x0Dc5bdbe8Ed6eF6e93d8FF90674893E58DE5e777).call{value: bnbForDev}("");
