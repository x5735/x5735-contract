...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8a5cAbA66a8D40C372590dE867c700B9ACd1E5E1; // owner address
...
contract SanjiroInuOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sanjiro Inu";
    string private _symbol = "SI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xCC16f60Cc5C91Fd919461fE12A1a1E8885408f93); // Marketing Address
    address payable private teamWalletAddress = payable(0x8a5cAbA66a8D40C372590dE867c700B9ACd1E5E1); // Team Address
