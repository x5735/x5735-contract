...
/**
 *Submitted for verification at BscScan.com on 2023-31-03
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaa4B248A6581F205f179B0e5C0b6205e6C016329; // owner address
...
contract BabyUFO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyUFO";
    string private _symbol = "BabyUFO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xaa4B248A6581F205f179B0e5C0b6205e6C016329); // Marketing Address
    address payable public teamWalletAddress = payable(0xaa4B248A6581F205f179B0e5C0b6205e6C016329); // Team Address
