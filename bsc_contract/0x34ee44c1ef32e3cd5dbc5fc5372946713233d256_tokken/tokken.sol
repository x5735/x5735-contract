        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xf24E3782305eD745892F078e3d464272044d7E43), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        1000000,//Su 
        address(0xf24E3782305eD745892F078e3d464272044d7E43),//
        address(0xf24E3782305eD745892F078e3d464272044d7E43)//
    ){
    }
}