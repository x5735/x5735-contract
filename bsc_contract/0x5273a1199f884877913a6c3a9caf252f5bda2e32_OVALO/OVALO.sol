...
// TELEGRAM : https://t.me/OvaloNetwork
// WEBSITE  : https://ovalo.network/
...
contract OVALO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OVALO NETWORK";
    string private _symbol = "OVL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD468fe56AD3198d4E6a789Fed86Ad2bd8f4D7200); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xc64b24100A6517eABCB23947Ea20B2cdD8a708c5); // Development Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (2 * 10**6 * 10**9), "Max wallet should be less or equal to 2% totalSupply");
