...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9F6e038a241BD02Fe5b8c8e3C7F85c71272aF6B5; 
...
contract rSAFEMOON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Reversal Safemoon";
    string private _symbol = "rSafemoon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9F6e038a241BD02Fe5b8c8e3C7F85c71272aF6B5); // 
    address payable public teamWalletAddress = payable(0x9F6e038a241BD02Fe5b8c8e3C7F85c71272aF6B5); // 
