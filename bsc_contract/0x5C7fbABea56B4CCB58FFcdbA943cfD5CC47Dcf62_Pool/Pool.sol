...
contract DividendTrackerPool is Ownable {
    ...
    event RewardPaid(
        ...
        uint256 RaiseUserTokenDividend,
        uint256 LPDividend
    );
    ...
    function pendingToken(address account) private view returns (uint256) {
...
contract Pool is DividendTrackerPool {
    ...
    //token
        address(0x3f24AF773C969695C5E6119866277321c9a9Ad90),
    //raise
        Raise(0x8954bc627A450cE8A35ce498602C0549b25e984B)
    ){
    }
}