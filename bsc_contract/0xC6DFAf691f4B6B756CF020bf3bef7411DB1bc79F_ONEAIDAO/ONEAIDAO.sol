...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbb31a2318A1089F79218EE5F1Ff4dA6dd8bFDB93;
...
contract ONEAIDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "$1AIDAO";
    string private _symbol = "OAD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbb31a2318A1089F79218EE5F1Ff4dA6dd8bFDB93);
    address payable public teamWalletAddress = payable(0xbb31a2318A1089F79218EE5F1Ff4dA6dd8bFDB93);
