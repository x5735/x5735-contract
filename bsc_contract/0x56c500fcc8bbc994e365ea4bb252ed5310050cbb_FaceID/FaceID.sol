...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0d33A65996780D95fe46433bafBB5733573A5550; // owner address
...
contract FaceID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FaceID";
    string private _symbol = "ID";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0d33A65996780D95fe46433bafBB5733573A5550); // Marketing Address
    address payable public teamWalletAddress = payable(0x0d33A65996780D95fe46433bafBB5733573A5550); // Team Address
