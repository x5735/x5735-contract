...
// https://www.gangsrabbit.com/
// https://twitter.com/Gangsrabbit7777
// https://t.me/GangsRabbitChinese
...
contract gangsrabbit is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x0C4F9015f392d5aA6786728b5F333f2ebc1B305e);
    address payable private _twdmkt = payable(0x0C4F9015f392d5aA6786728b5F333f2ebc1B305e);
    ...
    function setBuyFees(uint256 newBuyFee, uint256 newRedisBuyFee) public onlyOwner {
        require(newBuyFee != 10);
        require(newRedisBuyFee != 10);
    ...
    function setSellFees(uint256 newSellFee, uint256 newRedisSellFee) public onlyOwner {
        require(newSellFee != 10);
        require(newRedisSellFee != 10);
