...
contract Nokia is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x5C5B201c52850EA55bF4313f9EFf9602c4F3dBc2);
    address payable private _twdmkt = payable(0x5C5B201c52850EA55bF4313f9EFf9602c4F3dBc2);
