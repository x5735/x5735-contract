...
Super Mario Inu is a popular character based on Nintendo bringing hype to the BSC chain that aims to provide popular media integration.

We aim to be the most popular BSC token in the space. Let's show the power of community here in BSC
...
https://t.me/SuperMarioInuChannel
...
contract SUPERMARIOINU is Context, IERC20, Ownable {
    ...
    string private _name = "Super Mario Inu";
    string private _symbol = "SUPERMINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA7801Ee0cA95AF6aDcd60bA8EE58f67Cd232Ffe0); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xef807f6a9b02f3071f508a25fAA06D822Fd04754); // buyback Address
