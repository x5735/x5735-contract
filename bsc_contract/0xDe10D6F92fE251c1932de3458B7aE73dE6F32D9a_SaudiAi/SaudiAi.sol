...
contract SaudiAi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi Ai";
    string private _symbol = "$SAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9d24cc454a54E1e8523f00aEF28190942154D6E4); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x9d24cc454a54E1e8523f00aEF28190942154D6E4); // Development Address
