...
//Official Telegram: https://t.me/SafemoonCat
//Official Website : https://sfmooncat.com
//Official Twitter : https://twitter.com/SafemoonCat_
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x634FFA5928adEFFD0BAffBb3cf432981FCcA6A3C; 
...
contract SafemoonCat is Context, IERC20, Ownable {
    ...
    string private _name = "SafeMoon Cat";
    string private _symbol = "SFMOONCAT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x634FFA5928adEFFD0BAffBb3cf432981FCcA6A3C); // 
    address payable private teamWalletAddress = payable(0x634FFA5928adEFFD0BAffBb3cf432981FCcA6A3C); // 
