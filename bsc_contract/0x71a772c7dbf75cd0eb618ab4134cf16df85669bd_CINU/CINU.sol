...
contract CINU is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Conan Inu";
    ...
    address payable public DevWallet = payable(0x1e70bD82bA06aC32B09861F066a29684D8a14453);
    address payable public MarketingWallet = payable(0xa4E76F16bbe410dd8b7C8b42D5DC6b3B1CE710De);
