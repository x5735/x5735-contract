...
//telegram -https://t.me/HorgiInuGlobalChat
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7e3F7A6754F103CFc3219E4638079995027D0e1d;
...
contract HorgiInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "HORGI INU"; // 
    string private constant _symbol = "HORGI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x7e3F7A6754F103CFc3219E4638079995027D0e1d);
