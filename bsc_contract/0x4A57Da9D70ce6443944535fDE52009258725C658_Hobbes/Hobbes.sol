...
Telegram:https://t.me/HobbesElon
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x836dCf92713113533F7F7981abE7f036036490dF), block.timestamp
                );
            }
        }
    }
...
contract Hobbes is AbsToken {
    constructor() AbsToken(
        ...
        address(0x836dCf92713113533F7F7981abE7f036036490dF),//FundAddress
        address(0xdB315Cfc7AF73C160521D29C0e42eA63D9B1eA23)//ReceiveAddress
    ){
    }
}