...
contract Baby_Doge_Token is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 900000000000 * 10**_decimals;

    uint256 private TopSellAmount = 1000000000000 * 10**_decimals;
    uint256 private TopBuyAmount = 8000000000000 * 10**_decimals;
    uint256 private TopBalance = 8000000000000 * 10**_decimals;
    ...
    string private constant _symbol = "BabyDogeTKN";
