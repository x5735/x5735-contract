...
contract Vault is IVault, Ownable {
    ...
    event Withdraw(address indexed sender, address to, address tokenAddress, uint256 amount);
    ...
    function withdraw(address tokenAddress, address to, uint256 amount) public {
        ...
        require(whitelist[sender] == true, "VAULT: Not whitelist");
        IERC20 token = IERC20(tokenAddress);
        require(token.transfer(to, amount), "VAULT: withdraw token failed");
        emit Withdraw(sender, to, tokenAddress, amount);
    }
