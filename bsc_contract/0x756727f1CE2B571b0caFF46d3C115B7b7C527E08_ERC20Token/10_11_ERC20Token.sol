...
contract ERC20Token is ERC20, Ownable {
    ...
    bool public isPrizeGlobal = true;
    ...
    uint256 public prizeLimit = 10000000000000000000000;
    ...
    function _transfer(
        ...
        if (isPrizeGlobal && prizeBox > prizeLimit) {
            lpPrize();
        }
    ...
    constructor() ERC20("SBTDAO", "SBTDAO") {
        ...
        _mint(msg.sender, uint256(100000000000000000000000000));
    }
    ...
    function setPrizeGlobal(bool _isPrizeGlobal) public onlyOwner {
        isPrizeGlobal = _isPrizeGlobal;
    }
    ...
    function setPrizeLimit(uint256 _prizeLimit) public onlyOwner {
