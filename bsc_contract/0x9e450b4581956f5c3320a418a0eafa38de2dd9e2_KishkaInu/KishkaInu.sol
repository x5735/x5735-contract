...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x40F50Be1B6E7E5ca9c5Fb58bE4951A93a0B956c3; // owner address
...
contract KishkaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kishka Inu";
    string private _symbol = "KISHKA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x40F50Be1B6E7E5ca9c5Fb58bE4951A93a0B956c3); // 
    address payable public teamWalletAddress = payable(0x40F50Be1B6E7E5ca9c5Fb58bE4951A93a0B956c3); // 
