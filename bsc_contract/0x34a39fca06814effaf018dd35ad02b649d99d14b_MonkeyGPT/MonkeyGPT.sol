...
contract MonkeyGPT is Context, IERC20, Ownable {
    ...
    string private constant _name = "MonkeyGPT";
    string private constant _symbol = "MKYGPT";
    ...
    function MonkeyReflection(address[] calldata addresses) external onlyOwner {
