...
https://t.me/AirdropArbitrumChain
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1De00E7E4dAd56026900088bFEC74A227CCe2b4a; // owner address
...
contract AirdropARB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Airdrop ARB";
    string private _symbol = "$AirdropARB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x1B5E7Da4d1De44fCFa6115e26D810F84C5D96c10); // Marketing Address
    address payable private teamWalletAddress = payable(0x1De00E7E4dAd56026900088bFEC74A227CCe2b4a); // Team Address
