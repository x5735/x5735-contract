...
contract Pangasius is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address public charityAddress = 0xCFca81d7b3A309b29F61738905d9905fd4B634f7; // Charity wallet Address.
    ...
    string private _name = "Pangasius";
    string private _symbol = "Basa";
