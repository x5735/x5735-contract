...
contract BUSDBNBMOON {
	using SafeMath for uint256;

	IERC20 public erctoken;
	 
	//address token = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; /** BUSD Testnet **/
	...
	uint256 public COMPOUND_COOLDOWN = 168 * 60 * 60;
    ...
    uint public startTime = 1679931000; //  https://www.unixtimestamp.com/
	...
	constructor(address payable _dev1, address payable _mkt) {require(!isContract(_dev1) && !isContract(_mkt));
        ...
        plans.push(Plan(20, 100, 10 ether, 100000 ether, 0, 0, 0, 0, true));
	}
