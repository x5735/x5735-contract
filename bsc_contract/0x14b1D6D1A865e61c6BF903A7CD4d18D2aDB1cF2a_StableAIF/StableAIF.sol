...
contract StableAIF {
    ...
    IToken public token_AIF;
	//address erctoken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; /** AIF Testnet **/
    address erctoken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; /** AIF Mainnet **/
    ...
    uint256 public MIN_INVEST_LIMIT = 10 * 1e18; /** 10 AIF  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 10000 * 1e18; /** 10000 AIF  **/
    ...
    function sellEggs() public{
        ...
        token_AIF.transfer(msg.sender, eggsPayout);
    ...
    function buyEggs(address ref, uint256 amount) public{
        ...
        token_AIF.transferFrom(address(msg.sender), address(this), amount);
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                ...
                token_AIF.transfer(upline, refRewards);
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_AIF.transfer(dev1, tax);
        token_AIF.transfer(dev2, tax);
        token_AIF.transfer(dev3, tax);
        token_AIF.transfer(dev4, tax);
        token_AIF.transfer(mkt, tax);
        return tax.mul(5);
    }
    ...
    function getBalance() public view returns (uint256) {
        return token_AIF.balanceOf(address(this));
	}
