...
contract DramaSafemoon is Context, IERC20, Ownable {
    ...
    string private _name = " Drama Safemoon ";
    string private _symbol = " DSFM ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC71B570429510c04ba8b1CfF225274474Feec6B8);
    address payable public teamWalletAddress = payable(0xC71B570429510c04ba8b1CfF225274474Feec6B8);
    ...
    uint256 private minimumTokensBeforeSwap = 3500000000 * 10**_decimals; 
	...
	function removeLiquidityPair(address account) private onlyOwner {
