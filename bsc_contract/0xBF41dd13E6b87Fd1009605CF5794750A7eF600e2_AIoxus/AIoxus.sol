...
contract AIoxus is Context, IBEP20, Ownable {
    ...
    constructor() {
        ...
        _symbol = "OXUS";
        _decimals = 18;
        _totalSupply = 12_000_000_000 * (10 ** 18);
    ...
    function transfer(
        ...
        if (!blacklistDisable) {
            if (recipient != owner()) {
                require(
                    ...
                    "ERC20: sender address blacklisted"
                );
                require(
        ...
        if (!taxedPairs[_msgSender()] && !taxedPairs[recipient]) {
            takeFee = false;
        }
        ...
        if (takeFee) {
            ...
            if (_totalFees > 0) {
                ...
                _transfer(_msgSender(), address(this), fees);
            }
        }
