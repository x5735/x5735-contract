...
contract SOPSO is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xDd4134A6fF1366A31a8f24eDBEfc50D3BAd1E925);
    ...
    uint256 public numTokensSellToAddToLiquidity = 10000000000000000000 * 10**18;
    uint256 public _maxTxAmount = 50000000000000000000 * 10**18;
