...
contract Sharkicorn is BEP20, Ownable {
    ...
    uint256 public maxBuyLimit = 1e9 * 10**18; // 2%
    uint256 public maxSellLimit = 1e9 * 10**18; // 2%
    uint256 public maxWalletLimit = 1e9 * 10**18; // 2%

    uint256 public genesis_block;
    uint256 private lunchTime = 0;
    uint256 private lunchTax = 0;

    address public marketingWallet = 0xFCCCE4936f2CC3290a07680eF513B8CA41A77DCa;
    ...
    constructor() BEP20("Sharkicorn", "$SHAC") {
