...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if(from == _mainPair){
            require(isStartBuy == 1, "Sales not started");
        }
    ...
    function startBuy(uint256 newIsStartBuy) external onlyOwner {
        isStartBuy = newIsStartBuy;
    }
...
contract Token is AbsToken {
    ...
    // Supply
        5000,
    //  FundAddress
        address(0xee83434ae4E27f35FaE0D65D56eB4b9C3331DAfF),
    //  FundAddress2
        address(0xee83434ae4E27f35FaE0D65D56eB4b9C3331DAfF),
    //  ReceiveAddress
        address(0xee83434ae4E27f35FaE0D65D56eB4b9C3331DAfF),
