...
//Jodi Usama Husain v1 for MAMA DeFi, to stabilize USDC-eUSD pool to reflect the real market and stablize pair.
...
contract ReBase_ARYZE_Pair is Initializable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize() public initializer {
        ...
        address USDC_eUSD_Pool = 0xe0f6ef4c31638D1eD3573C36289ea7c9f91c6BaA;
        address USDC = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d;
        address eUSD = 0xa4335da338ec4C07C391Fc1A9bF75F306adadc08;
        address oracle_USD_USD = address(0);
        address oracle_USDC_USD = 0x51597f405303C4377E36123cBc172b13269EA163;
        address oracle_BNB_USD = 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE;

        setPair(USDC_eUSD_Pool, USDC, eUSD, oracle_USDC_USD, oracle_USD_USD, oracle_BNB_USD);
