...
contract Spc is ERC20, Ownable {
    ...
    constructor() ERC20("SPACE", "SPC") {
        marketingWallet = payable(0x668dF6b109D88FD3F5c80C2326291f9fbe0c4B92);
        devWallet = payable(0x668dF6b109D88FD3F5c80C2326291f9fbe0c4B92);
...
contract SpcDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
