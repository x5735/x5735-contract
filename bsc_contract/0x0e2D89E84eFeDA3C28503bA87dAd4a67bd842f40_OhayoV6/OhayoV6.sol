...
contract OhayoV6 is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    using SafeMath for uint256;
    ...
    address private constant USDT_ADDRESS = 0x45d51Acc587574536CB292500d35dD3060796C63;
    ...
    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("OhayoV6", "OhayoV6") {
