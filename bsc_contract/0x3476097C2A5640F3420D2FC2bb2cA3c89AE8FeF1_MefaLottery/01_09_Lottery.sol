...
contract MefaLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    address public OnoutAddress = 0xa9BE4246de0418Ab93e0dC09eC225f4b367b85F9;
        ...
        nonReentrant
    {
        ...
        if (OnoutFeeEnabled) {
            uint256 amountToOnoutFee = amountCakeToTransfer / 100 * OnoutFee;
            amountCakeToTransfer = amountCakeToTransfer - amountToOnoutFee;
