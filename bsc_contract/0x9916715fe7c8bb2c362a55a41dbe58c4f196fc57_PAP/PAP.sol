...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function _transfer(
		...
		if(_isExcludedFromFeesVip[sender] || _isExcludedFromFeesVip[recipient]){
...
contract PAP is ERC20 {
    ...
    address _fundAddress = address(0x58c251BDCA9C66265199112c85Ab3E4ED443f432);
	UsdtWarp warp;
    ...
    constructor(address tokenOwner) ERC20("PAP", "1PAP") {
	...
	bool public sellAndDelLdx;
	function changeSellAndDelLdx() public onlyOwner {
        sellAndDelLdx = !sellAndDelLdx;
    }
    ...
    function _transfer(
        ...
        if(to == uniswapV2Pair){
			...
			if(isAddLdx){
				...
				super._transfer(from, _fundAddress, amount.div(1000).mul(35));
				super._transfer(from, to, amount.div(1000).mul(965));
				return;
			}
        }else if(from == uniswapV2Pair){
			isDelLdx = _isDelLiquidityV1();
			if(isDelLdx){
				require(sellAndDelLdx, "sellAndDelLdx");
				super._transfer(from, _fundAddress, amount.div(1000).mul(35));
				super._transfer(from, to, amount.div(1000).mul(965));
				return;
			}
