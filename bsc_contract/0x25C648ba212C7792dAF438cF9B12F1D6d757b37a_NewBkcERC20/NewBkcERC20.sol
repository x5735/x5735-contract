...
// File: bkc/token/ERC20/NewBkcERC20.sol

pragma solidity >=0.6.0 <0.8.0;



contract NewBkcERC20 is Context, Ownable, IERC20 {
    ...
    constructor (address lpAddress, address dropAddress) public {
        _name = "Metabank coin";
        _symbol = "BKC";
        _decimals = 18;
        
        _mint(lpAddress, 10000 * 10**8 * 10**18);
        _mint(dropAddress, 90000 * 10**8 * 10**18);
        _mint(destroyAddress, 900000 * 10**8 * 10**18);
    }
