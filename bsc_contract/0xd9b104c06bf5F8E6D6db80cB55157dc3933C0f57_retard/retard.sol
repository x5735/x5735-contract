...
contract retard is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"rtd";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            uint256 CATB = balanceOf(address(this));
            if (!inSwap &&  from != uniswapV2Pair && swapEnabled && CATB>_taxSwapThreshold) {
                swapTokensForEth(CATB);
