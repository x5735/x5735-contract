...
contract Easter_Doge is ERC20, Ownable {
    ...
    EDoge_DividendTracker public dividendTracker;
    
    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x16C73a1D620522d19CBE193D9A876c6918D34EDd;
    ...
    constructor() ERC20("Easter Doge", "EDoge") {
        dividendTracker = new  EDoge_DividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        EDoge_DividendTracker newDividendTracker = EDoge_DividendTracker(
            payable(newAddress)
        );
...
contract EDoge_DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("EDoge_Dividen_Tracker", "EDoge_Dividend_Tracker")
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10000000 * (10**decimals());
    }
    ...
    function _transfer(
        ...
        require(false, "EDoge_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "EDoge_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "EDoge_Dividend_Tracker: Cannot update claimWait to same value"
        );
