...
contract HulkCZ is Context, IERC20, Ownable {
    ...
    string private _name = "HulkCZ";
    string private _symbol = "HulkCZ";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x4Fe1Fb1A58AbFAd85B9f6208f6DffA755Ef4ad0A); 
    address payable public teamWalletAddress = payable(0x4Fe1Fb1A58AbFAd85B9f6208f6DffA755Ef4ad0A); 
