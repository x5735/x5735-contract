...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x492500F4734Ed45Ea2FB22eda89a15255e37B2D7;
...
contract ITP is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb3E2EAf8B50504f978A767020AD14a9E93c218A4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ITP Payment";
    string private _symbol = "ITP";
