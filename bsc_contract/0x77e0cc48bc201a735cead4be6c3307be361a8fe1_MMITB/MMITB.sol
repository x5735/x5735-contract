...
contract MMITB  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MMITB ";
    string private _symbol = "MMITB ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9586cF050d2B79D01280618a9DBFe3E04af5F5E4);
    address payable public teamWalletAddress = payable(0x9586cF050d2B79D01280618a9DBFe3E04af5F5E4);
    address public immutable deadAddress = 0x9586cF050d2B79D01280618a9DBFe3E04af5F5E4;
