...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd84bDF1d304Ccb779cb76e003761C00c41989adf; 
...
contract WeimaranerInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Weimaraner Inu";
    string private _symbol = "WI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd84bDF1d304Ccb779cb76e003761C00c41989adf); // 
    address payable public teamWalletAddress = payable(0xd84bDF1d304Ccb779cb76e003761C00c41989adf); // 
