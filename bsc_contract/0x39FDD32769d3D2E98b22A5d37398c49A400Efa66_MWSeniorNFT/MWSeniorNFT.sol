...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintWithTokenURI(address to, uint256 tokenId, string memory tokenURI) public onlyMinter returns (bool) {
		require(tokenId > 1000000 , "tokenId");
        _mint(to, tokenId);
        _setTokenURI(tokenId, tokenURI);
        return true;
    }
	
    uint256 public nftSeniorIndexId = 100000;
	function mintAdminSeniorTokenURI(address user) public onlyMinter returns (bool) {
        _mint(user, nftSeniorIndexId);
        _setTokenURI(nftSeniorIndexId, "https://bafkreicyusyzkscd7kjievtv4rf7z7dpdfn6yv2tmg4ys6a4h4tx7zemme.ipfs.nftstorage.link");
		nftSeniorIndexId = nftSeniorIndexId+1;
        return true;
    }
}
...
//0x8FBAaE39c1D57A54272e764cD293c3cC49254Ab4
contract MWSeniorNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("MW Senior NFT", "MW Senior NFT") {
