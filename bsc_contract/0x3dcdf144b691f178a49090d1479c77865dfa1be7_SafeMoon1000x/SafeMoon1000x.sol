...
contract SafeMoon1000x is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SafeMoon1000x";
    string private _symbol = "SafeMoon1000x";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2428763F12Bbd065a0f865267C41e4eF252f215e); // Marketing Address
    address payable public teamWalletAddress = payable(0x2428763F12Bbd065a0f865267C41e4eF252f215e); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 10000000000 * 10**_decimals;IUniswapV2Router02 public uniswapV2Router;
