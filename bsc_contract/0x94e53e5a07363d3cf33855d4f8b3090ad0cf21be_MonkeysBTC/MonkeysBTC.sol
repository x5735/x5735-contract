...
*  Telegram: https://t.me/MonkeysBTC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x74D28ed532324831ce20B3f0121254129C6c5991; // owner address
...
contract MonkeysBTC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MonkeysBTC";
    string private _symbol = "MonkeysBTC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x74D28ed532324831ce20B3f0121254129C6c5991); // Marketing Address
    address payable public teamWalletAddress = payable(0x74D28ed532324831ce20B3f0121254129C6c5991); // Team Address
