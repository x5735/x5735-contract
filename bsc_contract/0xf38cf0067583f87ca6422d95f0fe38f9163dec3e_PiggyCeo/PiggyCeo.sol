...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfb3713128A3aF5b38771050d762473E9464386fe; // owner address
...
contract PiggyCeo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PiggyCeo";
    string private _symbol = "PIGCEO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2155d610eC8666081CDf7F89b3B6B7D460657a95); // Marketing Address
    address payable private teamWalletAddress = payable(0xfb3713128A3aF5b38771050d762473E9464386fe); // Team Address
