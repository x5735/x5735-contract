...
contract ShinjiroInu is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT =  1 * 10**1 * 10**9; //
    string private constant _name = "Shinjiro Inu"; // 
    string private constant _symbol = "Shinjiro"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address private  _marketing_Wallet = 0x1e2dFf36647AC7511D99BA1B10184c3bF3f000Cb;
