...
contract HMTToken is IERC20, Ownable {
    ...
    uint256 lianchuangFee = 80;
    uint256 reflowFee = 50;
    uint256 lpRewardFee = 120;
    uint256 burnFee = 100;
    uint256 inviteFee = 50;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != uniswapV2Pair && !_isDividendExempt[from])
            addShareholder(from);
    }
    ...
    function _killTransfer(
        ...
        _takeTransfer(sender, address(0), feeAmount);
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            _takeTransfer(sender, projectAddress, fee);
            ...
            _takeTransfer(sender, address(0), fee);
