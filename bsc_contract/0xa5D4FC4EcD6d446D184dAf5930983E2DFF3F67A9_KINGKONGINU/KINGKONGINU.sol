...
contract KINGKONGINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x436476e07cF666E3cA8F5e159611cd62c3D45A52); 
    address payable public Wallet_Dev = payable(0x5BD5E123abdC8A2eCC6A1C8720214F5F2D7500Df);
    ...
    string private constant _symbol = unicode"YMNT"; 
