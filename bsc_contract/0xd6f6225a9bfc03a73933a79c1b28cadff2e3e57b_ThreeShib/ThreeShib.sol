...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF2103639e31349ED6E9eA2746aBFAc00c4fcfaca; // owner address
...
contract ThreeShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ThreeShib";
    string private _symbol = "3Shib";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x28987b607247b239233417a96A24df77A321fac1); // Marketing Address
    address payable private teamWalletAddress = payable(0xF2103639e31349ED6E9eA2746aBFAc00c4fcfaca); // Team Address
