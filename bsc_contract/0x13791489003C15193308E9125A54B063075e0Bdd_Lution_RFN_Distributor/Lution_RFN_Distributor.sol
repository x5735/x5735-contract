...
/*
 * Lution - Reflection Distributor
 * Developed by Kevin Remer (Totenmacher)
 */
contract Lution_RFN_Distributor is UUPSUpgradeable, OwnableUpgradeable {
    ...
    function initialize(address parentToken_, address rewardToken_) public initializer {
        __Ownable_init();
