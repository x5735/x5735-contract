...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x452dC860c2308F4e9076683D2AAa483C1600E5fb;    
...
contract QGYYDSCoin is AbsToken {
    constructor() AbsToken(
        ...
        address(0x452dC860c2308F4e9076683D2AAa483C1600E5fb),  //
    
        address(0x893A56473398F1A2EBdf849EEd07Bb6e840ACf78) //
    ){
