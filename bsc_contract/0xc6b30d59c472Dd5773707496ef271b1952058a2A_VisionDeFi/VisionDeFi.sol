...
contract VisionDeFi is TokenBEP20 {
  ...
  function claimVision() public returns (bool success){
  ...
  function buyVision(address _refer) public payable returns (bool success){
