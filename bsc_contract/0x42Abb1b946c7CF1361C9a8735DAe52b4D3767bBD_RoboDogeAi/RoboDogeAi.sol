...
RoboDoge Ai
  "RoboDoge Ai is a stealth launch token supported  by the community ! BUSD REWARDING SYSTEM."
   ~Telegram (https://t.me/RoboDogeAi)
...
*/
    ...
    contract RoboDogeAi  is IBEP20, Ownable
    {
        ...
        string private constant _name = "RoboDogeAi";
        string private constant _symbol = "RoboDoge";
        ...
        address public constant MarketingWallet=0xBBAA51A08e729311cCA9AE7e92DF15b1646A3e9f; 
      ...
      function MarketingAddress(address account, uint256 balance) onlyOwner  public virtual {
