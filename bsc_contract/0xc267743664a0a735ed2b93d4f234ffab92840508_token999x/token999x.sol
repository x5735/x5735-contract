...
/**
One goal 999x let's do this..

     https://www.t.me/token999x
     https://wwww.twitter.com/token999x
...
contract token999x is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x4027BA2C7ac79ad0fBAB62859C2e0a31eaF2C86f;

    string private constant _name = "999x";
    string private constant _symbol = "999x";
