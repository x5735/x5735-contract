...
contract FoolsFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "FoolsFloki";
    string private constant _symbol = "FoolsFloki";
