...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x03C147dF52420aeDFBAe7E5b945a710d7B46183E; // owner address
...
contract Safemoon911 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safemoon911";
    string private _symbol = "Safemoon911";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x03C147dF52420aeDFBAe7E5b945a710d7B46183E); // Marketing Address
    address payable public teamWalletAddress = payable(0x03C147dF52420aeDFBAe7E5b945a710d7B46183E); // Team Address
