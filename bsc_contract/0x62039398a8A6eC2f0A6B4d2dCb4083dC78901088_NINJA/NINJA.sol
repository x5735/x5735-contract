...
contract NINJA is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    address private constant USDT_ADDRESS = 0x20dd734594DAdc69DF313CD143B34a70a3D9214E;
    ...
    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("NINJA", "NINJA") {
