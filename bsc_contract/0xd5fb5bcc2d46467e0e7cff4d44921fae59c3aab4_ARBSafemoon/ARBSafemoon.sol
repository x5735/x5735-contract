...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3dcB665B7D419B642D962Ba5f63fb10636408522; 
...
contract ARBSafemoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ARB SAFEMOON";
    string private _symbol = "ARBSafemoon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc215faD4D634B1e09d426c79F6797853232E502f); // 
    address payable public teamWalletAddress = payable(0xc215faD4D634B1e09d426c79F6797853232E502f); // 
