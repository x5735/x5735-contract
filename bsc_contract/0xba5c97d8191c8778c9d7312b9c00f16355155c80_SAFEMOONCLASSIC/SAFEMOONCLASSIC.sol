...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE6C5cC995e4A72CdEacaf87728DD39A8C4eb2Da8; // owner address
...
contract SAFEMOONCLASSIC is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xF236f9fc3D2B4EC2e7EB329B50826BBADD039591); // Marketing Address
    address payable private teamWalletAddress = payable(0xE6C5cC995e4A72CdEacaf87728DD39A8C4eb2Da8); // Team Address
