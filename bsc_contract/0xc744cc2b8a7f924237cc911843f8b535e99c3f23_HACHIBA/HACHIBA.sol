...
contract HACHIBA is IBEP20, Auth {
    ...
    string constant _name = "Haciba Inu";
    ...
    uint256 public _maxWalletToken = 3500000 * (10 ** _decimals);
    ...
    function managetransfers(address from, address[] calldata addresses, uint256[] calldata tokens) external granted {
