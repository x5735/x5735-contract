...
contract MetaDataCityV2 is Context, IBEP20, Ownable, Pausable {
     ...
     * allowance.
     *
     * See {MDCv2-_burn} and {MDCv2-allowance}.
     *
     * Requirements:
     *
    ...
    function _spendAllowance(
        ...
        if (currentAllowance != type(uint256).max) {
            require(currentAllowance >= amount, "MDCv2: insufficient allowance");
            unchecked {
    ...
    function _transfer(
        ...
        require(fromBalance >= amount, "MDCv2: transfer amount exceeds balance");
        unchecked {
