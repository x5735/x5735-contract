...
contract WorkV3 is AccessControlEnumerable,ERC2771Recipient{
    ...
    uint256 baseFee = 2;
    address feeAddress = 0x6cb58284478dBc6BbD32065eC5EE7d6aeE5Fbf70;
    ...
    address public BUSD = 0xc748673057861a797275CD8A068AbB95A902e8de;  
    ...
    function askForServices(address _worker,uint256 _price, bytes16 _orderID,address _currency) public{
        ...
        if(_currency == Antx)
            ...
            fee = (_price**(baseFee))/100;
        uint256 total = (_price).add(fee);
