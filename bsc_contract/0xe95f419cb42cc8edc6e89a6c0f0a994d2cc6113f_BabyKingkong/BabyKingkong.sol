 ...
 * Telegram https://t.me/BabyKingkongBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6668BE24B46a94CE2cB69c6e24f131AD61C98E86; // owner address
...
contract BabyKingkong is Context, IERC20, Ownable {
    ...
    string private _name = "BabyKingkong";
    string private _symbol = "BabyKingkong";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xE73c23eF721b44e2C506EddB9FEeF27F6201c066); // Marketing Address
    address payable public teamWalletAddress = payable(0xE73c23eF721b44e2C506EddB9FEeF27F6201c066); // Team Address
