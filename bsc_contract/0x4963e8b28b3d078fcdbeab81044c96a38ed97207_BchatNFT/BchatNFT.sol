...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintNftWithTokenUser(address to) public onlyMinter returns (bool) {
		...
		tokenId = tokenId + 1;
		_mint(to, tokenId);
        _setTokenURI(tokenId, "https://ipfs.io/ipfs/QmQdDZiVVYcpVSiFg56KVDZk216W95taGi39AwGbB288Gp");
        return true;
    }
}
...
contract BchatNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("B chat NFT", "B chat NFT") {
