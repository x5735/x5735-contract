...
contract LOFIStake {
    ...
    //STAKING DURATION
    uint256[4] public Duration = [3 days, 7 days, 14 days, 21 days];
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address TKN_WBNB = 0xDD75db199f420aC3A6e0fCf6b9F553429b4C511B; // TKN_WBNB pancake pool address
        IERC20 TKNTOKEN = IERC20(0xf4E4df009AD4Bc9d5cDc66ac6FAE37d7b5361cF8); // TKN Token address 
