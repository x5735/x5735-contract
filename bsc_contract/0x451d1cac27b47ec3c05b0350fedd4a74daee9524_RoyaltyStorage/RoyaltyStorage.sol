...
contract RoyaltyStorage is Ownable{
    ...
    function setRoyaltyData(
        ...
        require(msg.sender == platformLazyNFT || msg.sender == marketplace || msg.sender == owner(), "Only run on redeem");
    ...
    function setLazyNFT(address _platformLazyNFT) external onlyOwner{
        platformLazyNFT = _platformLazyNFT;
    }
