...
contract Token is ERC20, Ownable {
    ...
    uint256 public killTradeBlock = 10;
    ...
    constructor(address _marketingWallet) ERC20("Rise Bot", "Risebot") {
        address router;
    ...
    function setBlacklistMode(bool b) public onlyOwner {
        blacklistMode = b;
    }
    ...
    function _transfer(
        ...
        if (_totalFees > 0) {
            if (block.number < startTradeBlock + killTradeBlock) {
    ...
    function _killTransfer(
        ...
        super._transfer(sender, address(0x000000000000000000000000000000000000dEaD), feeAmount);
