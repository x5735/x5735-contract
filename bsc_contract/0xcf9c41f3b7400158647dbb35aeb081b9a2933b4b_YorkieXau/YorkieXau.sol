...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5576801289aBf804B702790A4459A160c773A8A7; // YorkieXau
...
contract YorkieXau is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YorkieXau";
    string private _symbol = "YORKIEXAU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5576801289aBf804B702790A4459A160c773A8A7); // YorkieXau Marketing
    address payable public earnWalletAddress = payable(0x5576801289aBf804B702790A4459A160c773A8A7); // YorkieXau Earning Pool
