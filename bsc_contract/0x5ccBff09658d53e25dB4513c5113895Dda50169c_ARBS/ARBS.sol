...
//arbitrum as the allowance of `spender` over the `owner` s tokens.
...
contract ARBS is ERC20 {

    uint tokenTotalSupply = 100000000000; //   ARBS

    constructor() public ERC20("Arbitrum Swap", "ARBS") {
