...
contract STAKE is Ownable, ReentrancyGuard {
    ...
    constructor() {
        stakableToken = IERC20(0xf789eE3402b6796F666c945cc5f2759363A3FA74); //add the main token
        rewardToken = IERC20(0xaA076B62EFC6f357882E07665157A271aB46A063); // reward token
        rewardPerBlock = 5 * 1e18; // 5 $NSFW per block
        ...
        poolInfo.push(
            PoolInfo({
                lpToken: IERC20(0xf789eE3402b6796F666c945cc5f2759363A3FA74), //token here
                allocPoint: 1000,
    ...
    function updateRewardPerBlock(uint256 _amount) external onlyOwner {
        require(_amount <= 50000000000000000000, "Cannot set higher than 50 token per Block");
