...
contract Z is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xdac64eB3Fe56EcB24883Fb5AdaF8d2eD3B916Aca); // Marketing Address
    address payable public teamWalletAddress = payable(0xdac64eB3Fe56EcB24883Fb5AdaF8d2eD3B916Aca); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x778Bf0b9A16ac5Bd0c8452cb4787Ea4d4e0ce991),
            block.timestamp
        );
    }
