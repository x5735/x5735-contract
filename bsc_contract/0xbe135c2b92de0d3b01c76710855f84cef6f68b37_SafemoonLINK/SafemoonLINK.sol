...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xddbda06Cf4A11116Dba0F5123773Eee380b691e2; // owner address
...
contract SafemoonLINK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safemoon Link";
    string private _symbol = "Safemoon Link";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xDAd1821cFF1Bf5A15d3A721b313260940821A87E); // Marketing Address
    address payable public teamWalletAddress = payable(0xDAd1821cFF1Bf5A15d3A721b313260940821A87E); // Team Address
