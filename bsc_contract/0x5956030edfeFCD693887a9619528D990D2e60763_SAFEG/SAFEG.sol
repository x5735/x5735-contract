...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9B7DF243c89cBC66503f6EA4b2D1565c632feb8D; 
...
contract SAFEG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safemoon Gold";
    string private _symbol = "SAFEG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9B7DF243c89cBC66503f6EA4b2D1565c632feb8D); // 
    address payable public teamWalletAddress = payable(0x9B7DF243c89cBC66503f6EA4b2D1565c632feb8D); // 
