...
/*
https://t.me/ChickenCeoFloki_Portal
*/
...
contract CHICKENCEOFLOKI is ERC20, Ownable {
    uint256 private constant initialSupply = 1_000_000_000_000 * 10**18;
    uint256 public constant denominator = 10000;
    uint256 public constant swapThreshold = 0.01 ether; // The contract will only swap to ETH, once the fee tokens reach the specified threshold
    ...
    constructor(address _router) ERC20("CHICKEN CEO FLOKI", "CHICKENCEOFLOKI") payable
    {
        ...
        // External wallets 
        taxWallets["marketing"] = 0xA4f2fdb98eE2E447a97D35fdb7980c2F119b7453;
        taxWallets["dev"] = 0xA4f2fdb98eE2E447a97D35fdb7980c2F119b7453;
    ...
    function SetSwap(bool _inSwap) public onlyOwner {
        inSwap = _inSwap;
    }
