...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _BurnGGSQFee = 50;
    ...
    constructor (
        address RouterAddress, address FISTAddress,address GGSQAddress,
        ...
        IERC20(GGSQAddress).approve(address(swapRouter), MAX);
        ...
        _feeWhiteList[0xE4b6a1cFc8524FcbF20ec8F3E760ba1E4562cc89] = true;
        ...
        excludeHolder[0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE] = true;

        holderRewardCondition = 1;

        _tokenDistributor = new TokenDistributor(FISTAddress);
        _tokenDistributor1 = new TokenDistributor(GGSQAddress);
    }
                ...
                if (_swapPairList[to]) {
                    if (!inSwap) {
                        ...
                        if (contractTokenBalance > 0) {
                            uint256 swapFee = _buyFundFee + _buyLPDividendFee + _sellFundFee + _sellLPDividendFee + _BurnGGSQFee;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            uint256 swapFee;
            if (isSell) {
                swapFee = _sellFundFee + _sellLPDividendFee + _BurnGGSQFee;
            } else {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (BurnAmount > 0) {
            uint256 BurnFist = fistBalance * BurnFee / swapFee;
            if (BurnFist > 0) {
                ...
                IERC20 GGSQ = IERC20(_ggsq);
                uint256 ggsqBalance=GGSQ.balanceOf(address(_tokenDistributor1));
                GGSQ.transferFrom(address(_tokenDistributor1),address(0),ggsqBalance);
            }
        }
    }
    ...
    function setBurnGGSQFee(uint256 burnFee) external onlyOwner {
        _BurnGGSQFee = burnFee;
    }
...
contract QBGG is AbsToken {
    constructor() AbsToken(
    
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),   
        address(0x55d398326f99059fF775485246999027B3197955),
        address(0x0f3a272617f5900592d69e94119943Ecae0Dd281),
        "QBGG",
        "QBGG",
        18,    
        1000000000000,   
        address(0x7ED9cac6547Bee8773AdeC28B3A43483E0dE9c7f),
        address(0x9C1EcD195BE11bfE93d8c97E48Cae7bd8718D929),   
        address(0x616776f804632a63F4F11e3b3416Fdb268888888)
    ){
