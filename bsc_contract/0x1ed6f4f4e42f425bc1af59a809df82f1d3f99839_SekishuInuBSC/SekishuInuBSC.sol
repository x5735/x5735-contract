...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x95a515EFfD9B87c4c9080507a7959d7dB5DE1529; // owner address
...
contract SekishuInuBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sekishu Inu";
    string private _symbol = "SEKISHU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x897f507F8196D8c220cB6AF5Ef9fB06Caa754615); // Marketing Address
    address payable private teamWalletAddress = payable(0x95a515EFfD9B87c4c9080507a7959d7dB5DE1529); // Team Address
