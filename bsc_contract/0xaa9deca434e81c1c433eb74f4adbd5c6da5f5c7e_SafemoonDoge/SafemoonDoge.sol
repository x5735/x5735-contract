...
*  Telegram: https://t.me/SafeMoonDoge
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3B47Ac98ED594aF935779685a9D4105640c088e8; // owner address
...
contract SafemoonDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safemoon Doge";
    string private _symbol = "Safemoon doge";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xc737fA59216Fc0CF74aB5a583307C28Ba288a2A6); // Marketing Address
    address payable public teamWalletAddress = payable(0xc737fA59216Fc0CF74aB5a583307C28Ba288a2A6); // Team Address
