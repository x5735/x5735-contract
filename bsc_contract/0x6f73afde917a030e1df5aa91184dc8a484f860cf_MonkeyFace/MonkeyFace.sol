...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x64FBFA7D5C585A488cb2192E7f67F7Be6D659035; // owner address
...
contract MonkeyFace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Monkey Face";
    string private _symbol = "$MF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x64FBFA7D5C585A488cb2192E7f67F7Be6D659035); // Marketing Address
    address payable private teamWalletAddress = payable(0x64FBFA7D5C585A488cb2192E7f67F7Be6D659035); // Team Address
