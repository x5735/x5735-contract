...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xac456d0dD7De3f4fFaBE11f6ee86Eb56c4921f4C; 
...
contract ANTX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AntX";
    string private _symbol = "AntX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xac456d0dD7De3f4fFaBE11f6ee86Eb56c4921f4C); // 
    address payable public teamWalletAddress = payable(0x0CAFa8c91f9098505573313599336631fAeae0C8); // 
