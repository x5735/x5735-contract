...
contract sharpeiinu is IBEP20, Auth {
    ...
    uint256 _totalSupply = 100000 * (15 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 10000; //20,000,000
   
    //max wallet holding of 1%
    uint256 public _maxWalletToken =  _totalSupply  / 10000; //100,000,000
