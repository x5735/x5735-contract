...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x429c2370D18d90Ec91382F1744c029Be12CB63eD; // owner address
...
contract EricTheGoldFishBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ERICTHEGOLDFISH";
    string private _symbol = "$ETGF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x09A50eaCc2654d6480702eA9b7Af9C2d78FE7016); // Marketing Address
    address payable private teamWalletAddress = payable(0x429c2370D18d90Ec91382F1744c029Be12CB63eD); // Team Address
