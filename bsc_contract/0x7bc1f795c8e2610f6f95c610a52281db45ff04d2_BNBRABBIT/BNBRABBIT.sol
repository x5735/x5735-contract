...
contract BNBRABBIT is Context, IERC20, Ownable {
    ...
    address payable private _dev = payable(0xfBf8eE67164df7c50340AB6A4cd378ad447FFB24);
    address payable private _mkt = payable(0xfBf8eE67164df7c50340AB6A4cd378ad447FFB24);
    
    string private constant _name = "BNBRabbit";
    string private constant _symbol = "BNBRB";
