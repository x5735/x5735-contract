...
contract THEWARRIORS is Ownable, IBEP20 {
    using SafeMath for uint256;

    string constant _name = "The Warriors";
    string constant _symbol = "WARRIORS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * 10**_decimals;
    uint256 private _MaxTxLimit = 100000000000 * 10**_decimals;
    uint256 private _MaxWalletLimit = 100000000000 * 10**_decimals;
    ...
    constructor() {
        ...
        marketingFeeReceiver = 0x89DB0E2f908B65778eA46c6e1fc5FCb8f5d83Cee;
        ...
        onlyOwner
    {
        ...
        _MaxWalletLimit = (_totalSupply * maxWallPercent_base1000) / 1000;
    }
    ...
    function setMaxSell(uint256 maxTXPercentage_base1000) external onlyOwner {
        ...
        _MaxTxLimit = (_totalSupply * maxTXPercentage_base1000) / 1000;
    }
    ...
    function _transferFrom(
        ...
        if (
            ...
            require(
                (heldTokens + amount) <= _MaxWalletLimit,
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        require(
            amount <= _MaxTxLimit || isTxLimitExempt[sender],
            "TX Limit Exceeded"
        );
    }
