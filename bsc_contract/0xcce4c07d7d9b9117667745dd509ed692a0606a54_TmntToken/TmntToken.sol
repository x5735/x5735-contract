...
contract TmntToken is IERC20, Ownable {
    ...
    constructor (){
        ...
        uint256 total = 410 * 10 ** _decimals;
        _tTotal = total;
        _maxWalletToken = 410 * 10**_decimals;

        fundAddress = 0xF07539354eDD8986df75186Fa5f19DaA9d961996;
        devAddress = 0xF07539354eDD8986df75186Fa5f19DaA9d961996;
