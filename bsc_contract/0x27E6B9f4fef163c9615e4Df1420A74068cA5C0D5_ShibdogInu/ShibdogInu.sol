...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB50a94C68E47420c42cFe7E7f893AfCD1C748E8f; // owner address
...
contract ShibdogInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Shibdog Inu";
    string private _symbol = unicode"$Shibdog";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB50a94C68E47420c42cFe7E7f893AfCD1C748E8f); // Marketing Address
    address payable public teamWalletAddress = payable(0xB50a94C68E47420c42cFe7E7f893AfCD1C748E8f); // Team Address
