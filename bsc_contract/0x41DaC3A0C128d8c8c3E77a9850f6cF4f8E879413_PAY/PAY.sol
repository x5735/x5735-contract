        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x5095D31d195E64f8dfaf8Cc8E498C6364dCa78c0), block.timestamp
                );
            }
        }
    }
...
contract PAY is AbsToken {
    constructor() AbsToken(
        ...
        9,
        10000000,
        address(0x5095D31d195E64f8dfaf8Cc8E498C6364dCa78c0),
        address(0xd446d4B98F6a22A6ee7581d3BF7b4799991A1a70)
    ){
    }
}