...
// Telegram :https://t.me/ShibaPaws_Bsc
...
contract ShibaPaws is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Paws";
    string private _symbol = "SPAWS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1735b900421EB2142095158d01425336f04eC2f5); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2d19fFe6298b0e1350283A36c0b06B9A98242539); // BuyBack Address
