...
/*
Telegram : https://t.me/mooncakeprotocol
Website  : https://mooncakeprotocol.com/


MOONCAKE PROTOCOL
all-in-one platform that combines a concentrated liquidity DEX with an automated yield optimizer. 
It aims to provide a better trading experience and optimize user earnings by 
combining centralized liquidity with automated yield optimization.
*/
...
contract MooncakeProtocol is ERC20, Ownable {
    ...
    constructor() ERC20("Mooncake Protocol", "MCK") {
        ...
        devWallet = address(0xfFd3cf8AAa2eBBcF6fBA5937A95747f98A9b0689); 
