 ...
 * {BEP721Enumerable}.
 */
contract BEP721 is  Context, BEP165, IBEP721, IBEP721Metadata, IBEP2981 {
        ...
        returns (uint256)
    {
        require(
            owner != address(0),
            "BEP721: address zero is not a valid owner"
        );
    ...
    function _lazyMint(
        ...
        require(to != address(0) && from != address(0), "BEP721: mint to the zero address");
 ...
 */
abstract contract BEP721URIStorage is BEP721,  Owned {
    using Strings for uint256;
...
contract BidexCollection721 is BEP721URIStorage {
    ...
    ) BEP721(name_, symbol_) Owned(_ownerAddress) {
    }
