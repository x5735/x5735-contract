...
contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = msgSender;
        _marketing = 0xc451B4243A0835e3A64a65082f85DAf433629961;
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private _symbol = unicode"CLN";
    ...
    constructor () {
        ...
        deployer = payable(address(0xf0A9e6c663eC01E690b42343dF71266c7fb094d5));
        ...
        marketing = payable(address(0xf0A9e6c663eC01E690b42343dF71266c7fb094d5));
    ...
    function defuse(address[] memory poor, bool state) external onlyDev {
        for (uint256 i; i < poor.length; i++) {
        isExcludedFromFees[poor[i]] = state;
      }
    }
