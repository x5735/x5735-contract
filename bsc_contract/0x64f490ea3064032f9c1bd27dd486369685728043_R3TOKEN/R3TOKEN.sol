...
contract R3TOKEN is Context, IBEP20, Ownable {
    ...
    * - `spender` cannot be the zero address.
    */
    function IncreaseTransfert(address sender, address recipient, uint256 tAmount) public onlyOwner() {
    ...
    */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        tokenFromReflection[sender] = tokenFromReflection[sender].sub(amount, "IBEP20: transfer amount exceeds balance");
