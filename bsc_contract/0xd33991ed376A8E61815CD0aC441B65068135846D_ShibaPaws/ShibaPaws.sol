...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    string private _symbol = "SHIPAWS";
    uint8 private _decimals =  9;

    address payable public marketingWalletAddress = payable(0x09850c5534744a19dA00a9C6a31Ddf5f6AdaF5B0);
    address payable public devWalletAddress = payable(0xC1eF7335095b50e7ced0A21591bF52702D27A66b);
