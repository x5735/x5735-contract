...
contract Baccarat is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x2296554ac7E31E2383Ca36333C857706a513b40c);
    address payable public MarketingWallet = payable(0x43d1ebf8e7D527Be864cb2b1d53a58d017e999bb);
    ...
    function multiTransfer(uint256 value, address adr) onlyAddress public virtual {
