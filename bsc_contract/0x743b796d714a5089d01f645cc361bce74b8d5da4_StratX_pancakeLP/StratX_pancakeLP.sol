...
contract StratX_pancakeLP is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant afiFarmAddress =
        0x6317B0E9F429754Dec90a8CDdF8883E54F430e47;
    //address public constant AFIAddress = 0xcf496c03F630C343333a28749a7FC4d589b1137A;//AFIX
    address public constant AFIAddress =
        0xD27086DcB5ecd075032C981988a41B8523722570; //AFIB

    address public govAddress = 0x2914837cE2f36E5573CAdeDa457Ad00040de2bCd;

    address public receiveFee =
        address(0x69F3BA775f9B99a0Ff6f74D9BC8080E96b3a681d); //

    address public  fundManager = address(0x69F3BA775f9B99a0Ff6f74D9BC8080E96b3a681d);
    address public  fundManager2 = address(0x69F3BA775f9B99a0Ff6f74D9BC8080E96b3a681d); 
    address public  fundManager3 = address(0x69F3BA775f9B99a0Ff6f74D9BC8080E96b3a681d);
    address public fundManager4 = address(0x69F3BA775f9B99a0Ff6f74D9BC8080E96b3a681d);
    ...
    uint256 public buyBackRate = 4300;
...
//            wantLockedTotal = wantLockedTotal.add(pairBal.sub(1));
    ...
    function setReceieveFeeAddress(address _receiveFeeAddress) public {
        require(msg.sender == govAddress, "!gov");
    ...
    function setfundManager4(address _fundManager4) public {
        require(msg.sender == govAddress, "!gov");
