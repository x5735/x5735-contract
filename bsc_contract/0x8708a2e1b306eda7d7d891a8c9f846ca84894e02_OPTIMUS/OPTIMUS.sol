...
abstract contract Project {
    address public marketingWallet = 0x6860332782b0F584Dc10c2794DF211388295e100;
    address public treasuryWallet = 0xe3CC828C8d049D396fA897e1B49A202958ae7eBb;

    string constant _name = "OPTIMUS BUNNY AI";
    string constant _symbol = "OPTIMUS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 10) / 200; // (_totalSupply * 10) / 1000 [this equals 5%]
...
contract OPTIMUS is Project, IBEP20, Auth {
    using SafeMath for uint256;
