 ...
 *Submitted for verification at BscScan.com on 2023-03-29
  TELEGRAM: https://t.me/BinanceHulk
/*
...
contract BINANCEHULK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " BINANCE HULK ";
    string private _symbol = " CZHULK " ;
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07B79c4651E71762e0A5C53b408fD3591C2660fA); 
    address payable public teamWalletAddress = payable(0x07B79c4651E71762e0A5C53b408fD3591C2660fA); 
