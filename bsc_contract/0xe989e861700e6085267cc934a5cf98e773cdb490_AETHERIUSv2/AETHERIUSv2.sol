...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6c57A14043984C8CC9c3C46eC76D928E6140b62A; // owner address
...
contract AETHERIUSv2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AETHERIUSv2";
    string private _symbol = "AETH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6c57A14043984C8CC9c3C46eC76D928E6140b62A); // Marketing Address
    address payable public teamWalletAddress = payable(0x6c57A14043984C8CC9c3C46eC76D928E6140b62A); // Team Address
