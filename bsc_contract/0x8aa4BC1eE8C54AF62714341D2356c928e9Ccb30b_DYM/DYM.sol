...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private marketAddress = address(0xF0Cab3f92C7c4616cF71a6A88c1bE882aAb7547b); 
    address private teamAddress = address(0xc346b2FcF7D442Df811A185908b5CEff0dCe145C); 
    ...
    uint256 public _walletMax = 40 * 10**18;
    uint256 public canRemoveTime = 3600 ;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
                ...
                if (block.timestamp >_startTradeTime + canRemoveTime + 1 && block.timestamp <=  _startTradeTime + 172800) {//前2天
                ...
                else if( block.timestamp <=  _startTradeTime + 172800 && block.timestamp <= _startTradeTime + 355600) {//第3-4天
                    ...
                    uint removeFeeAmount = tAmount * 5 / 100;
                    if (removeFeeAmount > 0) {
                        feeAmount += removeFeeAmount;
...
contract DYM is AbsToken {
    ...
    //USDT
        ...
        9111,
    //Receive
        address(0x71f233f6db22C0169738d6740B536FF1C125EbB9),
    //Fund
        address(0xfAc3E214D0B880f75e56CE33484Dbe9256431f8e)
    ){
    }
}