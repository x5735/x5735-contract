...
/**
https://t.me/BabySafemoon96entry
...
contract babySAFEMOON96 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "babySAFEMOON96";
    string private _symbol = "baby96";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0xe42B27D496c8c5904C7fECaA5D8e644711B1674b); // Marketing Address
    address payable public teamWalletAddress = payable(0xe42B27D496c8c5904C7fECaA5D8e644711B1674b); // Team Address
