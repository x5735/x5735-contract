...
contract SGOLD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC35E7F472f93e81db834B1b3AC21c4092EC29685); 
    address payable public Wallet_Dev = payable(0xC35E7F472f93e81db834B1b3AC21c4092EC29685);
    ...
    string private constant _name = "SAGRADA GOLD"; 
    ...
    constructor () {
        ...
        _owner = 0xC35E7F472f93e81db834B1b3AC21c4092EC29685;
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Maintet
