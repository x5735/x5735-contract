...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcb4B87cb87979F3bb352BD75c7Ab3919D90bE779; 
...
contract SAFEMOONGALA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " SAFEMOON GALA ";
    string private _symbol = " $SGALA ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcb4B87cb87979F3bb352BD75c7Ab3919D90bE779); // 
    address payable public teamWalletAddress = payable(0xcb4B87cb87979F3bb352BD75c7Ab3919D90bE779); // 
