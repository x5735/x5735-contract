...
/**
    Telegram: https://t.me/ShibShinjiOfficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6d73EA7D46d4488ceD1B4676a2e12315f0F6daa1; // owner address
...
contract ShibShinji is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Shib Shinji ";
    string private _symbol = "$SSHInji";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6d73EA7D46d4488ceD1B4676a2e12315f0F6daa1); // Marketing Address
    address payable public teamWalletAddress = payable(0x6d73EA7D46d4488ceD1B4676a2e12315f0F6daa1); // Team Address
