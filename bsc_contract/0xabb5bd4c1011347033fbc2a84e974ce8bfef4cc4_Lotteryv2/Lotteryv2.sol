...
contract Lotteryv2 is ReentrancyGuard, Ownable {
    ...
    function buyTicket(
        ...
        // referral system and ticket bundle incentives
        if (referrer != address(0) && referrer != msg.sender) {
            uint256 referralReward = amount.div(20); // 5% referral reward
            token.transferFrom(msg.sender, referrer, referralReward);
            emit ReferralRewarded(msg.sender, referrer, referralReward);
        }
