...
contract ShibaEggs is IBEP20, Auth {
    ...
    address constant DEV = 0x58434225E25Da0f01e8EB33e2e1a4e954F84fa7D;


    string constant _name = "Shiba Eggs";
    string constant _symbol = "$SEGGS";
