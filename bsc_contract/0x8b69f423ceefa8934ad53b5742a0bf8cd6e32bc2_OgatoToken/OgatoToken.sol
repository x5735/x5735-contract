...
contract OgatoToken is BEP20, Ownable {
    ...
    uint256 private totalSupply_ = 1_000_000_000 * (10 ** _decimals);
    uint256 public swapTokensAtAmount = (totalSupply_) / 1000000;
    ...
    constructor() BEP20("OGATO", "OGT")
    {
        buyFee = 2;
        sellFee = 3;

        marketingWallet = address(0x800c2b5951A7Bee71fD8C0F04754034BD2b46A37);
    ...
    function _transfer(
        ...
        if (!swapping && canSwap && to == uniswapV2Pair && !_isExcludedFromFees[from] && !_isExcludedFromFees[to] ) {
            swapAndLiquify();
        }
    ...
    function swapAndLiquify() private lockTheSwap {
        ...
        if (deltaBalance > 0) {
            sendBNB(payable(marketingWallet), deltaBalance);
        }
    }
