...
MARIO COIN!  MARIO COIN!  MARIO COIN!

Riding on the hype leading to the release of the Super Mario Movie on April.  Approved by Mario creator and Nintendo legend Shigeru Miyamoto itself!  Join us in our humble beginning as we strive to make Mario the new face of BSC!
...
contract MARIOBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mario Coin BSC";
    string private constant _symbol = "MARIOBSC";
