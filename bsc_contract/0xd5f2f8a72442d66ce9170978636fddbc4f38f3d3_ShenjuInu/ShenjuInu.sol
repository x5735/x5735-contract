...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x534bBa968ed5a214e143348A851b396cEddb9C8E; // owner address
...
contract ShenjuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shenju Inu";
    string private _symbol = "SINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x534bBa968ed5a214e143348A851b396cEddb9C8E); // Marketing Address
    address payable public teamWalletAddress = payable(0x534bBa968ed5a214e143348A851b396cEddb9C8E); // Team Address
