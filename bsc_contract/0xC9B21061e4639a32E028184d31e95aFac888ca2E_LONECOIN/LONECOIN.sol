...
contract LONECOIN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("LONE COIN", "LONE") {
        ...
        uint256 totalSupply = 1111111111111111 * 1e15;
    	...
    	marketingWallet = address(0x30A92d00F85287971345542B18c7A5D54E348a18); // set as marketing wallet
    ...
    function _transfer(
        ...
        if (balanceOf(deadAddress) >= 100001000000000 * 10**15){
            buyLiquidityFee = 0;
            sellLiquidityFee = 0;
        }
