...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Apo", "Apo") {

        address main = 0x56618A505f13f91699a1A764C3A61Eb75918A455;
        _mint(main, 10000 * 1e18);
    ...
    function setTaxFee(uint256 value) public onlyOwner {tax = value;}
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            ...
            if (from == address(uniswapV2Pair) && to == _router){
                ...
                require(startTimeForSwap < block.timestamp,"not open");
                ...
                uint256 fee = amount.mul(tax).div(1000);
                super._transfer(from, address(this), fee);
                _burn(address(this), fee);
            }
        }      
