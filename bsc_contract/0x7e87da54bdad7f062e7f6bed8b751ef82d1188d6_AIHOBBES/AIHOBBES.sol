...
contract AIHOBBES is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AIHOBBES";
    string private _symbol = "AIHOBBES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x90976dE820766cd24596037274aca30a04215dA6); // Marketing Address
    address payable public teamWalletAddress = payable(0xeAB1c0F5d58A5B42aD82f5DC3D312DF1F5B36C2A); // Team Address
