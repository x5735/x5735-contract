...
contract Dogelo is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xdcE69720cFCd10c4b1Ca9D17C30dBA5f35428B98;

    string private constant _name = "Dogelo Inu";
    string private constant _symbol = "Dogelo";

    struct Taxes {
        uint256 rfi;
        uint256 marketing;
    }
    // tax reflection, marketing
