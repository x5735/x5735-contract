...
contract cMonkey is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Cyber Monkey";
    string private _symbol = "cMokey";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x910448169958AE07963E87B8C0D496D70587EF97);
