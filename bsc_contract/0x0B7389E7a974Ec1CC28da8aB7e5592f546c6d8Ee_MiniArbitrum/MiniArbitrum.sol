...
contract MiniArbitrum is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mini Arbitrum";
    string private constant _symbol = "MARB";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 2000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 60000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 60000000000 * 10**_decimals;
