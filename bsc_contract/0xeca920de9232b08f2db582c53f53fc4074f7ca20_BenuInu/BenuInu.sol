...
contract BenuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Benu Inu";
    string private _symbol = "BENU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb2d5BE15691FAd471aE8351F6836867fb2eEA766); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xb2d5BE15691FAd471aE8351F6836867fb2eEA766); // BuyBack Address
