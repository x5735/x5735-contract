...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6Af5a47be15EBe278F87301b238A228d86dB1815; // owner address
...
contract ShibTronix is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibTronix";
    string private _symbol = "$ST";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7a2DBB31c3595210c0fa72546903A9C223332ABf); // Marketing Address
    address payable private teamWalletAddress = payable(0x7a2DBB31c3595210c0fa72546903A9C223332ABf); // Team Address
