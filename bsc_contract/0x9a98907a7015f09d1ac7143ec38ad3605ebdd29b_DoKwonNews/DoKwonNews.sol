...
/**
 * Telegram https://t.me/DoKwonNews
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x87EB8ff7AC887F6E7D4A08771215C9c892456982; // owner address
...
contract DoKwonNews is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DoKwonNews";
    string private _symbol = "DoKwon";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x87EB8ff7AC887F6E7D4A08771215C9c892456982); // Marketing Address
    address payable public teamWalletAddress = payable(0x87EB8ff7AC887F6E7D4A08771215C9c892456982); // Team Address
