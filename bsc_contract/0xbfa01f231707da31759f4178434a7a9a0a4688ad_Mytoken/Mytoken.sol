...
contract Mytoken is ERC20, Ownable {
    ...
    string public name_ = "DragonQueen Token";//名称
    string public symbol_ = "DragonQueen";//简称
    ...
    address public marketingWalletAddr_ = 0xcC49Cccb5F0bA2f2a7737c925210cc30baC84664;//营销钱包地址
    uint256[8] public  buyFeeSetting_ = [3,0,5,0];//买入手续费：持币分红、回流、营销钱包、销毁
    uint256[8] public  sellFeeSetting_ = [3,0,5,0];//卖出手续费：持币分红、回流、营销钱包、销毁
