...
abstract contract Project {
    ...
    string constant PROJECT_NAME = "JEETERY";
    string constant SYMBOL = "Jet";
 ...
 * MainContract
 */
contract JEETERY is Project, IBEP20, Ownable {
    using SafeMath for uint256;
...
// ***
    ...
    function getCoinwarsHolders() public view returns (address[] memory coinAHolders, address[] memory coinBHolders) {
