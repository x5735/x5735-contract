...
contract VoterV2_1 is IVoter, Ownable, ReentrancyGuard {
    ...
    function testBridge(uint16 chainId, bytes memory sideChainManager) public payable {
        ...
        lzEndpoint.send{value: msg.value}(chainId, sideChainManager, lzPayload, payable(address(0)), address(0), "0x");
    }
