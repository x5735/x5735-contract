...
/**
 * https://t.me/shitruminu
 * https://shitruminu.com/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB13245D1E1192c4b8Aa5dECF12D3A1eEE94006f5; // owner address
...
contract ShitrumInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shitrum Inu";
    string private _symbol = "SHIT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xB13245D1E1192c4b8Aa5dECF12D3A1eEE94006f5); // Marketing Address
    address payable public teamWalletAddress = payable(0xB13245D1E1192c4b8Aa5dECF12D3A1eEE94006f5); // Team Address
