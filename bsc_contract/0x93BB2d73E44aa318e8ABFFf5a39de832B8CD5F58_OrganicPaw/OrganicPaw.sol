...
contract OrganicPaw is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Organic Paw";
    string private _symbol = "OPaw";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF357E87C93C8fee041c7Fc83Fa11D015889987E5); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xF357E87C93C8fee041c7Fc83Fa11D015889987E5); // BuyBack Address
