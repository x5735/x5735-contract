...
contract HobbesGPT is Context, IERC20, Ownable {
    ...
    string private constant _name = "HobbesGPT";
    ...
    uint256 public _maxWallet = 60_000 * 10**18;
    uint256 private maxContractSwap = 6_000 * 10**18;
    ...
    function _transfer(
        ...
        if (canSwap && !inSwapAndLiquify && from != uniswapV2Pair && to != address(uniswapV2Router))
        {
