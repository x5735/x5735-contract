...
contract MUSICGPT4 is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Music GPT4";
    string private constant _symbol = unicode"M-GPT4";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**11 * 10**_decimals;

    address payable public DevWallet = payable(0xF697C3d77cFdA01cef3c80d426A660a5fC698FeB);
    address payable public MarketingWallet = payable(0x34fd15f9D3b63E26d6206A9Ef2D9766094889188);
