...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbFdfa2143d1aa3EFEA094E5177295df9E77202a8);
...
contract BabyHokkaidoInuOfficial is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Hokkaido";
    string constant _symbol = "BabyHOKA";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xbFdfa2143d1aa3EFEA094E5177295df9E77202a8;
    ...
    constructor () Auth(msg.sender) {
        ...
        // wallets
        autoLiquidityReceiver = 0xf4c048395208862A25482cA54e3aa77Ec3D6CE11;
        marketingWallet = 0x38F72A55FDBdA648F2C94D445ae1C231530aF538;
        devWallet = 0xf4c048395208862A25482cA54e3aa77Ec3D6CE11;
