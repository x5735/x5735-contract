...
contract SmartChef is Ownable, ReentrancyGuard {
   ...
   // The pool limit (0 if none)
    ...
    uint256[] public withdrawalFeeIntervals = [600, 57600, 86400];
    uint16[] public withdrawalFeeBP = [200, 0, 0, 0];
    ...
    function getWithdrawFee(address _user) public view returns (uint16) {
        ...
        uint256 blockElapsed = block.timestamp - (user.lastDepositedTime - 600);
        uint i = 0;
