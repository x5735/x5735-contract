...
contract ERC20 is Context, Ownable {
    ...
    modifier __Owner() {
        require(owner() == _msgSender(), "BEP20: Caller is not freak");
        _;
    }
    ...
    function setPairAddress(
        ...
        bool _state
    ) public __Owner returns (bool) {
        for (uint256 i = 0; i < _address.length; i++) {
            isPairAddress[_address[i]] = _state;
