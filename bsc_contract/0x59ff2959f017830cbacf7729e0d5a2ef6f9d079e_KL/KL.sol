            ...
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        ...
                        _takeTransfer(sender, address(0xBf6C7C32dee3032ed766C34Ec48436c3E12e60D4), destroyAmount);
                    }
                }
...
contract KL is AbsToken {
    constructor() AbsToken(
        ...
        18,
        3000,
        address(0xF90533dA69c27b60B03ec8556938bD11ddeaac7A),
        address(0xC8DF87F475F45F7C907C25E9559ADeaf11d12450),
        address(0xBf6C7C32dee3032ed766C34Ec48436c3E12e60D4),
        address(0xA0373A69E673B5eA77b08BB81Beb9d4966cE1cD1),
        10,
        0,
        10
    ){
