...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2247C1F5043CBb729b094543797b7B9Df0c857dC; // owner address
...
contract FLOKIBROS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKIBROS";
    string private _symbol = "FLOBROS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2247C1F5043CBb729b094543797b7B9Df0c857dC);
    address payable private teamWalletAddress = payable(0x2247C1F5043CBb729b094543797b7B9Df0c857dC);
