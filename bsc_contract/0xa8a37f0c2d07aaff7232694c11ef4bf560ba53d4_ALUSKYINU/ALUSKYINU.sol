...
Alusky Inu is a BSC token for Dogs and Non-dogs lover's . 
A combination of Alusky+ Inu.
Launching soon by a safe/experienced Dev.
Previous did 8k Ath
Utilities (Swap and website) soon!!
...
contract ALUSKYINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xa7e84f0031F886BEBdA56E4BD2C892a341ac2b7D;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Alusky Inu";
    string constant _symbol = "ALUSKY";
