...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE7f11D46Be01EE39a3BfB584b553F5e96eCdabfd; // owner address
...
contract YorkieFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Yorkie Floki";
    string private _symbol = unicode"$Yoki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE7f11D46Be01EE39a3BfB584b553F5e96eCdabfd); // Marketing Address
    address payable public teamWalletAddress = payable(0xE7f11D46Be01EE39a3BfB584b553F5e96eCdabfd); // Team Address
