...
/**
 *TG: https://t.me/EtherZilla

 11% ETH Rewards | BSC Pegged ETH : 0x2170Ed0880ac9A755fd29B2688956BD959F933F8

¨X¨T¨T¨T¨j¨[¨X¨[     ¨X¨T¨T¨T¨T¨[¨X¨[¨X¨[
¨U¨X¨T¨j¨a¨^¨g¨U     ¨^¨T¨T¨[¨T¨U¨U¨U¨U¨U
¨U¨^¨T¨m¨[¨X¨g¨^¨T¨j¨T¨T¨j¨T¨[¨X¨a¨X¨p¨g¨U¨U¨U¨X¨T¨T¨[
¨U¨X¨T¨T¨g¨U¨U¨X¨[¨U¨U¨T¨g¨X¨p¨a¨X¨a¨d¨g¨U¨U¨U¨U¨X¨[¨U
¨U¨^¨T¨T¨g¨^¨g¨U¨U¨U¨U¨T¨g¨d¨a¨T¨^¨T¨g¨U¨^¨g¨^¨g¨X¨[¨U
¨^¨T¨T¨T¨m¨T¨m¨a¨^¨m¨T¨T¨m¨m¨T¨T¨T¨T¨m¨m¨T¨m¨T¨m¨a¨^¨a
*/
...
contract EtherZilla is IBEP20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "EtherZilla";
    string private constant _symbol = "ETHZ";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply = 420 * 10**_decimals;
    ...
    constructor() Ownable() {
        ...
        Dev_wallet = 0x650eFFEC19503BBEaB99b0ff2C3f430a8cE38180;
        Marketing_wallet = 0x82Fe0f5826Bb143f8f05DEA209F681a868cD877E;
