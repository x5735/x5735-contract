...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD0bc9B12231ea06d6fC88e0B0e1A44d6745F94d3; 
...
contract CBDCINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CBDC Inu";
    string private _symbol = "CBDC Inu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD0bc9B12231ea06d6fC88e0B0e1A44d6745F94d3); // 
    address payable public teamWalletAddress = payable(0xD0bc9B12231ea06d6fC88e0B0e1A44d6745F94d3); // 
