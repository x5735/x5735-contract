...
contract NEONAI is ERC20, Ownable {
    ...
    constructor(
        ...
        require(
            ...
            'NEON AI: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'NEON AI: incorrect fee percent');
        require(owner != address(0), 'NEON AI: incorrect owner address');
        require(mintToAddr != address(0), 'NEON AI: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'NEON AI: transfer from the zero address');
        require(recipient != address(0), 'NEON AI: transfer to the zero address');
