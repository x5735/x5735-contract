...
/**
 *Submitted for verification at bscscan on 2023-03-31
*/

// SPDX-License-Identifier: Unlicensed 
// Contract created by mplanet.tech
...
contract MSN is Context, IERC20 { 
    ...
    address payable private constant Wallet_Fee = payable(0xe953f1550de8D594c3c7075b1aDdAB6a99B2Cd3A);
    ...
    function MSN_SetUp_1__Presale_Address(
    ...
    // Set buy fees
    function MSN_SetUp_2__Fees_on_Buy(
    ...
    // Set sell fees
    function MSN_SetUp_3__Fees_on_Sell(
    ...
    */
    ...
    function MSN_SetUp_4__Wallet_Limits(
    ...
    */
    ...
    function MSN_SetUp_5__Bot_Protection(
    ...
    // Open Trade
    function MSN_SetUp_6__Open_Trade() external onlyOwner {
    ...
    function MSN_SetUp_7__Blacklist_Bots(address Wallet, bool true_or_false) external onlyOwner {
    ...
    function MSN_SetUp_8__Deactivate_Launch_Mode() external onlyOwner {
    ...
    */
    ...
    function MSN_SetUp_9__Update_Wallets(
    ...
    */
    ...
    function MSN_SetUp_10__Update_Links(
    ...
    */
    ...
    function swapAndLiquify(uint256 Tokens) private {
        ...
        uint256 BNB_Contract    = returned_BNB * ( 0)    * 2 / fee_Split;
...
STANDARD BSC BEP20 TOKEN - Contract by MSN

    Website: https://mplanet.tech
