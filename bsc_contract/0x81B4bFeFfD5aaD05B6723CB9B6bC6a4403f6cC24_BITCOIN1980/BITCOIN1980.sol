...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE3041d7b556cD26A028F7664886313D960c8bd44; // owner address
...
contract BITCOIN1980 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BITCOIN 1980";
    string private _symbol = unicode"$BIT-1980";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE3041d7b556cD26A028F7664886313D960c8bd44); // Marketing Address
    address payable public teamWalletAddress = payable(0xE3041d7b556cD26A028F7664886313D960c8bd44); // Team Address
