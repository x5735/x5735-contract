        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xEA3f9c617A0fAa410C43710D7d1Ff9026De3a1bD), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        100000,//Su 
        address(0xEA3f9c617A0fAa410C43710D7d1Ff9026De3a1bD),//
        address(0xEA3f9c617A0fAa410C43710D7d1Ff9026De3a1bD)//
    ){
    }
}