...
contract BonjurICO is ContextUpgradeable, OwnableUpgradeable {
    ...
    function updateToken(IBEP20 _ADDRESS) public onlyOwner {
      rewardToken = _ADDRESS;
    }

    function updateoldToken(IBEP20 _ADDRESS) public onlyOwner {
      oldToken = _ADDRESS;
    }
    ...
    function updateBonjourContract(readContract _contract) public  onlyOwner {
        BonjourContract = _contract;
    }
