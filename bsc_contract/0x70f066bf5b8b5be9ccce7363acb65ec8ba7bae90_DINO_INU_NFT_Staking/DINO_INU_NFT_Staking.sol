...
contract DINO_INU_NFT_Staking is Ownable, ERC721Holder {

    IERC20 internal R_Token;
    IERC721 internal NFT;
    
    uint256 public dailyReward = 150_000 * 10**8;
    ...
    uint public maxNormalNftReward = 9_000_000 * 10**8;
    uint public maxSpecialNftReward = 13_500_000 * 10**8;
    ...
    function setfee(uint fee, uint deno) external onlyOwner {
        claimFee = fee;
        denominator = deno;
    }
