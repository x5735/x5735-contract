...
Yorkie Grow is a meme token based on popularity and trend across social media platforms. The community believes that its popularity can bring this token to the moon and gain more exposure with the help of one another and marketing.
...
Telegram: https://t.me/YorkieGrowPortal
Twitter: https://twitter.com/YorkieGrowBSC
...
contract YOGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yorkie Grow";
    string private _symbol = "YOGROW";
