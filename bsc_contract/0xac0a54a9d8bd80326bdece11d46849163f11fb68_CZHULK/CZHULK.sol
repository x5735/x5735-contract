...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeE0Bb3BED6f104F263fd587372B6c278a310f2cf; // owner address
...
contract CZHULK is Context, IERC20, Ownable {
    ...
    string private _name = "CZ HULK 2.0";
    string private _symbol = "CZ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xeE0Bb3BED6f104F263fd587372B6c278a310f2cf); // Marketing Address
    address payable public teamWalletAddress = payable(0xeE0Bb3BED6f104F263fd587372B6c278a310f2cf); // Team Address
