...
contract LionCeo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LionCeo";
    string private _symbol = "LCEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCd0518b2eACE144Ad0a27dF355371bBaAe066eDd); // Marketing Address
    address payable public teamWalletAddress = payable(0xCd0518b2eACE144Ad0a27dF355371bBaAe066eDd); // Team Address
