...
contract Chibidog is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "CHIBIDOG";
    ...
    address payable public DevWallet = payable(0xE4AA150394d79A9b900049B75795BEb640925E9d);
    address payable public MarketingWallet = payable(0x3462A33B5082Eee6a3C1477c17EE671AAE6dB1Ef);
