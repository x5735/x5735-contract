...
contract YouAreKING is Context, IERC20, Ownable {
    ...
    address payable private _dev = payable(0x9eA96330F1F8d0bD431ec5887B6999fe32345cfE);
    address payable private _mw = payable(0x9eA96330F1F8d0bD431ec5887B6999fe32345cfE);
    
    string private constant _name = "YouAreKING";
