...
/**
 https://ironymanerc.com/
 Irony Man - $IRONY
@IronyManERC
Irony Man - Defeats villain using the power of irony
*/

// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.19;

abstract contract ContextBEP20IronyMan {
...
contract OwnableBEP20IronyMan is ContextBEP20IronyMan {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEP20IronyMan: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEP20IronyMan: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract IronyMan is ContextBEP20IronyMan, BEP20IronyMan, OwnableBEP20IronyMan {
