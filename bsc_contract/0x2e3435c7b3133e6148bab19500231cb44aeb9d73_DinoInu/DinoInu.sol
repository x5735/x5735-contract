...
/*
    ...
    TG:         https://t.me/DinoInuOfficial
    Twitter:    https://twitter.com/DinoInuBSC
...
contract DinoInu is BEP20, Ownable {
    ...
    uint256 public maxBuyLimit = 2e7 * 10**18; // 2%
    uint256 public maxSellLimit = 2e7 * 10**18; // 2%
    uint256 public maxWalletLimit = 2e7 * 10**18; // 2%

    uint256 public genesis_block;
    uint256 private lunchTime = 20;
    uint256 private lunchTax = 30;
    ...
    Taxes public taxes = Taxes(9, 0);
    Taxes public sellTaxes = Taxes(9, 0);
    ...
    constructor() BEP20("Dino Inu", "DINU") {
    ...
    function SetBuyTaxes(
        ...
        require((_marketing + _liquidity) <= 15, "Must keep fees at 10% or less");
    }
    ...
    function updatelunchTime(uint256 _lunchTime) external onlyOwner {
        ...
        require(_lunchTime < 20,"lunchTime should be less than 20 Blocks");
