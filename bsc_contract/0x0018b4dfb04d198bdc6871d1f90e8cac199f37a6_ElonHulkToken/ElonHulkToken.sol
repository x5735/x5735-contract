...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x32e18959f2C97BA929eCE754B3597D52d12D9347; // owner address
...
contract ElonHulkToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Elon Hulk";
    string private _symbol = "EHULK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x32e18959f2C97BA929eCE754B3597D52d12D9347); // 
    address payable public teamWalletAddress = payable(0x32e18959f2C97BA929eCE754B3597D52d12D9347); // 
