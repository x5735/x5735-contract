...
contract Four is Context, IERC20, Ownable {
    ...
    address public charityWallet = 0xAD3C2C23c8d38261B04E09A2567e8a23ad49F77B;
    ...
    uint256 public _maxTxAmount =_tTotal.mul(10).div(100);  //MAX 10% 
    
    uint256 private numTokensSellToAddToLiquidity = _tTotal.mul(2).div(100);  //more than 5% to addLiquidity 
    ...
    function restoreSellAllFee() private {
        _taxFee       = 0;
        _liquidityFee = 3;
        _charityFee = 3;
        _burnFee      = 6;
    ...
    //Call this function after finalizing the presale
    function enableSellAllFees() external onlyOwner() {
        _taxFee       = 0;
        _previousTaxFee = _taxFee;
        _burnFee      = 6;
        _previousBurnFee = _taxFee;
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        require(maxTxPercent <= 100, "Cannot set transaction amount less than 10 percent!");
