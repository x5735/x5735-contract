...
contract MCEO is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xa1e2009FF1BdC6A3643ABe85f6B83ECDdC71b370;
    address public opsWallet = 0xa1e2009FF1BdC6A3643ABe85f6B83ECDdC71b370;
    address public devWallet = 0xa1e2009FF1BdC6A3643ABe85f6B83ECDdC71b370;

    string private constant _name = "Meme CEO Token";
    ...
    Taxes public taxes = Taxes(1, 4, 0, 1, 0);
