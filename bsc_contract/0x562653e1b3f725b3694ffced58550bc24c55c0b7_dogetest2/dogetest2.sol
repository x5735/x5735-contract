...
contract dogetest2 is IBEP20, Auth {
    ...
    string constant _name = "doge test2";
    string constant _symbol = "dogetst2";
    ...
    function changeSwapBackSettings(bool enableSwapBack, bool swapByLimitOnly) external authorized {
