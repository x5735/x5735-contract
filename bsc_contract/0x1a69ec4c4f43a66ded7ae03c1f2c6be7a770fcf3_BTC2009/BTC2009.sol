...
BTC2009 Math and computer fix finance.
Before 2009 we had no choice.
Now that there is #bitcoin, people are tired of the same cycle of problems and they are learning that they can opt out of banking.
TG Community - https://t.me/Bitcoin2009_BTC
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcAC27dD0606120995F527D9E48994052a612b7f1;
...
contract BTC2009 is Context, IERC20, Ownable {
    ...
    string private constant _name = "BTC2009"; // 
    string private constant _symbol = "BTC2009"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 5;
    address payable public  _marketingWallet = payable(0xcAC27dD0606120995F527D9E48994052a612b7f1);
