...
contract BNBCK is ERC20 {
	...
	address payable _fundAddress = payable(address(0x78158f667FC0aD5C8929385beB47bB1128D071c3));
    ...
    constructor(address tokenOwner) ERC20("BNBCK", "BNBCK") {
		...
		CAKE.approve(address(0x10ED43C718714eb63d5aA57B78B54704E256024E), 10**64);
