...
contract COINLANDS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "COIN LANDS";
    ...
    uint256 public _totalSupply = 1 * 10**10 * 10**4;
    uint256 public _maxTxAmount = 1 * 10**10 * 10**4;
    uint256 public _walletMax = 1 * 10**10 * 10**4;
