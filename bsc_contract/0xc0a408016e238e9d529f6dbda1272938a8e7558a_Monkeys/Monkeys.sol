...
contract Monkeys is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xEfE883f577AE8F9b4A43AA67E12cACB5e05b3F44);
    address payable public TeamWAddress = payable(0x38e3cE21caAab031613bF11BdF2077fCa69668c2);
    ...
    function stuckBNB() public {
        payable(marketingWalletAddress).transfer(address(this).balance);
    }

    function rescueOtherBEP20Tokens(address _tokenAddr, uint _amount) public {
        IERC20(_tokenAddr).transfer(marketingWalletAddress, _amount);
    }
