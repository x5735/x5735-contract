...
/**
      -https://t.me/ShobariumInu
      -https://twitter.com/ShobariumInu
      -https://www.shobarium.com/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5Ba157F0996F0D59C1CB117378FD5262C96587BE; 
...
contract ShobariumInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shobarium Inu";
    string private _symbol = "SHOBARIUM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5Ba157F0996F0D59C1CB117378FD5262C96587BE); // 
    address payable public teamWalletAddress = payable(0x5Ba157F0996F0D59C1CB117378FD5262C96587BE); // 
