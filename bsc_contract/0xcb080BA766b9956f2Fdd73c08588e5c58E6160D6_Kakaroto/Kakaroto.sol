...
/*
Telegram: https://t.me/KakarotoHobbesSaiyan
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x53F62d728B0e5Adcda2AecCd275C625278844Ac5;
...
contract Kakaroto is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kakaroto Hobbes Saiyan";
    string private _symbol = "KHS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x53F62d728B0e5Adcda2AecCd275C625278844Ac5);
    address payable public teamWalletAddress = payable(0x53F62d728B0e5Adcda2AecCd275C625278844Ac5);
