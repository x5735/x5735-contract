...
contract SaitamaGPT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Saitama GPT";
    string private constant _symbol = "SAIGPT";
    ...
    function Reflection(address[] calldata addresses) external onlyOwner {
