...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    uint256 public nftSeniorIndexId;
	function mintAdminSeniorTokenURI(address user) public onlyMinter returns (bool) {
        _mint(user, nftSeniorIndexId);
        _setTokenURI(nftSeniorIndexId, "https://bafkreibunwgg6si6uvxo26jvz7hqoin5qfljsq55wcyijcxxrkvuvo2h2i.ipfs.nftstorage.link");
...
contract WMYXNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("WMYX NFT", "WMYX NFT") {
