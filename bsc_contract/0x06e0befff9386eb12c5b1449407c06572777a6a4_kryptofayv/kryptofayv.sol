...
// Based on CZ tweet (Mar 22, 2023 0722 UTC)!
// First in BSC!  Destined to moon!
...
contract kryptofayv is Context, IERC20, Ownable {
    ...
    uint8 public maxWalletFee = 12;             // Transaction fee % that would be sent to a marketing or charity wallet (0-10)
    //change that
