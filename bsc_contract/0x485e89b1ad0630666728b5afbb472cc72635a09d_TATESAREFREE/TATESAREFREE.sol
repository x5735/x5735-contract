...
/**
ANDREW TATE & TRISTAN TATE ARE FREE!
*/
...
contract TATESAREFREE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TATESAREFREE";
    string private _symbol = "TATE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x29Fd4D1d381fcD1F55535572478f6E7400E79d92); // Marketing Address
    address payable public teamWalletAddress = payable(0x29Fd4D1d381fcD1F55535572478f6E7400E79d92); // Team Address
