...
// Join our Telegram Group: https://t.me/FLOKUSHBSC 
...
contract FLOKUSH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKUSH"; 
    string private _symbol = "$FKUSH"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x15182ccb2243C1ba81eCD5e60079606de4738435); 
    address payable public teamWalletAddress = payable(0x9BBB16a2683Ad68c1D741a7b16eA279a4a895246); 
