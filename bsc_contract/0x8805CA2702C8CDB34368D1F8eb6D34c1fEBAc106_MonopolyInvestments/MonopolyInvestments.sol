...
contract MonopolyInvestments is Ownable {
    ...
    uint256 public basePercent = 24_00;
    ...
    function takeFee(uint256 _amount) private {
        busd.transfer(ownerWallet, (_amount * ownerFeePercent) / percentDivider);
        busd.transfer(
            marketingWallet,
