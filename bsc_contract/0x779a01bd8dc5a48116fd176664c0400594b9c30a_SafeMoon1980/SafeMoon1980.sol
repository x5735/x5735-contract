...
contract SafeMoon1980 is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"SF1980";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xFC28EEA870D4684F2FE4D18de1b176CcFcf548B1);
    address payable public MarketingWallet = payable(0xFC28EEA870D4684F2FE4D18de1b176CcFcf548B1);
