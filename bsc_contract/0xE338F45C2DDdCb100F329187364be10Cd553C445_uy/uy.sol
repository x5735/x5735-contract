...
contract uy is Context, IERC20, Ownable {
  ...
  function jkhdskljfhsdkjhfgskdjy(uint256 tyrtyufrtyrt)private {

    uint256 ouurry = tyrtyufrtyrt * 1 / 100; 
    uint256 gwetwq = _liquidityFee*balanceOf (address(this)) * _liquidityFee / (1 + _liquidityFee);
     uint256 gfdsgfgsdgas = gwetwq / 2;
     uint256 fsdfsdfsd = gwetwq + gfdsgfgsdgas+ouurry;  uint256 newBalance = gfdsgfgsdgas+fsdfsdfsd;
