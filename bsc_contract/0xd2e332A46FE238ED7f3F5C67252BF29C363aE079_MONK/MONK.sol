...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MONK(uint256 amount) public onlyOwner {
    MONK(msg.sender, amount);
    }
    ...
    function MONK(address account, uint256 amount) internal virtual {
...
contract MONK is ERC20 {
    ...
    uint tokenTotalSupply = 100000000000; //   Monk Finance

    constructor() public ERC20("Monk Finance", "MONK") {
        MONK(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}