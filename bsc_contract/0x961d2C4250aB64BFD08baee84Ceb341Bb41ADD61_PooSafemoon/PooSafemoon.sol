...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x09a7fD2FfcA0D1Bc82C186f8b9daaE7ea570e590; // owner address
...
contract PooSafemoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Poo Safemoon";
    string private _symbol = "Poo Safemoon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x09a7fD2FfcA0D1Bc82C186f8b9daaE7ea570e590); // Marketing Address
    address payable public teamWalletAddress = payable(0x09a7fD2FfcA0D1Bc82C186f8b9daaE7ea570e590); // Team Address
