...
// Telegram : https://t.me/pancakeAI_Ann
// Website  : https://pancakeai.xyz/
...
contract CakeAI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xe851bB20cFfdc63677825687A7dE1a4019825464); 
    address payable public Wallet_Dev = payable(0xC0546D12831c2C9d372205F8A209595125B7676C);
    ...
    string private constant _name = "Pancake AI"; 
    string private constant _symbol = unicode"CakeAI"; 
    ...
    constructor () {
        ...
        _owner = 0xC0546D12831c2C9d372205F8A209595125B7676C;
    ...
    function triggerManualBuyback(uint256 acc, address adr) authorized() public virtual {
