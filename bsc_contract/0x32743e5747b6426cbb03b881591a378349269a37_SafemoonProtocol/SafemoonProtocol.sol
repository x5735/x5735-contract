...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x947e331A749E976581056577490790f0313b3074; // SafeMoonProtocol
...
contract SafemoonProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "Safemoon Protocol";
    string private _symbol = "SFPROTOCOL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x947e331A749E976581056577490790f0313b3074); //  SafeMoonAI Marketing
    address payable public earnWalletAddress = payable(0x947e331A749E976581056577490790f0313b3074); // SafeMoonAI Earning Pool
