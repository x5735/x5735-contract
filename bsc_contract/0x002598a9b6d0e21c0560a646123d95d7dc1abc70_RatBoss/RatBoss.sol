...
contract RatBoss is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "RATBOSS";
    string private constant _symbol = unicode"$RBOSS";
    ...
    address payable public DevWallet = payable(0x5e2f7B10855e8F4887548eeb3dd5052f8c0767c7);
    address payable public MarketingWallet = payable(0xf4346BD6834dA03cF0A9dC7573a95EB0eDc8dE83);
