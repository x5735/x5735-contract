...
contract FACAICAT is ERC20 {
	...
	address _fundAddress = address(0xa4eC3D26b68221078f047EAb73cc13398f2D4552);
    address _fund1Address = address(0xa4eC3D26b68221078f047EAb73cc13398f2D4552);
    ...
    constructor(address tokenOwner) ERC20("FACAI CAT ", "FACAICAT") {
		...
		nft = UsdtWarp(0x1D5B4137Bc314713D3C372c3F67A5829d1666666);//Nft Contract
