...
contract BITMETAHOLDINGToken is IBEP20 {
...
contract BITMETAHOLDINGBUSD {
    address payable admin;
    BITMETAHOLDINGToken public tokenContract;
    ...
    constructor(BITMETAHOLDINGToken _tokenContract, uint256 _tokensSold)  {
