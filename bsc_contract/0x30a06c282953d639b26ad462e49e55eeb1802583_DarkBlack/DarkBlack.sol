...
contract DarkBlack is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x925fe3E9a8335D3662D63BC4807bE4dD32481bF6); 
    address payable private Wallet_Dev = payable(0x1c419804800DBc72CaeC3132eC18F1655983e21b);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 20**6 * 10**_decimals;
    string private constant _name = "DarkBlack"; 
    ...
    uint256 private Percent_AutoLP = 30; 

    uint256 private _maxWalletToken = _tTotal * 3 / 100;
    ...
    constructor () {
        ...
        _owner = 0x1219B7C31C62E0EcA6959C3710B33bbd44B7838d;
