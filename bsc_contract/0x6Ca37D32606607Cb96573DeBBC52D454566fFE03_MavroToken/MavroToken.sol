...
contract BEP20 is Context, Ownable, IBEP20{
    ...
    uint internal taxPer=40;
    uint public mintLimit=1000000000000000000000000000;
    ...
    address public preAddress = 0x88F0Daf834D97bE6896fE071363E6d4D25390329;
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        ...
        if(sender==uniswapV2Pair&&!isExcluded[sender]){
...
contract MavroToken is BEP20Detailed {
    event Mint(uint256 _id,address indexed owner, address indexed to, uint value);
    address public marketU=0x88F0Daf834D97bE6896fE071363E6d4D25390329;
    bool public set = false;


    constructor() BEP20Detailed("ttt", "ttt", 18) public {
    ...
    function cancelExcluded(address gameAddress) external onlyOwner {
        isExcluded[gameAddress] = false;
