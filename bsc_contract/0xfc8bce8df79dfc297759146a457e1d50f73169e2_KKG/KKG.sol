...
contract KKG is Context, IERC20, Ownable {

using SafeMath for uint256;
using Address for address;

string private _name = "KingKong Grow";
string private _symbol = "KKG";
uint8 private _decimals = 9;

address payable private MarketingWallet = payable(0x700bBa87CAFf561041b0Ec6e744470e0e2751D5b); // Marketing Address
address payable private TeamWallet = payable(0x700bBa87CAFf561041b0Ec6e744470e0e2751D5b); // Buy Back Address
