...
/* Coin AI Relaunch  - March 23 2023
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7C1Af7a0c44436bF457197E66adE0631C1021183; // COINAI
...
contract COINAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "COIN AI";
    string private _symbol = "C";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7C1Af7a0c44436bF457197E66adE0631C1021183); // Marketing Address
    address payable public teamWalletAddress = payable(0x7C1Af7a0c44436bF457197E66adE0631C1021183); // Team Address
