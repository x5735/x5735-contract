...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x137Bc9fb701B0D0f852CBE0473f41C273e0BcD69; // owner address
...
contract PAWZONE is Context, IERC20, Ownable {
    ...
    string private _symbol = "PAWZONE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x137Bc9fb701B0D0f852CBE0473f41C273e0BcD69); // Marketing Address
    address payable public teamWalletAddress = payable(0x137Bc9fb701B0D0f852CBE0473f41C273e0BcD69); // Team Address
