...
contract SAFEMOON2K23 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SAFEMOON 2K23";
    string private _symbol = "SFM2023";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8e9e87719bdfB8b54e8b43AD9B010E52CD0b8518); 
    address payable public DevelopmentalWalletAddress = payable(0xA7801Ee0cA95AF6aDcd60bA8EE58f67Cd232Ffe0);
