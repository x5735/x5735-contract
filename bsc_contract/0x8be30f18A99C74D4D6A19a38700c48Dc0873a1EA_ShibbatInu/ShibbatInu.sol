...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDb4bf2a67bB03b14f1E0b3bcfC1f6CB03eE34B60; // owner address
...
contract ShibbatInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Shibbat Inu";
    string private _symbol = unicode"$Shibbat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDb4bf2a67bB03b14f1E0b3bcfC1f6CB03eE34B60); // Marketing Address
    address payable public teamWalletAddress = payable(0xDb4bf2a67bB03b14f1E0b3bcfC1f6CB03eE34B60); // Team Address
