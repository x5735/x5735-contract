...
contract OptimusComic is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public devTransferFee;
    uint256 public ecosystemTransferFee;
    ...
    constructor() ERC20("Optimus Comic", "OPCOMIC") {
        address newOwner = msg.sender;
        _decimals= 9;
    
        uint256 totalSupply = 1e17 * (10 ** _decimals);
        ...
        devSellFee = 3;
        ecosystemSellFee = 2;
        totalSellFees = rewardsSellFee + marketingSellFee + devSellFee + ecosystemSellFee;
        
        rewardsBuyFee = 1;
        marketingBuyFee = 3;
        devBuyFee = 3;
        ecosystemBuyFee = 2;
        totalBuyFees = rewardsBuyFee + marketingBuyFee + devBuyFee + ecosystemBuyFee;

        rewardsTransferFee = 1;
        marketingTransferFee = 3;
        devTransferFee = 3;
        ecosystemTransferFee = 2;
        totalTransferFees = rewardsTransferFee + marketingTransferFee + devTransferFee + ecosystemTransferFee;
        
    	dividendTracker = new DividendTracker();
    	
    	marketingWallet = address(0x56af97268CAA7f29dBd1b51B70561e7304350045); // set as marketing wallet
        ecosystemWallet = address(0x56af97268CAA7f29dBd1b51B70561e7304350045); // set as ecosystem wallet
        devWallet = address(0x56af97268CAA7f29dBd1b51B70561e7304350045); // set as dev wallet
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && totalSellFees > 0){
                ...
                tokensForEcosystem += fees * ecosystemSellFee / totalSellFees;
            }
            // on buy
                ...
                tokensForEcosystem += fees * ecosystemBuyFee / totalBuyFees;
            } else {
                if (totalTransferFees > 0){
                    ...
                    tokensForDev += fees * devTransferFee / totalTransferFees;
                    tokensForMarketing += fees * marketingTransferFee / totalTransferFees;
                    tokensForEcosystem += fees * ecosystemTransferFee / totalTransferFees;
                }
            }
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForDev + tokensForMarketing + tokensForRewards + tokensForEcosystem;
