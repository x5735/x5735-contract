...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x048A8DADF1d3eF4963e15D3E044a747A52b615c1; // owner address
...
contract Arjunacoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Arjuna Coin";
    string private _symbol = "JUNA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x838c44F3099dad94dbEEC92eD4570Ad6Ac6add2E); // Marketing Address
    address payable public teamWalletAddress = payable(0xD06A3EBD3E2600d462B7bE82662BbA1202d0940D); // Team Address
