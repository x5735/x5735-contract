...
/**
   LOW TAX:/
   OWNERSHIP RENOUNCED
   TG GROUP£ºhttps://t.me/BabyDragonKing_bsc
   */
...
contract BabyDragonKing is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BabyDragonKing";
    string private _symbol = "BDragonKing";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xA7d8ff4A37feeFCB1AbDc1e20eeE06e83ece9DA5);
