...
contract MetacadeToken is Context, MetacadeECO, Ownable {
    ...
    string private _name = 'Metacade Official Token';
    string private _symbol = 'Metacade Official Token';
