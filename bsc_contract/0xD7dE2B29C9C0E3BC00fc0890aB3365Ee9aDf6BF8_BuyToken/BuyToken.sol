...
contract BuyToken is Ownable  {
    ...
    event BuyRecord(address indexed buyer_address, uint256 bnb_amt, uint256 qudex_amt, uint256 buyId);
    ...
    function buyToken (uint256 numberOfToken) public payable returns (uint256 id) {
        ...
        buyhistory[id].qudex_amt = numberOfToken;
    ...
    function updateQudexPrice (uint256 new_price) public onlyOwner {
