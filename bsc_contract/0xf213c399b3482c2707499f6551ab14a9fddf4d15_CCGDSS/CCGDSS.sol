...
contract CCGDSS  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCGDSS ";
    string private _symbol = "CCGDSS ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x35BF98E22DB26e3D5e4e2A79DE3ddCb75Cf0eb7e);
    address payable public teamWalletAddress = payable(0x35BF98E22DB26e3D5e4e2A79DE3ddCb75Cf0eb7e);
    address public immutable deadAddress = 0x35BF98E22DB26e3D5e4e2A79DE3ddCb75Cf0eb7e;
