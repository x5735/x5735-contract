...
contract TaxCollector is Ownable {
  ...
  uint256 public teamPercentage = 3350; address public teamWallet = 0xEE29485bea93f63342fC2Cd4f2753115daF61160;
  function setTeam (uint256 percent_, address wallet_) public onlyOwner { teamPercentage = percent_; teamWallet = wallet_; }
  
  uint256 public partnershipPercentage = 1650; address public partnershipWallet = 0x59a3eb38378e02Fc8a7a5f4E15Bd2815e8C40b19;
  ...
  uint256 public rndPercentage = 5000; address public rndWallet = 0x13e7E3797d98eFD599aa73460CfECF1f837D5Be1;
  ...
  , IERC20Metadata
{
  ...
  string private _name = "FansOnly";
  string private _symbol = "FansOnly";
  ...
  constructor() {
    ...
    _mint(_msgSender(), 10000000000000 * 10 ** uint256(_decimals));
  }
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
    ...
    require(currentAllowance >= subtractedValue, "FansOnly: decreased allowance below zero");
    unchecked {
  ...
  function _transfer(
    ...
    require(sender != address(0), "FansOnly: transfer from the zero address");
    require(recipient != address(0), "FansOnly: transfer to the zero address");
    uint256 senderBalance = _balances[sender];
    require(senderBalance >= amount, "EFansOnlyRC20: transfer amount exceeds balance");
  ...
  function _mint(address account, uint256 amount) internal virtual {
    require(account != address(0), "FansOnly: mint to the zero address");
  ...
  function _burn(address account, uint256 amount) internal virtual {
    require(account != address(0), "FansOnly: burn from the zero address");

    uint256 accountBalance = _balances[account];
    require(accountBalance >= amount, "FansOnly: burn amount exceeds balance");
    unchecked {
  ...
  function _approve(
    ...
    require(owner != address(0), "FansOnly: approve from the zero address");
    require(spender != address(0), "FansOnly: approve to the zero address");
