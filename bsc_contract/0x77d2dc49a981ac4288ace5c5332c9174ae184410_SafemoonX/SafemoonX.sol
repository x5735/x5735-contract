...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x64962c8177445F308a9c7AABd2239b25779A0269; // owner address
...
contract SafemoonX is Context, IERC20, Ownable {
    ...
    string private _name = "SafemoonX";
    string private _symbol = "SFMX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x64962c8177445F308a9c7AABd2239b25779A0269); // 
    address payable public teamWalletAddress = payable(0x64962c8177445F308a9c7AABd2239b25779A0269); // 
