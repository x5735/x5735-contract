...
TG: https://t.me/FableOfTheSafemoon
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x52A94A8640e965557C61729414D500F2e3d1BE73; // owner address
...
contract FableoftheSafemoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Fable of the Safemoon";
    string private _symbol = unicode"$Moon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x52A94A8640e965557C61729414D500F2e3d1BE73); // Marketing Address
    address payable public teamWalletAddress = payable(0x52A94A8640e965557C61729414D500F2e3d1BE73); // Team Address
