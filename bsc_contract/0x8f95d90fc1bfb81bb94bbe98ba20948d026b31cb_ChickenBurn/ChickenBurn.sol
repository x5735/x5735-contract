...
contract ChickenBurn is Context, IERC20, Ownable {
    ...
    string private constant _name = "Chicken Burn";
    string private constant _symbol = "bChicken";
