...
// Contract created at mplanet.tech
...
contract MSN_STANDARD_TOKEN is Context {

    address payable private COLLECTOR = payable(0x8910eBfCC5703208c2Fff8a3B17180C7e417d9f5);
...
contract MSN_TOKEN is Context, IERC20 { 
    ...
    address payable private constant Wallet_Fee = payable(0x8910eBfCC5703208c2Fff8a3B17180C7e417d9f5);
    ...
    function Project_Information() external view returns(address Owner_Wallet,
        ...
        string memory Creator = "https://mplanet.tech";
    ...
    function Token_SetUp_1__Presale_Address(
    ...
    // Set buy fees
    function Token_SetUp_2__Fees_on_Buy(
        ...
        require (Marketing_on_BUY    + 
                 Liquidity_on_BUY    + 
                 Burn_on_BUY         + 
                 Tokens_on_BUY       <= 15, "E01"); // Total buy fee (including 1% contract fee if applicable) must be 15 or less 
        ...
        emit updated_Buy_fees(_Fee__Buy_Marketing, _Fee__Buy_Liquidity, _Fee__Buy_Burn, _Fee__Buy_Tokens, 0);
    }

    // Set sell fees
    function Token_SetUp_3__Fees_on_Sell(
        ...
        require (Marketing_on_SELL  + 
                 Liquidity_on_SELL  + 
                 Burn_on_SELL       + 
                 Tokens_on_SELL     <= 15, "E02"); // Total sell fee (including 1% contract fee if applicable) must be 15 or less 
        ...
        emit updated_Sell_fees(_Fee__Sell_Marketing, _Fee__Sell_Liquidity, _Fee__Sell_Burn, _Fee__Sell_Tokens,  0);
    }
    ...
    */
    ...
    function Token_SetUp_4__Wallet_Limits(
    ...
    */
    ...
    function Token_SetUp_5__Bot_Protection(
    ...
    // Open Trade
    function Token_SetUp_6__Open_Trade() external onlyOwner {
    ...
    function Token_SetUp_7__Blacklist_Bots(address Wallet, bool true_or_false) external onlyOwner {
    ...
    function Token_SetUp_8__Deactivate_Launch_Mode() external onlyOwner {
    ...
    */
    ...
    function Token_SetUp_9__Update_Wallets(
    ...
    */
    ...
    function Token_SetUp_10__Update_Links(
    ...
    */
    ...
    function swapAndLiquify(uint256 Tokens) private {
        ...
        uint256 BNB_Contract    = returned_BNB * (0    + 0)    * 2 / fee_Split;
