...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x99F067577Ef70DbDBFfD9FFdCD2eB140b461e483; // owner address
...
contract PORKINU is Context, IERC20, Ownable {
    ...
    string private _name = "PORK INU";
    string private _symbol = "PI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6D41EabD7E7CC5Af723DD168a0D1d392da0B2dAF); // Marketing Address
    address payable private teamWalletAddress = payable(0x99F067577Ef70DbDBFfD9FFdCD2eB140b461e483); // Team Address
