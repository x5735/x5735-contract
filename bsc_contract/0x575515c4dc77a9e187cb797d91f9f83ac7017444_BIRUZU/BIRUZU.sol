...
contract BIRUZU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BIRUZU";
    string private _symbol = "BIRUZU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFd1792a4A7962c65f84A5aE9d41Ce02e1b51fAeC); // Marketing Address
    address payable public teamWalletAddress = payable(0xFd1792a4A7962c65f84A5aE9d41Ce02e1b51fAeC); // Team Address
