...
contract Mickey is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xf06cD348a2C4eDE36a7eCbBBF4fD0cFfC435936c

);
    address payable public liquidityWalletAddress = payable(0xf06cD348a2C4eDE36a7eCbBBF4fD0cFfC435936c
    ...
    uint256 private _totalSupply = 3200000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 3200000000000000000 * 10**_decimals; 
    uint256 public _walletMax = 3200000000000000000 * 10**_decimals;
