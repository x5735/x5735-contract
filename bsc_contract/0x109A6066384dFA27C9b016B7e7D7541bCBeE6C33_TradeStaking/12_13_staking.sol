...
contract TradeStaking is Initializable, OwnableUpgradeable{
    ...
    function initialize () public initializer{
        router = UniswapRouterInterfaceV5(0xDE2Db97D54a3c3B008a097B2260633E6cA7DB1AF);
        BIGNUMBER = 10**18;
        spreadPrecision = 10**6;
        totalPairs = 0;
        lendingFeesDecimas=1e6;
        quteTokenDecimals=1e6;
        quoteToken=address(0xf9114498b7f38f3337D6295a3a0f3edF8da71326) ;
        __Ownable_init();
        adminFee=0;
    }
