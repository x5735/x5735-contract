...
contract DRAGON is Context, Ownable, IBEP20, BEP20Detailed {
    ...
    address payable public marketingAndBuybackAddress = payable(0x95Aa4a3D050fA09FA9098414eA4698E3994fF1Db);
    ...
    constructor () BEP20Detailed("Dragon Dex", "DRAGON", 18) {
        _owner = msg.sender ;
    ...
    function setSellFeePercent(uint256 newFee) external onlyOwner {
        require(newFee <= 15, "Sell fee should be less than 15%");
        sellFee = newFee;
    }
