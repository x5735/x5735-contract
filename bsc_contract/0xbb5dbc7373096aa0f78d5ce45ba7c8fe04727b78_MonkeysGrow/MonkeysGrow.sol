...
// Telegram :https://t.me/MonkeyGrowOfficial  
...
contract MonkeysGrow is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Monkeys Grow";
    string private _symbol = "MGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcb99E1985ba2af9a6f15C3Af36e6A1116aC7A3f4); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xb158F0C1732e26D0D470A74B42faf2d2F2e875Cf); // BuyBack Address
