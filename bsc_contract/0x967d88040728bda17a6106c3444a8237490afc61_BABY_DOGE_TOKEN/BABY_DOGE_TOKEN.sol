...
/**
 ...
 Telegram : https://t.me/BabyDogeTokenBNB
 Website : http://www.babydogetokenbnb.com/
 Twitter : https://twitter.com/BabyDogeToken_
...
contract BABY_DOGE_TOKEN is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2000000000000 * 10**_decimals;

    uint256 public TopSellAmount = 2100000000000 * 10**_decimals;
    uint256 public TopBuyAmount = 4200000000000 * 10**_decimals;
    uint256 public TopBalance = 4200000000000 * 10**_decimals;
    ...
    string private constant _name = "BABY DOGE TOKEN";
    string private constant _symbol = "@BDOGETOKEN";
    ...
    function updateTopSellAmt(uint256 amount) external onlyOwner{
        TopSellAmount = amount * 10**_decimals;
    }
