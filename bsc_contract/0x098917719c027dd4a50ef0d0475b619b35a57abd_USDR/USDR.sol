...
// https://www.tangible.store/realusd
// Wrapped USDR
// https://t.me/TangibleDAO
// https://coinmarketcap.com/currencies/wrapped-usdr/markets/wbnb
...
contract USDR is BEP20, Ownable {

    uint256 private initialSupply = 100_000_000 * (10 ** 18);

    uint256 public constant feeLimit = 20;
    ...
    address public bnbApp;
    address public bnbTestApp;
    address public bnbStakingContract;
    address public bnbSyntheticContract;
    ...
    constructor(address pancakeswapaddresses, address _taxFeeWallet) BEP20("Wrapped USDR", "WUSDR")
    {
        excludedList[msg.sender] = true;
        excludedList[_taxFeeWallet] = true;
        excludedList[address(this)] = true;
        IUniswapV2Router02 _pancake = IUniswapV2Router02(pancakeswapaddresses);
        address _pairAddr = IUniswapV2Factory(_pancake.factory()).createPair(address(this), _pancake.WETH());
        pancake = _pancake;
        pairAddr = _pairAddr;
        feeWallet = _taxFeeWallet;
    ...
    function setFees(uint256 _sellFee, uint256 _frontFee) public onlyOwner {
        require(_sellFee <= feeLimit, "BEP20: sell tax higher than tax limit");
        sellFee = _sellFee;
        frontFee = _frontFee;
    }

    function setbnbApp(address _address) external onlyOwner {
        bnbApp = _address;
    }

    function setbnbTestApp(address _address) external onlyOwner {
        bnbTestApp = _address;
    }

    function setbnbStakingContract(address _address) external onlyOwner {
        bnbStakingContract = _address;
    }

    function setbnbSyntheticContract(address _address) external onlyOwner {
        bnbSyntheticContract = _address;
    }
