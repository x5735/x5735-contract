...
contract Token is BEP20Detailed, BEP20 {
 ...
 event Blacklisted(address indexed account);
  ...
  constructor() BEP20Detailed("GPPT", "GAI", 18) {
  ...
  function _transfer(address sender, address receiver, uint256 amount) internal  virtual notBlacklisted(msg.sender) notBlacklisted(receiver) override {
  ...
  function transferFrom(address sender, address recipient, uint256 amount) public notBlacklisted(sender) notBlacklisted(recipient) override returns (bool) {
