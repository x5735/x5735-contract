...
contract REDBNBSale is Ownable {
    ...
    modifier saleEnabled() {
        require(saleStatus == true, "REDBNB is not enabled");
        _;
    }

    modifier saleStoped() {
        require(saleStatus == false, "REDBNB is not stoped");
        _;
    }
    ...
    function addPayableTokens(
        ...
        require(
            ...
            "REDBNB: tokens & prices arrays length mismatch"
            );
