...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd732302a823781789b3935FD48bB4879748e881b; // owner address
...
contract InuSwapProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "InuSwap Protocol";
    string private _symbol = "INUSWAP";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xd732302a823781789b3935FD48bB4879748e881b); // Marketing Address
    address payable private teamWalletAddress = payable(0xd732302a823781789b3935FD48bB4879748e881b); // Team Address
