...
contract hobbesGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "hobbesGROW";
    string private _symbol = "hobGW";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x1F11509AD0153eD6dfC164B04E7866CBe9014D09); // Marketing Address
    address payable public teamWalletAddress = payable(0x1F11509AD0153eD6dfC164B04E7866CBe9014D09); // Team Address
