...
contract Luffyop is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3aB5415aEC266927C3bA12F8CC0176D85c839F18); 
    address payable public Wallet_Dev = payable(0x65F02313e69Fceb9682f4C5C93a2c97B4E975eCb);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**15 * 10**_decimals;
    string private constant _name = "Luffy op"; 
    string private constant _symbol = unicode"Luffy op"; 
    ...
    constructor () {
        _owner = 0x3aB5415aEC266927C3bA12F8CC0176D85c839F18;
