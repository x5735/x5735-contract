...
contract SPS is ERC20, Ownable, Refer {
    ...
    constructor() ERC20("SPS", "SPS") {
        ...
        lpAddress = payable(0xf68b1952d0F261D767D265F0c285633D5A0F4A68);
        marketAddress = payable(0x000000000000000000000000000000000000dEaD);
        teamAddress = payable(0xf68b1952d0F261D767D265F0c285633D5A0F4A68);
        _mint(
            0x1dCa8d3E1a5D17E7503289DAE29DADEB9EA51c84,
            50_0000 * 10**decimals()
        );
        _mint(
            0xf68b1952d0F261D767D265F0c285633D5A0F4A68,
            50_0000 * 10**decimals()
        );
